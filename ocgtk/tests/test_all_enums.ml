(** Comprehensive enum tests for all GTK4 subsystems
    ...
    Each enum is tested for: 1. Round-trip conversion (OCaml → C → OCaml) 2.
    Value distinctness (injection property) *)
...
let test_enum_roundtrip (module E : ENUM_TEST) () =
  ...
  List.iter
    (fun v ->
      let i = encode v in
      let v' = decode i in
      Alcotest.(check (of_pp E.pp)) (Format.asprintf "roundtrip %a" E.pp v) v v')
    E.values
      ...
      ( "GTK4/Align",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGtkAlign));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGtkAlign));
        ] );
      ( "GTK4/Orientation",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGtkOrientation));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGtkOrientation));
        ] );
      ( "GTK4/Justification",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGtkJustification));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGtkJustification));
        ] );
      ( "GTK4/MessageType",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGtkMessageType));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGtkMessageType));
        ] );
      ( "GTK4/SelectionMode",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGtkSelectionMode));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGtkSelectionMode));
        ] );
      (* GDK4 Enums *)
      ( "GDK4/ModifierType",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGdkModifierType));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGdkModifierType));
        ] );
      ( "GDK4/ScrollDirection",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGdkScrollDirection));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGdkScrollDirection));
        ] );
      (* GLib Enums *)
      ( "GLib/LogLevel",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGlibLogLevel));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGlibLogLevel));
        ] );
      ( "GLib/IoCondition",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGlibIoCondition));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGlibIoCondition));
        ] );
      (* Pango Enums *)
      ( "Pango/Style",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestPangoStyle));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestPangoStyle));
        ] );
      ( "Pango/Weight",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestPangoWeight));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestPangoWeight));
        ] );
      ( "Pango/WrapMode",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestPangoWrapMode));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestPangoWrapMode));
        ] );
      (* GObject Enums *)
      ( "GObject/SignalType",
        [
          Alcotest.test_case "roundtrip" `Quick
            (test_enum_roundtrip (module TestGObjectSignalType));
          Alcotest.test_case "distinct" `Quick
            (test_enum_distinct (module TestGObjectSignalType));
        ] );
    ]
