...
let test_is_of_type_basic () =
  ...
  Alcotest.(check bool) "int32 is not of type 's'" false (Gvariant.is_of_type v "s")
...
let test_double_special_values () =
  ...
  Alcotest.(check bool) "neg_infinity roundtrip" true (result_neg_inf = neg_infinity);
...
let test_dict_lookup_string () =
  ...
  Alcotest.(check string) "dictionary type is a{sv}" "a{sv}" (Gvariant.type_string v);
...
let test_dict_lookup_boolean () =
  ...
  | Some disabled -> Alcotest.(check bool) "lookup boolean disabled" false disabled
...
let test_get_child_value () =
  ...
  Alcotest.(check string) "child 1 is string" "hello" (Gvariant.to_string child1);
...
let test_print_string () =
  ...
  Alcotest.(check bool) "print string contains hello" 
    true (String.length s > 0 && String.contains s 'h')
...
let test_print_double () =
  ...
  Alcotest.(check bool) "print double contains 3.14" 
...
let () =
  Alcotest.run "GVariant Tests" [
    "Type Introspection", [
      Alcotest.test_case "type string boolean" `Quick test_type_string_boolean;
    ...
    "Boolean", [
      ...
      Alcotest.test_case "roundtrip false" `Quick test_boolean_roundtrip_false;
    ];

    "Int32", [
      Alcotest.test_case "roundtrip positive" `Quick test_int32_roundtrip_positive;
      Alcotest.test_case "roundtrip negative" `Quick test_int32_roundtrip_negative;
    ...
    "Int64", [
      Alcotest.test_case "roundtrip positive" `Quick test_int64_roundtrip_positive;
      Alcotest.test_case "roundtrip negative" `Quick test_int64_roundtrip_negative;
    ...
    "Double", [
      Alcotest.test_case "roundtrip positive" `Quick test_double_roundtrip_positive;
      Alcotest.test_case "roundtrip negative" `Quick test_double_roundtrip_negative;
    ...
    "String", [
      Alcotest.test_case "roundtrip ASCII" `Quick test_string_roundtrip_ascii;
      Alcotest.test_case "roundtrip Unicode" `Quick test_string_roundtrip_unicode;
      Alcotest.test_case "roundtrip empty" `Quick test_string_roundtrip_empty;
    ];
    ...
    "Dictionary", [
      ...
      Alcotest.test_case "lookup string missing" `Quick test_dict_lookup_string_missing;
      Alcotest.test_case "lookup int32" `Quick test_dict_lookup_int32;
      Alcotest.test_case "lookup int32 missing" `Quick test_dict_lookup_int32_missing;
    ...
    "GC Stress", [
      ...
      Alcotest.test_case "ref count stability" `Quick test_ref_count_stability;
    ];
  ]
