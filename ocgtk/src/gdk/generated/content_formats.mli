...
(** Create a new ContentFormats *)
external new_for_gtype : Gobject.Type.t -> t = "ml_gdk_content_formats_new_for_gtype"
...
external match_gtype : t -> t -> Gobject.Type.t = "ml_gdk_content_formats_match_gtype"
...
external get_gtypes : t -> Gobject.Type.t array option * Gsize.t = "ml_gdk_content_formats_get_gtypes"

(** Checks if a given mime type is part of the given @formats. *)
external contain_mime_type : t -> string -> bool = "ml_gdk_content_formats_contain_mime_type"

(** Checks if a given `GType` is part of the given @formats. *)
external contain_gtype : t -> Gobject.Type.t -> bool = "ml_gdk_content_formats_contain_gtype"
