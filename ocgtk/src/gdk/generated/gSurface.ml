...
let new_popup (parent : GApp_launch_context_cycle_de440b34.surface_t) (autohide : bool) : surface_t =
  let parent = parent#as_surface in
  let obj_ = App_launch_context_cycle_de440b34.Surface.new_popup parent autohide in
  new surface obj_

let new_toplevel (display : GApp_launch_context_cycle_de440b34.display_t) : surface_t =
