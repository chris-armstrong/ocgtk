...
class dmabuf_formats (obj : Dmabuf_formats.t) : dmabuf_formats_t =
  object (self)
    method contains : UInt32.t -> UInt64.t -> bool =
      fun fourcc modifier -> Dmabuf_formats.contains obj fourcc modifier

    method equal : Dmabuf_formats.t option -> bool =
      fun formats2 -> Dmabuf_formats.equal obj formats2
