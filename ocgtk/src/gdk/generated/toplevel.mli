...
external show_window_menu : t -> App_launch_context_cycle_de440b34.Event.t -> bool = "ml_gdk_toplevel_show_window_menu"
...
external set_transient_for : t -> App_launch_context_cycle_de440b34.Surface.t -> unit = "ml_gdk_toplevel_set_transient_for"
...
external inhibit_system_shortcuts : t -> App_launch_context_cycle_de440b34.Event.t option -> unit = "ml_gdk_toplevel_inhibit_system_shortcuts"
...
external begin_resize : t -> Gdk_enums.surfaceedge -> App_launch_context_cycle_de440b34.Device.t option -> int -> float -> float -> UInt32.t -> unit = "ml_gdk_toplevel_begin_resize_bytecode" "ml_gdk_toplevel_begin_resize_native"

(** Begins an interactive move operation.

You might use this function to implement draggable titlebars. *)
external begin_move : t -> App_launch_context_cycle_de440b34.Device.t -> int -> float -> float -> UInt32.t -> unit = "ml_gdk_toplevel_begin_move_bytecode" "ml_gdk_toplevel_begin_move_native"
