...
(** Create a new ContentProvider *)
external new_for_value : Gobject.Value.t -> t = "ml_gdk_content_provider_new_for_value"
...
external get_value : t -> (bool * Gobject.Value.t, GError.t) result = "ml_gdk_content_provider_get_value"
