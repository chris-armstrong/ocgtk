...
external set_context : t -> App_launch_context_cycle_de440b34.Gl_context.t option -> unit = "ml_gdk_gl_texture_builder_set_context"
...
%NULL if none was set. *)
external get_context : t -> App_launch_context_cycle_de440b34.Gl_context.t option = "ml_gdk_gl_texture_builder_get_context"
