...
class grab_broken_event (obj : Grab_broken_event.t) : grab_broken_event_t = object (self)
  inherit GApp_launch_context_cycle_de440b34.event (obj :> App_launch_context_cycle_de440b34.Event.t)

  method get_grab_surface : unit -> GApp_launch_context_cycle_de440b34.surface_t =
    fun () ->
      new  GApp_launch_context_cycle_de440b34.surface(Grab_broken_event.get_grab_surface obj)
