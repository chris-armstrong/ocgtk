class type gl_texture_builder_t = object
    method get_context : unit -> GApp_launch_context_cycle_de440b34.gl_context_t option
    ...
    method set_context : GApp_launch_context_cycle_de440b34.gl_context_t option -> unit
...
class gl_texture_builder (obj : Gl_texture_builder.t) : gl_texture_builder_t = object (self)

  method get_context : unit -> GApp_launch_context_cycle_de440b34.gl_context_t option =
    fun () ->
      Option.map (fun ret -> new GApp_launch_context_cycle_de440b34.gl_context ret) (Gl_texture_builder.get_context obj)
