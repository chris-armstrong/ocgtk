...
Applications should generally not handle this signal. *)
  method on_after_paint ~callback =
    Gobject.Signal.connect_simple obj ~name:"after-paint" ~callback ~after:false

  (** Begins processing of the frame.

Applications should generally not handle this signal. *)
  method on_before_paint ~callback =
    Gobject.Signal.connect_simple obj ~name:"before-paint" ~callback ~after:false
...
Applications should not handle this signal. *)
  method on_flush_events ~callback =
    Gobject.Signal.connect_simple obj ~name:"flush-events" ~callback ~after:false
...
should be performed. GTK normally handles this internally. *)
  method on_layout ~callback =
    Gobject.Signal.connect_simple obj ~name:"layout" ~callback ~after:false
...
by GTK. *)
  method on_paint ~callback =
    Gobject.Signal.connect_simple obj ~name:"paint" ~callback ~after:false
...
event processing. Applications should not handle this signal. *)
  method on_resume_events ~callback =
    Gobject.Signal.connect_simple obj ~name:"resume-events" ~callback ~after:false
...
as a more convenient interface. *)
  method on_update ~callback =
    Gobject.Signal.connect_simple obj ~name:"update" ~callback ~after:false
