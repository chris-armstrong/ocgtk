...
external add_gtype : t -> Gobject.Type.t -> unit = "ml_gdk_content_formats_builder_add_gtype"
...
external get_type : unit -> Gobject.Type.t = "ml_gdk_content_formats_builder_get_type"
