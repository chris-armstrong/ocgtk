class type popup_t = object
    ...
    method get_parent : unit -> GApp_launch_context_cycle_de440b34.surface_t option
...
class popup (obj : Popup.t) : popup_t = object (self)
  ...
  method get_parent : unit -> GApp_launch_context_cycle_de440b34.surface_t option =
    fun () ->
      Option.map (fun ret -> new GApp_launch_context_cycle_de440b34.surface ret) (Popup.get_parent obj)
