class type popup_t = object
    ...
    method get_parent : unit -> GApp_launch_context_and__cairo_context_and__clipboard_and__device_and__display_and__draw_context_and__event_and__gl_context_and__monitor_and__seat_and__surface_and__vulkan_context.surface_t option
...
class popup (obj : Popup.t) : popup_t = object (self)
