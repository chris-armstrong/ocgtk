class type toplevel_t = object
    method begin_move : GApp_launch_context_cycle_de440b34.device_t -> int -> float -> float -> UInt32.t -> unit
    method begin_resize : Gdk_enums.surfaceedge -> GApp_launch_context_cycle_de440b34.device_t option -> int -> float -> float -> UInt32.t -> unit
    method focus : UInt32.t -> unit
    method get_state : unit -> Gdk_enums.toplevelstate
    method inhibit_system_shortcuts : GApp_launch_context_cycle_de440b34.event_t option -> unit
    ...
    method set_transient_for : GApp_launch_context_cycle_de440b34.surface_t -> unit
