...
class frame_timings (obj : Frame_timings.t) : frame_timings_t = object (self)
  ...
  method get_frame_counter : unit -> int64 =
    fun () ->
      (Frame_timings.get_frame_counter obj)

  method get_frame_time : unit -> int64 =
    fun () ->
      (Frame_timings.get_frame_time obj)

  method get_predicted_presentation_time : unit -> int64 =
    fun () ->
      (Frame_timings.get_predicted_presentation_time obj)

  method get_presentation_time : unit -> int64 =
    fun () ->
      (Frame_timings.get_presentation_time obj)

  method get_refresh_interval : unit -> int64 =
    fun () ->
      (Frame_timings.get_refresh_interval obj)
