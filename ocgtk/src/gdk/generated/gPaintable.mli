class type paintable_t = object
    method on_invalidate_contents : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_invalidate_size : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
