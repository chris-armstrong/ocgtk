class type toplevel_layout_t = object
    ...
    method get_fullscreen_monitor : unit -> GApp_launch_context_cycle_de440b34.monitor_t option
    method get_resizable : unit -> bool
    method ref : unit -> Toplevel_layout.t
    method set_fullscreen : bool -> GApp_launch_context_cycle_de440b34.monitor_t option -> unit
...
class toplevel_layout (obj : Toplevel_layout.t) : toplevel_layout_t = object (self)
  ...
  method get_fullscreen_monitor : unit -> GApp_launch_context_cycle_de440b34.monitor_t option =
    fun () ->
      Option.map (fun ret -> new GApp_launch_context_cycle_de440b34.monitor ret) (Toplevel_layout.get_fullscreen_monitor obj)
