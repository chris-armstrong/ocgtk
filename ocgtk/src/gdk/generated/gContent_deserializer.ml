...
class content_deserializer (obj : Content_deserializer.t) :
  content_deserializer_t =
  object (self)
    inherit
    ...
    method get_input_stream : unit -> Ocgtk_gio.Gio.Input_stream.input_stream_t
        =
      fun () ->
        new Ocgtk_gio.Gio.Input_stream.input_stream
          (Content_deserializer.get_input_stream obj)

    method get_mime_type : unit -> string =
      fun () -> Content_deserializer.get_mime_type obj
