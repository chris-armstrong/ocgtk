...
class dmabuf_texture_builder (obj : Dmabuf_texture_builder.t) :
  ...
  object (self)
    method get_display : unit -> GApp_launch_context_cycle_de440b34.display_t =
      fun () ->
        new GApp_launch_context_cycle_de440b34.display
          (Dmabuf_texture_builder.get_display obj)

    method get_fd : int -> int =
      fun plane -> Dmabuf_texture_builder.get_fd obj plane

    method get_fourcc : unit -> UInt32.t =
      fun () -> Dmabuf_texture_builder.get_fourcc obj

    method get_height : unit -> int =
      fun () -> Dmabuf_texture_builder.get_height obj

    method get_modifier : unit -> UInt64.t =
      fun () -> Dmabuf_texture_builder.get_modifier obj

    method get_n_planes : unit -> int =
      fun () -> Dmabuf_texture_builder.get_n_planes obj

    method get_offset : int -> int =
      fun plane -> Dmabuf_texture_builder.get_offset obj plane

    method get_premultiplied : unit -> bool =
      fun () -> Dmabuf_texture_builder.get_premultiplied obj

    method get_stride : int -> int =
      fun plane -> Dmabuf_texture_builder.get_stride obj plane
    ...
    method get_update_region : unit -> Ocgtk_cairo.Cairo.Region.region_t option
      ...
      fun () ->
        Option.map
          ...
          (Dmabuf_texture_builder.get_update_region obj)

    method get_update_texture : unit -> GTexture.texture_t option =
      fun () ->
        Option.map
          (fun ret -> new GTexture.texture ret)
          (Dmabuf_texture_builder.get_update_texture obj)
    ...
    method set_fd : int -> int -> unit =
      fun plane fd -> Dmabuf_texture_builder.set_fd obj plane fd

    method set_fourcc : UInt32.t -> unit =
      fun fourcc -> Dmabuf_texture_builder.set_fourcc obj fourcc

    method set_height : int -> unit =
      fun height -> Dmabuf_texture_builder.set_height obj height

    method set_modifier : UInt64.t -> unit =
      fun modifier -> Dmabuf_texture_builder.set_modifier obj modifier

    method set_n_planes : int -> unit =
      fun n_planes -> Dmabuf_texture_builder.set_n_planes obj n_planes

    method set_offset : int -> int -> unit =
      fun plane offset -> Dmabuf_texture_builder.set_offset obj plane offset
    ...
    method set_stride : int -> int -> unit =
      fun plane stride -> Dmabuf_texture_builder.set_stride obj plane stride
    ...
    method set_width : int -> unit =
      fun width -> Dmabuf_texture_builder.set_width obj width
