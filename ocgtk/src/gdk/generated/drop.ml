...
external read_value_finish : t -> Ocgtk_gio.Gio.Wrappers.Async_result.t -> (Gobject.Value.t, GError.t) result = "ml_gdk_drop_read_value_finish"

(** Returns the `GdkSurface` performing the drop. *)
external get_surface : t -> App_launch_context_cycle_de440b34.Surface.t = "ml_gdk_drop_get_surface"
...
external get_display : t -> App_launch_context_cycle_de440b34.Display.t = "ml_gdk_drop_get_display"

(** Returns the `GdkDevice` performing the drop. *)
external get_device : t -> App_launch_context_cycle_de440b34.Device.t = "ml_gdk_drop_get_device"
