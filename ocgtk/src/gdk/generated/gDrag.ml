class type drag_t = object
    method on_cancel : ?after:bool -> callback:(reason:Gdk_enums.dragcancelreason -> unit) -> unit -> Gobject.Signal.handler_id
    ...
    method get_drag_surface : unit -> GApp_launch_context_cycle_de440b34.surface_t option
...
class drag (obj : Drag.t) : drag_t = object (self)
  ...
  method get_drag_surface : unit -> GApp_launch_context_cycle_de440b34.surface_t option =
    fun () ->
      Option.map (fun ret -> new GApp_launch_context_cycle_de440b34.surface ret) (Drag.get_drag_surface obj)
