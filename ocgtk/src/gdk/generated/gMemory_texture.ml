...
class memory_texture (obj : Memory_texture.t) : memory_texture_t =
  object (self)
    inherit GTexture.texture (obj :> Texture.t)
    method as_memory_texture = obj
  end

let new_ (width : int) (height : int) (format : Gdk_enums.memoryformat)
    (bytes : Glib_bytes.t) (stride : Gsize.t) : memory_texture_t =
