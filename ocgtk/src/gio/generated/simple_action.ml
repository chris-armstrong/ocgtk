...
(** Create a new SimpleAction *)
external new_stateful : string -> Gvariant_type.t option -> Gvariant.t -> t = "ml_g_simple_action_new_stateful"
...
action state hints. *)
external set_state_hint : t -> Gvariant.t option -> unit = "ml_g_simple_action_set_state_hint"
...
external get_parameter_type : t -> Gvariant_type.t = "ml_g_simple_action_get_parameter_type"

(** Get property: state-type *)
external get_state_type : t -> Gvariant_type.t = "ml_g_simple_action_get_state_type"
