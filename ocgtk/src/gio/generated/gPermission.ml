...
class permission (obj : Permission.t) : permission_t =
  object (self)
    method acquire :
    ...
    method get_allowed : unit -> bool = fun () -> Permission.get_allowed obj

    method get_can_acquire : unit -> bool =
      fun () -> Permission.get_can_acquire obj

    method get_can_release : unit -> bool =
      fun () -> Permission.get_can_release obj
