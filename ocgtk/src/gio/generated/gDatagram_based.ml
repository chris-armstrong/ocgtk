...
class datagram_based (obj : Datagram_based.t) : datagram_based_t =
  object (self)
    method receive_messages :
        Input_message.t array ->
        int ->
      ...
      fun messages num_messages flags timeout cancellable ->
        ...
        Datagram_based.receive_messages obj messages num_messages flags timeout
          cancellable
    ...
    method send_messages :
      ...
      fun messages num_messages flags timeout cancellable ->
        let cancellable = Option.map (fun c -> c#as_cancellable) cancellable in
        Datagram_based.send_messages obj messages num_messages flags timeout
          cancellable
