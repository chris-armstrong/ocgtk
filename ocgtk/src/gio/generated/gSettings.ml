class type settings_t = object
  ...
  method bind_writable :
    string -> [ `object_ ] Gobject.obj -> string -> bool -> unit
...
class settings (obj : Settings.t) : settings_t =
  object (self)
    ...
    method create_action : string -> GAction.action_t =
      fun key -> new GAction.action (Settings.create_action obj key)

    method delay : unit -> unit = fun () -> Settings.delay obj

    method get_boolean : string -> bool =
      fun key -> Settings.get_boolean obj key

    method get_child : string -> settings_t =
      fun name -> new settings (Settings.get_child obj name)

    method get_default_value : string -> Gvariant.t option =
      fun key -> Settings.get_default_value obj key

    method get_double : string -> float = fun key -> Settings.get_double obj key
    method get_enum : string -> int = fun key -> Settings.get_enum obj key
    method get_flags : string -> int = fun key -> Settings.get_flags obj key

    method get_has_unapplied : unit -> bool =
      fun () -> Settings.get_has_unapplied obj

    method get_int : string -> int = fun key -> Settings.get_int obj key
    method get_int64 : string -> int64 = fun key -> Settings.get_int64 obj key

    method get_range : string -> Gvariant.t =
      fun key -> Settings.get_range obj key

    method get_string : string -> string =
      fun key -> Settings.get_string obj key

    method get_strv : string -> string array =
      fun key -> Settings.get_strv obj key

    method get_uint : string -> int = fun key -> Settings.get_uint obj key

    method get_uint64 : string -> UInt64.t =
      fun key -> Settings.get_uint64 obj key

    method get_user_value : string -> Gvariant.t option =
      fun key -> Settings.get_user_value obj key

    method get_value : string -> Gvariant.t =
      fun key -> Settings.get_value obj key

    method is_writable : string -> bool =
      fun name -> Settings.is_writable obj name

    method list_children : unit -> string array =
      fun () -> Settings.list_children obj

    method list_keys : unit -> string array = fun () -> Settings.list_keys obj

    method range_check : string -> Gvariant.t -> bool =
      fun key value -> Settings.range_check obj key value

    method reset : string -> unit = fun key -> Settings.reset obj key
    method revert : unit -> unit = fun () -> Settings.revert obj

    method set_boolean : string -> bool -> bool =
      fun key value -> Settings.set_boolean obj key value

    method set_double : string -> float -> bool =
      fun key value -> Settings.set_double obj key value

    method set_enum : string -> int -> bool =
      fun key value -> Settings.set_enum obj key value

    method set_flags : string -> int -> bool =
      fun key value -> Settings.set_flags obj key value

    method set_int : string -> int -> bool =
      fun key value -> Settings.set_int obj key value

    method set_int64 : string -> int64 -> bool =
      fun key value -> Settings.set_int64 obj key value

    method set_string : string -> string -> bool =
      fun key value -> Settings.set_string obj key value

    method set_strv : string -> string array option -> bool =
      fun key value -> Settings.set_strv obj key value

    method set_uint : string -> int -> bool =
      fun key value -> Settings.set_uint obj key value

    method set_uint64 : string -> UInt64.t -> bool =
      fun key value -> Settings.set_uint64 obj key value

    method set_value : string -> Gvariant.t -> bool =
      fun key value -> Settings.set_value obj key value
