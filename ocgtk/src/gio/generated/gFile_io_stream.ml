  ...
  object (self)
    ...
    method query_info :
      ...
      fun attributes cancellable ->
        ...
        Result.map
          ...
          (File_io_stream.query_info obj attributes cancellable)
    ...
    method query_info_finish :
      ...
      fun result ->
        ...
        Result.map
          (fun ret -> new GFile_info.file_info ret)
          (File_io_stream.query_info_finish obj result)
