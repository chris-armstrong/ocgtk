...
class tls_backend (obj : Tls_backend.t) : tls_backend_t = object (self)
  ...
  method get_certificate_type : unit -> int =
    fun () ->
      (Tls_backend.get_certificate_type obj)

  method get_client_connection_type : unit -> int =
    fun () ->
      (Tls_backend.get_client_connection_type obj)
  ...
  method get_dtls_client_connection_type : unit -> int =
    fun () ->
      (Tls_backend.get_dtls_client_connection_type obj)

  method get_dtls_server_connection_type : unit -> int =
    fun () ->
      (Tls_backend.get_dtls_server_connection_type obj)

  method get_file_database_type : unit -> int =
    fun () ->
      (Tls_backend.get_file_database_type obj)

  method get_server_connection_type : unit -> int =
    fun () ->
      (Tls_backend.get_server_connection_type obj)
