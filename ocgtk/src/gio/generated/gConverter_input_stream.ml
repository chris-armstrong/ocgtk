...
class converter_input_stream (obj : Converter_input_stream.t) :
  converter_input_stream_t =
  object (self)
    inherit
...
let new_ (base_stream : GInput_stream.input_stream_t)
    (converter : GConverter.converter_t) : converter_input_stream_t =
