...
class menu_attribute_iter (obj : Menu_attribute_iter.t) : menu_attribute_iter_t
  =
  object (self)
    method get_name : unit -> string =
      fun () -> Menu_attribute_iter.get_name obj

    method get_value : unit -> Gvariant.t =
      fun () -> Menu_attribute_iter.get_value obj

    method next : unit -> bool = fun () -> Menu_attribute_iter.next obj
