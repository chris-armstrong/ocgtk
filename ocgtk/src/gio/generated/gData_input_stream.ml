class type data_input_stream_t = object
  ...
  method read_int16 :
    GCancellable.cancellable_t option -> (Int16.t, GError.t) result

  method read_int32 :
    GCancellable.cancellable_t option -> (Int32.t, GError.t) result

  method read_int64 :
    GCancellable.cancellable_t option -> (int64, GError.t) result

  method read_uint16 :
    GCancellable.cancellable_t option -> (UInt16.t, GError.t) result

  method read_uint32 :
    GCancellable.cancellable_t option -> (UInt32.t, GError.t) result

  method read_uint64 :
    GCancellable.cancellable_t option -> (UInt64.t, GError.t) result
...
class data_input_stream (obj : Data_input_stream.t) : data_input_stream_t =
  object (self)
    inherit
      GBuffered_input_stream.buffered_input_stream
        (obj :> Buffered_input_stream.t)

    method get_byte_order : unit -> Gio_enums.datastreambyteorder =
      fun () -> Data_input_stream.get_byte_order obj

    method get_newline_type : unit -> Gio_enums.datastreamnewlinetype =
      fun () -> Data_input_stream.get_newline_type obj
    ...
    method set_byte_order : Gio_enums.datastreambyteorder -> unit =
      fun order -> Data_input_stream.set_byte_order obj order

    method set_newline_type : Gio_enums.datastreamnewlinetype -> unit =
      fun type_ -> Data_input_stream.set_newline_type obj type_
