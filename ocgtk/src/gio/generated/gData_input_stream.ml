class type data_input_stream_t = object
    ...
    method read_int16 : GCancellable.cancellable_t option -> (int, GError.t) result
    method read_int32 : GCancellable.cancellable_t option -> (int32, GError.t) result
    method read_int64 : GCancellable.cancellable_t option -> (int64, GError.t) result
    method read_uint16 : GCancellable.cancellable_t option -> (int, GError.t) result
    method read_uint32 : GCancellable.cancellable_t option -> (int, GError.t) result
