...
external is_user_mountable : t -> bool
  = "ml_g_unix_mount_point_is_user_mountable"
...
external guess_symbolic_icon : t -> Icon.t
  = "ml_g_unix_mount_point_guess_symbolic_icon"
