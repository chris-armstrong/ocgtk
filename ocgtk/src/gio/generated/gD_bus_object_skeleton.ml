...
class d_bus_object_skeleton (obj : D_bus_object_skeleton.t) : d_bus_object_skeleton_t = object (self)
  inherit GD_bus_interface_and__d_bus_object.d_bus_object (D_bus_interface_and__d_bus_object.D_bus_object.from_gobject obj)
