...
(void)self;
(void)arg1;
caml_failwith("Socket requires GLib >= 2.26");
return Val_unit;
}
#endif
...
(void)arg2;
(void)arg3;
caml_failwith("Socket requires GLib >= 2.36");
return Val_unit;
}
#endif
...
(void)arg3;
(void)arg4;
caml_failwith("Socket requires GLib >= 2.44");
return Val_unit;
}
#endif
...
(void)arg2;
(void)arg3;
caml_failwith("Socket requires GLib >= 2.56");
return Val_unit;
}
#endif
