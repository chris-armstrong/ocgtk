class type data_output_stream_t = object
  ...
  method put_int16 :
    Int16.t -> GCancellable.cancellable_t option -> (bool, GError.t) result

  method put_int32 :
    Int32.t -> GCancellable.cancellable_t option -> (bool, GError.t) result

  method put_int64 :
    int64 -> GCancellable.cancellable_t option -> (bool, GError.t) result

  method put_string :
    string -> GCancellable.cancellable_t option -> (bool, GError.t) result

  method put_uint16 :
    UInt16.t -> GCancellable.cancellable_t option -> (bool, GError.t) result

  method put_uint32 :
    UInt32.t -> GCancellable.cancellable_t option -> (bool, GError.t) result

  method put_uint64 :
    UInt64.t -> GCancellable.cancellable_t option -> (bool, GError.t) result
...
class data_output_stream (obj : Data_output_stream.t) : data_output_stream_t =
  object (self)
    inherit
      GFilter_output_stream.filter_output_stream (obj :> Filter_output_stream.t)

    inherit GSeekable.seekable (Seekable.from_gobject obj)

    method get_byte_order : unit -> Gio_enums.datastreambyteorder =
      fun () -> Data_output_stream.get_byte_order obj
    ...
    method set_byte_order : Gio_enums.datastreambyteorder -> unit =
      fun order -> Data_output_stream.set_byte_order obj order
