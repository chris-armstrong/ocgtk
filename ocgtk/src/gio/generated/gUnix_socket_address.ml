...
class unix_socket_address (obj : Unix_socket_address.t) : unix_socket_address_t
  =
  object (self)
    inherit
      GSocket_address_and__socket_address_enumerator_and__socket_connectable
    ...
    method get_address_type : unit -> Gio_enums.unixsocketaddresstype =
      fun () -> Unix_socket_address.get_address_type obj

    method get_is_abstract : unit -> bool =
      fun () -> Unix_socket_address.get_is_abstract obj

    method get_path : unit -> string =
      fun () -> Unix_socket_address.get_path obj

    method get_path_len : unit -> Gsize.t =
      fun () -> Unix_socket_address.get_path_len obj
...
let new_with_type (path : int array) (path_len : int)
    (type_ : Gio_enums.unixsocketaddresstype) : unix_socket_address_t =
