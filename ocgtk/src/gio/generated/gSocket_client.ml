  ...
  object (self)
    ...
    method connect :
      ...
      fun connectable cancellable ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect obj connectable cancellable)
    ...
    method connect_finish :
      ...
      fun result ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_finish obj result)
    ...
    method connect_to_host :
      ...
      fun host_and_port default_port cancellable ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_to_host obj host_and_port default_port
             cancellable)
    ...
    method connect_to_host_finish :
      ...
      fun result ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_to_host_finish obj result)
    ...
    method connect_to_service :
      ...
      fun domain service cancellable ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_to_service obj domain service cancellable)
    ...
    method connect_to_service_finish :
      ...
      fun result ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_to_service_finish obj result)
    ...
    method connect_to_uri :
      ...
      fun uri default_port cancellable ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_to_uri obj uri default_port cancellable)
    ...
    method connect_to_uri_finish :
      ...
      fun result ->
        ...
        Result.map
          (fun ret -> new GSocket_and__socket_connection.socket_connection ret)
          (Socket_client.connect_to_uri_finish obj result)

    method get_enable_proxy : unit -> bool =
      fun () -> Socket_client.get_enable_proxy obj

    method get_family : unit -> Gio_enums.socketfamily =
      fun () -> Socket_client.get_family obj
        ...
        Option.map
          (fun ret ->
            new
              ...
              .socket_address
              ret)
          (Socket_client.get_local_address obj)

    method get_protocol : unit -> Gio_enums.socketprotocol =
      fun () -> Socket_client.get_protocol obj

    method get_proxy_resolver : unit -> GProxy_resolver.proxy_resolver_t =
      fun () ->
        new GProxy_resolver.proxy_resolver
          (Socket_client.get_proxy_resolver obj)

    method get_socket_type : unit -> Gio_enums.sockettype =
      fun () -> Socket_client.get_socket_type obj

    method get_timeout : unit -> int = fun () -> Socket_client.get_timeout obj
    method get_tls : unit -> bool = fun () -> Socket_client.get_tls obj

    method get_tls_validation_flags : unit -> Gio_enums.tlscertificateflags =
      fun () -> Socket_client.get_tls_validation_flags obj

    method set_enable_proxy : bool -> unit =
      fun enable -> Socket_client.set_enable_proxy obj enable

    method set_family : Gio_enums.socketfamily -> unit =
      fun family -> Socket_client.set_family obj family
    ...
    method set_protocol : Gio_enums.socketprotocol -> unit =
      fun protocol -> Socket_client.set_protocol obj protocol

    method set_proxy_resolver : GProxy_resolver.proxy_resolver_t option -> unit
        =
      fun proxy_resolver ->
        let proxy_resolver =
          Option.map (fun c -> c#as_proxy_resolver) proxy_resolver
        in
        Socket_client.set_proxy_resolver obj proxy_resolver

    method set_socket_type : Gio_enums.sockettype -> unit =
      fun type_ -> Socket_client.set_socket_type obj type_

    method set_timeout : int -> unit =
      fun timeout -> Socket_client.set_timeout obj timeout

    method set_tls : bool -> unit = fun tls -> Socket_client.set_tls obj tls

    method set_tls_validation_flags : Gio_enums.tlscertificateflags -> unit =
      fun flags -> Socket_client.set_tls_validation_flags obj flags
...
let new_ () : socket_client_t = new socket_client (Socket_client.new_ ())
