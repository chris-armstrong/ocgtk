...
class type app_info_t = object
  ...
  method launch :
    file_t list option -> app_launch_context_t option -> (bool, GError.t) result
...
and file_t = object
  method append_to :
    ...
    (GFile_output_stream.file_output_stream_t, GError.t) result
  ...
  method create_readwrite :
    Gio_enums.filecreateflags ->
    GCancellable.cancellable_t option ->
    (GFile_io_stream.file_io_stream_t, GError.t) result
  ...
  method enumerate_children :
    ...
    GCancellable.cancellable_t option ->
    (file_enumerator_t, GError.t) result
  ...
  method monitor :
    ...
    GCancellable.cancellable_t option ->
    (file_monitor_t, GError.t) result
  ...
  method read :
    GCancellable.cancellable_t option ->
    (GFile_input_stream.file_input_stream_t, GError.t) result
...
and file_enumerator_t = object
  ...
  method next_file :
    GCancellable.cancellable_t option ->
    (GFile_info.file_info_t option, GError.t) result
...
and mount_t = object
  ...
  method guess_content_type_sync :
    bool -> GCancellable.cancellable_t option -> (string array, GError.t) result
...
and app_launch_context
  ...
  object (self)
    ...
    method on_launch_started ~callback =
      App_info_and__app_launch_context_and__drive_and__file_and__file_enumerator_and__file_monitor_and__mount_and__volume
      .App_launch_context
      .on_launch_started self#as_app_launch_context ~callback

    method on_launched ~callback =
      App_info_and__app_launch_context_and__drive_and__file_and__file_enumerator_and__file_monitor_and__mount_and__volume
      .App_launch_context
      .on_launched self#as_app_launch_context ~callback
...
and file_monitor
  ...
  object (self)
    method on_changed ~callback =
      App_info_and__app_launch_context_and__drive_and__file_and__file_enumerator_and__file_monitor_and__mount_and__volume
      .File_monitor
      .on_changed self#as_file_monitor ~callback
