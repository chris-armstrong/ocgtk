...
class filter_output_stream (obj : Filter_output_stream.t) :
  filter_output_stream_t =
  object (self)
    inherit GOutput_stream.output_stream (obj :> Output_stream.t)

    method get_base_stream : unit -> GOutput_stream.output_stream_t =
      fun () ->
        new GOutput_stream.output_stream
          (Filter_output_stream.get_base_stream obj)

    method get_close_base_stream : unit -> bool =
      fun () -> Filter_output_stream.get_close_base_stream obj
