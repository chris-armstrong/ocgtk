...
class type file_t = object
  ...
  method query_default_handler :
    GCancellable.cancellable_t option ->
    (GApp_info_and__app_launch_context.app_info_t, GError.t) result
...
and file_enumerator_t = object
  ...
  method next_files_finish :
    GAsync_result.async_result_t -> (File_info.t list, GError.t) result
...
and mount_t = object
  ...
  method as_mount :
    File_and__file_enumerator_and__file_monitor_and__mount_and__volume.Mount.t
end
...
and volume_t = object
  ...
  method as_volume :
    File_and__file_enumerator_and__file_monitor_and__mount_and__volume.Volume.t
end
  ...
  object (self)
    ...
    method query_default_handler :
      ...
      fun cancellable ->
        let cancellable = Option.map (fun c -> c#as_cancellable) cancellable in
        Result.map
          (fun ret -> new GApp_info_and__app_launch_context.app_info ret)
          (File_and__file_enumerator_and__file_monitor_and__mount_and__volume
           .File
