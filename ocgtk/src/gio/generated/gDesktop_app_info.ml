class type desktop_app_info_t = object
  ...
  method launch_action :
    string ->
    GApp_info_and__app_launch_context.app_launch_context_t option ->
    unit
...
class desktop_app_info (obj : Desktop_app_info.t) : desktop_app_info_t =
  object (self)
    inherit
      GApp_info_and__app_launch_context.app_info
        (App_info_and__app_launch_context.App_info.from_gobject obj)
