...
class settings_schema_key (obj : Settings_schema_key.t) : settings_schema_key_t = object (self)
  ...
  method get_default_value : unit -> Gvariant.t =
    fun () ->
      (Settings_schema_key.get_default_value obj)
  ...
  method get_range : unit -> Gvariant.t =
    fun () ->
      (Settings_schema_key.get_range obj)
  ...
  method get_value_type : unit -> Gvariant_type.t =
    fun () ->
      (Settings_schema_key.get_value_type obj)

  method range_check : Gvariant.t -> bool =
    fun value ->
      (Settings_schema_key.range_check obj value)
