class type input_stream_t = object
    ...
    method read_bytes : Gsize.t -> GCancellable.cancellable_t option -> (Glib_bytes.t, GError.t) result
    method read_bytes_finish : GAsync_result.async_result_t -> (Glib_bytes.t, GError.t) result
    method read_finish : GAsync_result.async_result_t -> (int, GError.t) result
    method set_pending : unit -> (bool, GError.t) result
    method skip : Gsize.t -> GCancellable.cancellable_t option -> (int, GError.t) result
