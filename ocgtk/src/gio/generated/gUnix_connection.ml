class type unix_connection_t = object
    ...
    method receive_credentials_finish : GAsync_result.async_result_t -> (GCredentials.credentials_t, GError.t) result
    ...
    method send_credentials_finish : GAsync_result.async_result_t -> (bool, GError.t) result
...
class unix_connection (obj : Unix_connection.t) : unix_connection_t = object (self)
  ...
  method receive_credentials_finish : GAsync_result.async_result_t -> (GCredentials.credentials_t, GError.t) result =
    fun result ->
      ...
      Result.map (fun ret -> new GCredentials.credentials ret)(Unix_connection.receive_credentials_finish obj result)
