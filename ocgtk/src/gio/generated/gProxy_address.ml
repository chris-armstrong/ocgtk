...
let new_ (inetaddr : GInet_address.inet_address_t) (port : UInt16.t) (protocol : string) (dest_hostname : string) (dest_port : UInt16.t) (username : string option) (password : string option) : proxy_address_t =
