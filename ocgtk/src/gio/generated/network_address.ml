...
external new_ : string -> int -> t = "ml_g_network_address_new"

(** Create a new NetworkAddress *)
external new_loopback : int -> t = "ml_g_network_address_new_loopback"
...
external get_port : t -> int = "ml_g_network_address_get_port"
