...
external new_with_fd_list : Unix_fd_list.t -> t
  = "ml_g_unix_fd_message_new_with_fd_list"
(** Create a new UnixFDMessage *)
...
external append_fd : t -> int -> (bool, GError.t) result
  = "ml_g_unix_fd_message_append_fd"
