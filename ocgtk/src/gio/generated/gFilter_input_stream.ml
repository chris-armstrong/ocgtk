...
class filter_input_stream (obj : Filter_input_stream.t) : filter_input_stream_t
  =
  object (self)
    ...
    method get_close_base_stream : unit -> bool =
      fun () -> Filter_input_stream.get_close_base_stream obj

    method set_close_base_stream : bool -> unit =
      fun close_base -> Filter_input_stream.set_close_base_stream obj close_base
