...
class file_input_stream (obj : File_input_stream.t) : file_input_stream_t =
  object (self)
    ...
    method query_info :
      ...
      fun attributes cancellable ->
        ...
        Result.map
          ...
          (File_input_stream.query_info obj attributes cancellable)
    ...
    method query_info_finish :
      ...
      fun result ->
        ...
        Result.map
          (fun ret -> new GFile_info.file_info ret)
          (File_input_stream.query_info_finish obj result)
