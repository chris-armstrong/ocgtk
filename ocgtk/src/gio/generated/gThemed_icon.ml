...
class themed_icon (obj : Themed_icon.t) : themed_icon_t =
  object (self)
    inherit GIcon.icon (Icon.from_gobject obj)

    method append_name : string -> unit =
      fun iconname -> Themed_icon.append_name obj iconname

    method get_names : unit -> string array =
      fun () -> Themed_icon.get_names obj

    method prepend_name : string -> unit =
      fun iconname -> Themed_icon.prepend_name obj iconname
