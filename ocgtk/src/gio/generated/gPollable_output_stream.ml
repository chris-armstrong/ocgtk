...
class pollable_output_stream (obj : Pollable_output_stream.t) :
  pollable_output_stream_t =
  object (self)
    method can_poll : unit -> bool =
      fun () -> Pollable_output_stream.can_poll obj

    method is_writable : unit -> bool =
      fun () -> Pollable_output_stream.is_writable obj
