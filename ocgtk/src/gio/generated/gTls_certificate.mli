...
val new_from_file_with_password :
  string -> string -> (tls_certificate_t, GError.t) result
...
val new_from_pkcs11_uris :
  string -> string option -> (tls_certificate_t, GError.t) result
