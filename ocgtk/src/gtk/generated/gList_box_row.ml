...
class list_box_row (obj : List_box_row.t) : list_box_row_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
    ...
    method get_activatable : unit -> bool =
      fun () -> List_box_row.get_activatable obj
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (List_box_row.get_header obj)

    method get_index : unit -> int = fun () -> List_box_row.get_index obj

    method get_selectable : unit -> bool =
      fun () -> List_box_row.get_selectable obj

    method is_selected : unit -> bool = fun () -> List_box_row.is_selected obj

    method set_activatable : bool -> unit =
      fun activatable -> List_box_row.set_activatable obj activatable
    ...
    method set_selectable : bool -> unit =
      fun selectable -> List_box_row.set_selectable obj selectable

    method as_list_box_row = obj
  end

let new_ () : list_box_row_t = new list_box_row (List_box_row.new_ ())
