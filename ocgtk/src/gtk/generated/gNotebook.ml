...
class notebook (obj : Notebook.t) : notebook_t =
  object (self)
    ...
    method get_current_page : unit -> int =
      fun () -> Notebook.get_current_page obj
    ...
    method get_pages : unit -> Ocgtk_gio.Gio.List_model.list_model_t =
      fun () -> new Ocgtk_gio.Gio.List_model.list_model (Notebook.get_pages obj)

    method get_scrollable : unit -> bool = fun () -> Notebook.get_scrollable obj

    method get_show_border : unit -> bool =
      fun () -> Notebook.get_show_border obj
    ...
    method set_current_page : int -> unit =
      fun page_num -> Notebook.set_current_page obj page_num
    ...
    method set_scrollable : bool -> unit =
      fun scrollable -> Notebook.set_scrollable obj scrollable

    method set_show_border : bool -> unit =
      fun show_border -> Notebook.set_show_border obj show_border
...
let new_ () : notebook_t = new notebook (Notebook.new_ ())
