...
class color_button_signals (obj : Color_button.t) =
  object
    ...
    method on_color_set ~callback =
      Gobject.Signal.connect_simple obj ~name:"color-set" ~callback ~after:false
    (** Emitted when the user selects a color.

        When handling this signal, use [method@Gtk.ColorChooser.get_rgba] to
