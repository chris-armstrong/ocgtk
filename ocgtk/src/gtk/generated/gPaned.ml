class type paned_t = object
    ...
    method on_move_handle : ?after:bool -> callback:(scroll_type:Gtk_enums.scrolltype -> bool) -> unit -> Gobject.Signal.handler_id
    method on_toggle_handle_focus : ?after:bool -> callback:(unit -> bool) -> unit -> Gobject.Signal.handler_id
    method get_end_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
    ...
    method get_start_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
    method get_wide_handle : unit -> bool
    method set_end_child : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> unit
    ...
    method set_start_child : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> unit
...
class paned (obj : Paned.t) : paned_t = object (self)
  ...
  method get_end_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Paned.get_end_child obj)
  ...
  method get_start_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Paned.get_start_child obj)
