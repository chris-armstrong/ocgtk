...
class settings (obj : Settings.t) : settings_t =
  object (self)
    ...
    method reset_property : string -> unit =
      fun name -> Settings.reset_property obj name

    method gtk_alternative_button_order =
      Settings.get_gtk_alternative_button_order obj

    method set_gtk_alternative_button_order v =
      Settings.set_gtk_alternative_button_order obj v

    method gtk_alternative_sort_arrows =
      Settings.get_gtk_alternative_sort_arrows obj

    method set_gtk_alternative_sort_arrows v =
      Settings.set_gtk_alternative_sort_arrows obj v

    method gtk_application_prefer_dark_theme =
      Settings.get_gtk_application_prefer_dark_theme obj

    method set_gtk_application_prefer_dark_theme v =
      Settings.set_gtk_application_prefer_dark_theme obj v

    method gtk_cursor_aspect_ratio = Settings.get_gtk_cursor_aspect_ratio obj

    method set_gtk_cursor_aspect_ratio v =
      Settings.set_gtk_cursor_aspect_ratio obj v
    ...
    method set_gtk_cursor_blink_time v =
      Settings.set_gtk_cursor_blink_time obj v

    method gtk_cursor_blink_timeout = Settings.get_gtk_cursor_blink_timeout obj

    method set_gtk_cursor_blink_timeout v =
      Settings.set_gtk_cursor_blink_timeout obj v

    method gtk_cursor_theme_name = Settings.get_gtk_cursor_theme_name obj

    method set_gtk_cursor_theme_name v =
      Settings.set_gtk_cursor_theme_name obj v

    method gtk_cursor_theme_size = Settings.get_gtk_cursor_theme_size obj

    method set_gtk_cursor_theme_size v =
      Settings.set_gtk_cursor_theme_size obj v

    method gtk_decoration_layout = Settings.get_gtk_decoration_layout obj

    method set_gtk_decoration_layout v =
      Settings.set_gtk_decoration_layout obj v

    method gtk_dialogs_use_header = Settings.get_gtk_dialogs_use_header obj

    method set_gtk_dialogs_use_header v =
      Settings.set_gtk_dialogs_use_header obj v

    method gtk_dnd_drag_threshold = Settings.get_gtk_dnd_drag_threshold obj

    method set_gtk_dnd_drag_threshold v =
      Settings.set_gtk_dnd_drag_threshold obj v

    method gtk_double_click_distance =
      Settings.get_gtk_double_click_distance obj

    method set_gtk_double_click_distance v =
      Settings.set_gtk_double_click_distance obj v

    method gtk_double_click_time = Settings.get_gtk_double_click_time obj

    method set_gtk_double_click_time v =
      Settings.set_gtk_double_click_time obj v
    ...
    method set_gtk_enable_animations v =
      Settings.set_gtk_enable_animations obj v

    method gtk_enable_event_sounds = Settings.get_gtk_enable_event_sounds obj

    method set_gtk_enable_event_sounds v =
      Settings.set_gtk_enable_event_sounds obj v

    method gtk_enable_input_feedback_sounds =
      Settings.get_gtk_enable_input_feedback_sounds obj

    method set_gtk_enable_input_feedback_sounds v =
      Settings.set_gtk_enable_input_feedback_sounds obj v

    method gtk_enable_primary_paste = Settings.get_gtk_enable_primary_paste obj

    method set_gtk_enable_primary_paste v =
      Settings.set_gtk_enable_primary_paste obj v

    method gtk_entry_password_hint_timeout =
      Settings.get_gtk_entry_password_hint_timeout obj

    method set_gtk_entry_password_hint_timeout v =
      Settings.set_gtk_entry_password_hint_timeout obj v

    method gtk_entry_select_on_focus =
      Settings.get_gtk_entry_select_on_focus obj

    method set_gtk_entry_select_on_focus v =
      Settings.set_gtk_entry_select_on_focus obj v
    ...
    method set_gtk_fontconfig_timestamp v =
      Settings.set_gtk_fontconfig_timestamp obj v

    method gtk_hint_font_metrics = Settings.get_gtk_hint_font_metrics obj

    method set_gtk_hint_font_metrics v =
      Settings.set_gtk_hint_font_metrics obj v
    ...
    method gtk_label_select_on_focus =
      Settings.get_gtk_label_select_on_focus obj

    method set_gtk_label_select_on_focus v =
      Settings.set_gtk_label_select_on_focus obj v
    ...
    method set_gtk_overlay_scrolling v =
      Settings.set_gtk_overlay_scrolling obj v

    method gtk_primary_button_warps_slider =
      Settings.get_gtk_primary_button_warps_slider obj

    method set_gtk_primary_button_warps_slider v =
      Settings.set_gtk_primary_button_warps_slider obj v
    ...
    method gtk_print_preview_command =
      Settings.get_gtk_print_preview_command obj

    method set_gtk_print_preview_command v =
      Settings.set_gtk_print_preview_command obj v

    method gtk_recent_files_enabled = Settings.get_gtk_recent_files_enabled obj

    method set_gtk_recent_files_enabled v =
      Settings.set_gtk_recent_files_enabled obj v

    method gtk_recent_files_max_age = Settings.get_gtk_recent_files_max_age obj

    method set_gtk_recent_files_max_age v =
      Settings.set_gtk_recent_files_max_age obj v

    method gtk_shell_shows_app_menu = Settings.get_gtk_shell_shows_app_menu obj

    method set_gtk_shell_shows_app_menu v =
      Settings.set_gtk_shell_shows_app_menu obj v

    method gtk_shell_shows_desktop = Settings.get_gtk_shell_shows_desktop obj

    method set_gtk_shell_shows_desktop v =
      Settings.set_gtk_shell_shows_desktop obj v

    method gtk_shell_shows_menubar = Settings.get_gtk_shell_shows_menubar obj

    method set_gtk_shell_shows_menubar v =
      Settings.set_gtk_shell_shows_menubar obj v

    method gtk_show_status_shapes = Settings.get_gtk_show_status_shapes obj

    method set_gtk_show_status_shapes v =
      Settings.set_gtk_show_status_shapes obj v
    ...
    method gtk_titlebar_double_click =
      Settings.get_gtk_titlebar_double_click obj

    method set_gtk_titlebar_double_click v =
      Settings.set_gtk_titlebar_double_click obj v

    method gtk_titlebar_middle_click =
      Settings.get_gtk_titlebar_middle_click obj

    method set_gtk_titlebar_middle_click v =
      Settings.set_gtk_titlebar_middle_click obj v

    method gtk_titlebar_right_click = Settings.get_gtk_titlebar_right_click obj

    method set_gtk_titlebar_right_click v =
      Settings.set_gtk_titlebar_right_click obj v
