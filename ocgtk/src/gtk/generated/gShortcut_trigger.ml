...
class shortcut_trigger (obj : Shortcut_trigger.t) : shortcut_trigger_t =
  object (self)
    method compare : shortcut_trigger_t -> int =
      fun trigger2 ->
    ...
    method to_string : unit -> string = fun () -> Shortcut_trigger.to_string obj

    method trigger :
        Ocgtk_gdk.Gdk.Event.event_t -> bool -> Ocgtk_gdk.Gdk.keymatch =
