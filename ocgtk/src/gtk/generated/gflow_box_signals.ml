...
This is a [keybinding signal](class.SignalAction.html). *)
  method on_activate_cursor_child ~callback =
    Gobject.Signal.connect_simple obj ~name:"activate-cursor-child" ~callback ~after:false
...
selected children. *)
  method on_selected_children_changed ~callback =
    Gobject.Signal.connect_simple obj ~name:"selected-children-changed" ~callback ~after:false
...
The default binding for this signal is <kbd>Ctrl</kbd>-<kbd>Space</kbd>. *)
  method on_toggle_cursor_child ~callback =
    Gobject.Signal.connect_simple obj ~name:"toggle-cursor-child" ~callback ~after:false
