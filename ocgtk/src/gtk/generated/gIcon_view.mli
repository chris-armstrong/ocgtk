class type icon_view_t = object
    ...
    method set_tooltip_cell : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.tooltip_t -> Tree_path.t -> GCell_renderer.cell_renderer_t option -> unit
    method set_tooltip_column : int -> unit
    method set_tooltip_item : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.tooltip_t -> Tree_path.t -> unit
