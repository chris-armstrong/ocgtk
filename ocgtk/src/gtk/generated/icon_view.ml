...
external set_tooltip_item : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Tooltip.t -> Tree_path.t -> unit = "ml_gtk_icon_view_set_tooltip_item"
...
See also gtk_icon_view_set_tooltip_column() for a simpler alternative. *)
external set_tooltip_cell : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Tooltip.t -> Tree_path.t -> Cell_renderer.t option -> unit = "ml_gtk_icon_view_set_tooltip_cell"
