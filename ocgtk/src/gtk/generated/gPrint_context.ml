...
class print_context (obj : Print_context.t) : print_context_t =
  object (self)
    method create_pango_context : unit -> Ocgtk_pango.Pango.Context.context_t =
      fun () ->
        new Ocgtk_pango.Pango.Context.context
          (Print_context.create_pango_context obj)

    method create_pango_layout : unit -> Ocgtk_pango.Pango.Layout.layout_t =
      fun () ->
        new Ocgtk_pango.Pango.Layout.layout
          (Print_context.create_pango_layout obj)

    method get_cairo_context : unit -> Ocgtk_cairo.Cairo.Context.context_t =
      fun () ->
        new Ocgtk_cairo.Cairo.Context.context
          (Print_context.get_cairo_context obj)
    ...
    method get_page_setup : unit -> GPage_setup.page_setup_t =
      fun () -> new GPage_setup.page_setup (Print_context.get_page_setup obj)

    method get_pango_fontmap : unit -> Ocgtk_pango.Pango.Font_map.font_map_t =
      fun () ->
        new Ocgtk_pango.Pango.Font_map.font_map
          (Print_context.get_pango_fontmap obj)
