  ...
  object (self)
    ...
    method add_window : window_t -> unit =
      fun window ->
        ...
        Application_and__window_and__window_group.Application.add_window obj
          window

    method get_accels_for_action : string -> string array =
      fun detailed_action_name ->
        Application_and__window_and__window_group.Application
        .get_accels_for_action obj detailed_action_name

    method get_actions_for_accel : string -> string array =
      fun accel ->
        Application_and__window_and__window_group.Application
        .get_actions_for_accel obj accel

    method get_active_window : unit -> window_t option =
      fun () ->
        Option.map
          (fun ret -> new window ret)
          (Application_and__window_and__window_group.Application
           .get_active_window obj)

    method get_menu_by_id : string -> Ocgtk_gio.Gio.Menu.menu_t option =
      fun id ->
        Option.map
          (fun ret -> new Ocgtk_gio.Gio.Menu.menu ret)
          (Application_and__window_and__window_group.Application.get_menu_by_id
             obj id)
    ...
    method get_menubar : unit -> Ocgtk_gio.Gio.Menu_model.menu_model_t option =
      fun () ->
        Option.map
          ...
          (Application_and__window_and__window_group.Application.get_menubar obj)
    ...
    method get_window_by_id : int -> window_t option =
      fun id ->
        Option.map
          (fun ret -> new window ret)
          (Application_and__window_and__window_group.Application
           .get_window_by_id obj id)

    method get_windows : unit -> window_t list =
      fun () ->
        (List.map (fun ret -> new window ret))
    ...
    method inhibit :
      ...
      fun window flags reason ->
        ...
        Application_and__window_and__window_group.Application.inhibit obj window
          flags reason

    method list_action_descriptions : unit -> string array =
      fun () ->
        Application_and__window_and__window_group.Application
        .list_action_descriptions obj

    method remove_window : window_t -> unit =
      fun window ->
        let window = window#as_window in
        Application_and__window_and__window_group.Application.remove_window obj
          window

    method set_accels_for_action : string -> string array -> unit =
      fun detailed_action_name accels ->
        Application_and__window_and__window_group.Application
        .set_accels_for_action obj detailed_action_name accels

    method set_menubar : Ocgtk_gio.Gio.Menu_model.menu_model_t option -> unit =
      fun menubar ->
        let menubar = Option.map (fun c -> c#as_menu_model) menubar in
        Application_and__window_and__window_group.Application.set_menubar obj
          menubar

    method uninhibit : int -> unit =
      fun cookie ->
        Application_and__window_and__window_group.Application.uninhibit obj
          cookie

    method register_session =
      Application_and__window_and__window_group.Application.get_register_session
        obj

    method set_register_session v =
      Application_and__window_and__window_group.Application.set_register_session
        obj v
...
and window (obj : Application_and__window_and__window_group.Window.t) : window_t
  ...
  object (self)
    ...
    method destroy : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.destroy obj

    method fullscreen : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.fullscreen obj

    method fullscreen_on_monitor : Ocgtk_gdk.Gdk.Monitor.monitor_t -> unit =
      fun monitor ->
        let monitor = monitor#as_monitor in
        Application_and__window_and__window_group.Window.fullscreen_on_monitor
          obj monitor

    method get_application : unit -> application_t option =
      fun () ->
        Option.map
          (fun ret -> new application ret)
          (Application_and__window_and__window_group.Window.get_application obj)
    ...
    method get_destroy_with_parent : unit -> bool =
      fun () ->
        Application_and__window_and__window_group.Window.get_destroy_with_parent
          obj
    ...
    method get_group : unit -> window_group_t =
      fun () ->
        new window_group
          (Application_and__window_and__window_group.Window.get_group obj)

    method get_handle_menubar_accel : unit -> bool =
      fun () ->
        Application_and__window_and__window_group.Window
        .get_handle_menubar_accel obj
    ...
    method get_mnemonics_visible : unit -> bool =
      fun () ->
        Application_and__window_and__window_group.Window.get_mnemonics_visible
          obj

    method get_modal : unit -> bool =
      fun () -> Application_and__window_and__window_group.Window.get_modal obj
    ...
    method get_title : unit -> string option =
      fun () -> Application_and__window_and__window_group.Window.get_title obj
    ...
    method get_transient_for : unit -> window_t option =
      fun () ->
        Option.map
          (fun ret -> new window ret)
          (Application_and__window_and__window_group.Window.get_transient_for
             obj)

    method has_group : unit -> bool =
      fun () -> Application_and__window_and__window_group.Window.has_group obj

    method is_active : unit -> bool =
      fun () -> Application_and__window_and__window_group.Window.is_active obj
    ...
    method maximize : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.maximize obj

    method minimize : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.minimize obj

    method present : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.present obj

    method present_with_time : UInt32.t -> unit =
      fun timestamp ->
        Application_and__window_and__window_group.Window.present_with_time obj
          timestamp

    method set_application : application_t option -> unit =
      fun application ->
        let application = Option.map (fun c -> c#as_application) application in
        Application_and__window_and__window_group.Window.set_application obj
          application
    ...
    method set_decorated : bool -> unit =
      fun setting ->
        Application_and__window_and__window_group.Window.set_decorated obj
          setting

    method set_default_size : int -> int -> unit =
      fun width height ->
        Application_and__window_and__window_group.Window.set_default_size obj
          width height
    ...
    method set_default_widget :
      ...
      fun default_widget ->
        ...
        Application_and__window_and__window_group.Window.set_default_widget obj
          default_widget

    method set_deletable : bool -> unit =
      fun setting ->
        Application_and__window_and__window_group.Window.set_deletable obj
          setting

    method set_destroy_with_parent : bool -> unit =
      fun setting ->
        Application_and__window_and__window_group.Window.set_destroy_with_parent
          obj setting
    ...
    method set_handle_menubar_accel : bool -> unit =
      fun handle_menubar_accel ->
        Application_and__window_and__window_group.Window
        .set_handle_menubar_accel obj handle_menubar_accel

    method set_hide_on_close : bool -> unit =
      fun setting ->
        Application_and__window_and__window_group.Window.set_hide_on_close obj
          setting
    ...
    method set_mnemonics_visible : bool -> unit =
      fun setting ->
        Application_and__window_and__window_group.Window.set_mnemonics_visible
          obj setting
    ...
    method set_resizable : bool -> unit =
      fun resizable ->
        Application_and__window_and__window_group.Window.set_resizable obj
          resizable

    method set_startup_id : string -> unit =
      fun startup_id ->
        Application_and__window_and__window_group.Window.set_startup_id obj
          startup_id
    ...
    method set_titlebar :
      ...
      fun titlebar ->
        ...
        Application_and__window_and__window_group.Window.set_titlebar obj
          titlebar

    method set_transient_for : window_t option -> unit =
      fun parent ->
        let parent = Option.map (fun c -> c#as_window) parent in
        Application_and__window_and__window_group.Window.set_transient_for obj
          parent
    ...
    method unmaximize : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.unmaximize obj

    method unminimize : unit -> unit =
      fun () -> Application_and__window_and__window_group.Window.unminimize obj

    method default_height =
      Application_and__window_and__window_group.Window.get_default_height obj

    method set_default_height v =
      Application_and__window_and__window_group.Window.set_default_height obj v

    method default_width =
      Application_and__window_and__window_group.Window.get_default_width obj
...
and window_group
  (obj : Application_and__window_and__window_group.Window_group.t) :
  window_group_t =
  object (self)
    method add_window : window_t -> unit =
      fun window ->
        let window = window#as_window in
        Application_and__window_and__window_group.Window_group.add_window obj
          window

    method list_windows : unit -> window_t list =
      fun () ->
        (List.map (fun ret -> new window ret))
          (Application_and__window_and__window_group.Window_group.list_windows
             obj)

    method remove_window : window_t -> unit =
      fun window ->
        let window = window#as_window in
        Application_and__window_and__window_group.Window_group.remove_window obj
          window
