...
class type application_t = object
    ...
    method on_window_added : ?after:bool -> callback:(window:window_t -> unit) -> unit -> Gobject.Signal.handler_id
    method on_window_removed : ?after:bool -> callback:(window:window_t -> unit) -> unit -> Gobject.Signal.handler_id
...
and window_t = object
    ...
    inherit GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.root_t
    ...
    method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
    method get_decorated : unit -> bool
    method get_default_widget : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
    ...
    method get_titlebar : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
    ...
    method set_child : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> unit
    method set_decorated : bool -> unit
    method set_default_size : int -> int -> unit
    method set_default_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> unit
    ...
    method set_titlebar : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> unit
    ...
    method focus_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
    method set_focus_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> unit
...
class application (obj : Application_and__window_and__window_group.Application.t) : application_t = object (self)
  ...
  method on_query_end ?(after = false) ~callback () =
    Application_and__window_and__window_group.Application.on_query_end ~after self#as_application ~callback

  method on_window_added ?(after = false) ~callback () =
    Application_and__window_and__window_group.Application.on_window_added ~after self#as_application
      ~callback:(fun ~window -> callback ~window:(new window window))

  method on_window_removed ?(after = false) ~callback () =
    Application_and__window_and__window_group.Application.on_window_removed ~after self#as_application
      ~callback:(fun ~window -> callback ~window:(new window window))
...
and window (obj : Application_and__window_and__window_group.Window.t) : window_t = object (self)
  ...
  inherit GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.root (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Root.from_gobject obj)
  ...
  method on_activate_default ?(after = false) ~callback () =
    Application_and__window_and__window_group.Window.on_activate_default ~after self#as_window ~callback

  method on_activate_focus ?(after = false) ~callback () =
    Application_and__window_and__window_group.Window.on_activate_focus ~after self#as_window ~callback

  method on_close_request ?(after = false) ~callback () =
    Application_and__window_and__window_group.Window.on_close_request ~after self#as_window ~callback

  method on_enable_debugging ?(after = false) ~callback () =
    Application_and__window_and__window_group.Window.on_enable_debugging ~after self#as_window ~callback

  method on_keys_changed ?(after = false) ~callback () =
    Application_and__window_and__window_group.Window.on_keys_changed ~after self#as_window ~callback
  ...
  method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Application_and__window_and__window_group.Window.get_child obj)
  ...
  method get_default_widget : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Application_and__window_and__window_group.Window.get_default_widget obj)
  ...
  method get_titlebar : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Application_and__window_and__window_group.Window.get_titlebar obj)
  ...
  method focus_widget = new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget (Application_and__window_and__window_group.Window.get_focus_widget obj)
  method set_focus_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> unit  = fun v ->  Application_and__window_and__window_group.Window.set_focus_widget obj v#as_widget
