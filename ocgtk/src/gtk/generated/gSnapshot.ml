class type snapshot_t = object
    ...
    method append_conic_gradient : Ocgtk_graphene.Graphene.Rect.rect_t -> Ocgtk_graphene.Graphene.Point.point_t -> float -> Ocgtk_gsk.Gsk.Wrappers.Color_stop.t array -> int -> unit
    ...
    method append_linear_gradient : Ocgtk_graphene.Graphene.Rect.rect_t -> Ocgtk_graphene.Graphene.Point.point_t -> Ocgtk_graphene.Graphene.Point.point_t -> Ocgtk_gsk.Gsk.Wrappers.Color_stop.t array -> int -> unit
    ...
    method append_radial_gradient : Ocgtk_graphene.Graphene.Rect.rect_t -> Ocgtk_graphene.Graphene.Point.point_t -> float -> float -> float -> float -> Ocgtk_gsk.Gsk.Wrappers.Color_stop.t array -> int -> unit
    method append_repeating_linear_gradient : Ocgtk_graphene.Graphene.Rect.rect_t -> Ocgtk_graphene.Graphene.Point.point_t -> Ocgtk_graphene.Graphene.Point.point_t -> Ocgtk_gsk.Gsk.Wrappers.Color_stop.t array -> int -> unit
    method append_repeating_radial_gradient : Ocgtk_graphene.Graphene.Rect.rect_t -> Ocgtk_graphene.Graphene.Point.point_t -> float -> float -> float -> float -> Ocgtk_gsk.Gsk.Wrappers.Color_stop.t array -> int -> unit
    ...
    method push_shadow : Ocgtk_gsk.Gsk.Wrappers.Shadow.t array -> int -> unit
