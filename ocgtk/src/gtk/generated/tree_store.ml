...
external set_valuesv : t -> Tree_iter.t -> int array -> Gobject.Value.t array -> int -> unit = "ml_gtk_tree_store_set_valuesv"

(** Sets the data in the cell specified by @iter and @column.

The type of @value must be convertible to the type of the
column. *)
external set_value : t -> Tree_iter.t -> int -> Gobject.Value.t -> unit = "ml_gtk_tree_store_set_value"
...
tree store. *)
external set_column_types : t -> int -> Gobject.Type.t array -> unit = "ml_gtk_tree_store_set_column_types"
...
external insert_with_valuesv : t -> Tree_iter.t option -> int -> int array -> Gobject.Value.t array -> int -> Tree_iter.t = "ml_gtk_tree_store_insert_with_valuesv_bytecode" "ml_gtk_tree_store_insert_with_valuesv_native"
