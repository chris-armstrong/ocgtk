...
val on_begin_print : ?after:bool -> t -> callback:(context:Print_context.t -> unit) -> Gobject.Signal.handler_id
val on_custom_widget_apply : ?after:bool -> t -> callback:(widget:Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit) -> Gobject.Signal.handler_id
val on_done_ : ?after:bool -> t -> callback:(result:Gtk_enums.printoperationresult -> unit) -> Gobject.Signal.handler_id
val on_draw_page : ?after:bool -> t -> callback:(context:Print_context.t -> page_nr:int -> unit) -> Gobject.Signal.handler_id
val on_end_print : ?after:bool -> t -> callback:(context:Print_context.t -> unit) -> Gobject.Signal.handler_id
val on_paginate : ?after:bool -> t -> callback:(context:Print_context.t -> bool) -> Gobject.Signal.handler_id
val on_preview : ?after:bool -> t -> callback:(preview:Print_operation_preview.t -> context:Print_context.t -> parent:Application_and__window_and__window_group.Window.t option -> bool) -> Gobject.Signal.handler_id
val on_request_page_setup : ?after:bool -> t -> callback:(context:Print_context.t -> page_nr:int -> setup:Page_setup.t -> unit) -> Gobject.Signal.handler_id
val on_status_changed : ?after:bool -> t -> callback:(unit -> unit) -> Gobject.Signal.handler_id
val on_update_custom_widget : ?after:bool -> t -> callback:(widget:Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> setup:Page_setup.t -> settings:Print_settings.t -> unit) -> Gobject.Signal.handler_id
