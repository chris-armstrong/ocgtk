...
external get_value : t -> Tree_iter.t -> int -> Gobject.Value.t = "ml_gtk_tree_model_get_value"
...
external get_column_type : t -> int -> Gobject.Type.t = "ml_gtk_tree_model_get_column_type"
