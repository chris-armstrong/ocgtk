...
class text (obj : Text.t) : text_t =
  object (self)
    ...
    method get_attributes :
      ...
      fun () ->
        Option.map
          ...
          (Text.get_attributes obj)

    method get_buffer : unit -> GEntry_buffer.entry_buffer_t =
      fun () -> new GEntry_buffer.entry_buffer (Text.get_buffer obj)

    method get_enable_emoji_completion : unit -> bool =
      fun () -> Text.get_enable_emoji_completion obj
    ...
    method get_extra_menu : unit -> Ocgtk_gio.Gio.Menu_model.menu_model_t option
      ...
      fun () ->
        Option.map
          ...
          (Text.get_extra_menu obj)

    method get_input_hints : unit -> Gtk_enums.inputhints =
      fun () -> Text.get_input_hints obj

    method get_input_purpose : unit -> Gtk_enums.inputpurpose =
      fun () -> Text.get_input_purpose obj

    method get_invisible_char : unit -> int =
      fun () -> Text.get_invisible_char obj

    method get_max_length : unit -> int = fun () -> Text.get_max_length obj

    method get_overwrite_mode : unit -> bool =
      fun () -> Text.get_overwrite_mode obj

    method get_placeholder_text : unit -> string option =
      fun () -> Text.get_placeholder_text obj

    method get_propagate_text_width : unit -> bool =
      fun () -> Text.get_propagate_text_width obj
    ...
    method get_text_length : unit -> UInt16.t =
      fun () -> Text.get_text_length obj

    method get_truncate_multiline : unit -> bool =
      fun () -> Text.get_truncate_multiline obj

    method get_visibility : unit -> bool = fun () -> Text.get_visibility obj

    method grab_focus_without_selecting : unit -> bool =
      fun () -> Text.grab_focus_without_selecting obj

    method set_activates_default : bool -> unit =
      fun activates -> Text.set_activates_default obj activates
    ...
    method set_input_hints : Gtk_enums.inputhints -> unit =
      fun hints -> Text.set_input_hints obj hints

    method set_input_purpose : Gtk_enums.inputpurpose -> unit =
      fun purpose -> Text.set_input_purpose obj purpose

    method set_invisible_char : int -> unit =
      fun ch -> Text.set_invisible_char obj ch

    method set_max_length : int -> unit =
      fun length -> Text.set_max_length obj length

    method set_overwrite_mode : bool -> unit =
      fun overwrite -> Text.set_overwrite_mode obj overwrite

    method set_placeholder_text : string option -> unit =
      fun text -> Text.set_placeholder_text obj text
    ...
    method set_visibility : bool -> unit =
      fun visible -> Text.set_visibility obj visible

    method unset_invisible_char : unit -> unit =
      fun () -> Text.unset_invisible_char obj
...
let new_ () : text_t = new text (Text.new_ ())
