    ...
    method get_file : unit -> Ocgtk_gio.Gio.File.file_t option =
      fun () ->
        Option.map
          ...
          (Css_section.get_file obj)

    method get_parent : unit -> Css_section.t option =
      fun () -> Css_section.get_parent obj

    method get_start_location : unit -> Css_location.t =
      fun () -> Css_section.get_start_location obj
...
let new_ (file : Ocgtk_gio.Gio.File.file_t option) (start : Css_location.t)
