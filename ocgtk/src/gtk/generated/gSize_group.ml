class type size_group_t = object
    ...
    method add_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> unit
    method get_mode : unit -> Gtk_enums.sizegroupmode
    method get_widgets : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t list
    method remove_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> unit
...
class size_group (obj : Size_group.t) : size_group_t = object (self)
  ...
  method get_widgets : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t list =
    fun () ->
      (List.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret))(Size_group.get_widgets obj)
