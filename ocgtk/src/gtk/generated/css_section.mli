...
external new_ : Ocgtk_gio.Gio.Wrappers.File.t option -> Css_location.t -> Css_location.t -> t = "ml_gtk_css_section_new"
...
external get_file : t -> Ocgtk_gio.Gio.Wrappers.File.t option = "ml_gtk_css_section_get_file"
