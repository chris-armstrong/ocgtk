...
class numeric_sorter (obj : Numeric_sorter.t) : numeric_sorter_t =
  object (self)
    ...
    method get_expression : unit -> GExpression.expression_t option =
      fun () ->
        Option.map
          ...
          (Numeric_sorter.get_expression obj)

    method get_sort_order : unit -> Gtk_enums.sorttype =
      fun () -> Numeric_sorter.get_sort_order obj
    ...
    method set_sort_order : Gtk_enums.sorttype -> unit =
      fun sort_order -> Numeric_sorter.set_sort_order obj sort_order
