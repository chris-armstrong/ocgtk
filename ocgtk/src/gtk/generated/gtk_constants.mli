...
- [const@Gtk.ACCESSIBLE_ATTRIBUTE_STRETCH_SEMI_CONDENSED]
    @since 4.14 *)
val accessible_attribute_stretch : string
...
value is undefined. *)
val accessible_value_undefined : int
...
val im_module_extension_point_name : string
...
val media_file_extension_point_name : string
...
val text_view_priority_validate : int
