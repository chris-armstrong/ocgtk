...
external value_from_string_type : t -> Gobject.Type.t -> string -> (bool * Gobject.Value.t, GError.t) result = "ml_gtk_builder_value_from_string_type"
...
external get_type_from_name : t -> string -> Gobject.Type.t = "ml_gtk_builder_get_type_from_name"
...
external extend_with_template : t -> [`object_] Gobject.obj -> Gobject.Type.t -> string -> int -> (bool, GError.t) result = "ml_gtk_builder_extend_with_template"
