...
external activate : t -> Gtk_enums.shortcutactionflags -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Gvariant.t option -> bool = "ml_gtk_shortcut_action_activate"
