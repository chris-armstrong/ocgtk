...
[method@Gtk.IMContext.get_preedit_string] returns the empty string. *)
  method on_preedit_changed ~callback =
    Gobject.Signal.connect_simple obj ~name:"preedit-changed" ~callback ~after:false

  (** The ::preedit-end signal is emitted when a preediting sequence
has been completed or canceled. *)
  method on_preedit_end ~callback =
    Gobject.Signal.connect_simple obj ~name:"preedit-end" ~callback ~after:false

  (** The ::preedit-start signal is emitted when a new preediting sequence
starts. *)
  method on_preedit_start ~callback =
    Gobject.Signal.connect_simple obj ~name:"preedit-start" ~callback ~after:false
