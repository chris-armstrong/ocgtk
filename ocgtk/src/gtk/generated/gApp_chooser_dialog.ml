class type app_chooser_dialog_t = object
    ...
    method get_widget : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
...
class app_chooser_dialog (obj : App_chooser_dialog.t) : app_chooser_dialog_t = object (self)
  ...
  method get_widget : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t =
    fun () ->
      new  GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget(App_chooser_dialog.get_widget obj)
