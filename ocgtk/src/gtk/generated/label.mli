...
val on_activate_current_link : ?after:bool -> t -> callback:(unit -> unit) -> Gobject.Signal.handler_id
val on_activate_link : ?after:bool -> t -> callback:(uri:string -> bool) -> Gobject.Signal.handler_id
