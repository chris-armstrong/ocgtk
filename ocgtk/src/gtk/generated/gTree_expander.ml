...
class tree_expander (obj : Tree_expander.t) : tree_expander_t = object (self)
  ...
  method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Tree_expander.get_child obj)

  method get_hide_expander : unit -> bool =
    fun () ->
      (Tree_expander.get_hide_expander obj)

  method get_indent_for_depth : unit -> bool =
    fun () ->
      (Tree_expander.get_indent_for_depth obj)
  ...
  method set_hide_expander : bool -> unit =
    fun hide_expander ->
      (Tree_expander.set_hide_expander obj hide_expander)
