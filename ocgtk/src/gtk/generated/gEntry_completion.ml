class type entry_completion_t = object
    ...
    method get_entry : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
...
class entry_completion (obj : Entry_completion.t) : entry_completion_t = object (self)
  ...
  method on_insert_prefix ?(after = false) ~callback () =
    Entry_completion.on_insert_prefix ~after self#as_entry_completion ~callback
  ...
  method get_entry : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t =
    fun () ->
      new  GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget(Entry_completion.get_entry obj)
