class type file_chooser_t = object
    ...
    method add_shortcut_folder : Ocgtk_gio.Gio.file_t -> (bool, GError.t) result
    ...
    method get_current_folder : unit -> Ocgtk_gio.Gio.file_t option
    method get_current_name : unit -> string option
    method get_file : unit -> Ocgtk_gio.Gio.file_t option
    method get_files : unit -> Ocgtk_gio.Gio.list_model_t
    method get_filter : unit -> GFile_filter.file_filter_t option
    method get_filters : unit -> Ocgtk_gio.Gio.list_model_t
    method get_select_multiple : unit -> bool
    method get_shortcut_folders : unit -> Ocgtk_gio.Gio.list_model_t
    method remove_choice : string -> unit
    method remove_filter : GFile_filter.file_filter_t -> unit
    method remove_shortcut_folder : Ocgtk_gio.Gio.file_t -> (bool, GError.t) result
    ...
    method set_current_folder : Ocgtk_gio.Gio.file_t option -> (bool, GError.t) result
    method set_current_name : string -> unit
    method set_file : Ocgtk_gio.Gio.file_t -> (bool, GError.t) result
