class type gesture_t = object
  ...
  method get_last_event :
    Ocgtk_gdk.Gdk.Event_sequence.event_sequence_t option ->
    Ocgtk_gdk.Gdk.Event.event_t option

  method get_last_updated_sequence :
    unit -> Ocgtk_gdk.Gdk.Event_sequence.event_sequence_t option

  method get_sequence_state :
    Ocgtk_gdk.Gdk.Event_sequence.event_sequence_t ->
    Gtk_enums.eventsequencestate

  method get_sequences :
    unit -> Ocgtk_gdk.Gdk.Event_sequence.event_sequence_t list

  method group : gesture_t -> unit

  method handles_sequence :
    Ocgtk_gdk.Gdk.Event_sequence.event_sequence_t option -> bool
...
class gesture (obj : Gesture.t) : gesture_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .event_controller
    ...
    method get_device : unit -> Ocgtk_gdk.Gdk.Device.device_t option =
      fun () ->
        Option.map
          ...
          (Gesture.get_device obj)

    method get_group : unit -> gesture_t list =
      fun () -> (List.map (fun ret -> new gesture ret)) (Gesture.get_group obj)
    ...
    method get_last_event :
      ...
      fun sequence ->
        ...
        Option.map
          ...
          (Gesture.get_last_event obj sequence)
    ...
    method get_last_updated_sequence :
      ...
      fun () ->
        Option.map
          ...
          (Gesture.get_last_updated_sequence obj)
    ...
    method get_sequences :
      ...
      fun () ->
        (List.map (fun ret ->
             new Ocgtk_gdk.Gdk.Event_sequence.event_sequence ret))
    ...
    method is_active : unit -> bool = fun () -> Gesture.is_active obj
    ...
    method is_recognized : unit -> bool = fun () -> Gesture.is_recognized obj
    ...
    method set_state : Gtk_enums.eventsequencestate -> bool =
      fun state -> Gesture.set_state obj state

    method ungroup : unit -> unit = fun () -> Gesture.ungroup obj
