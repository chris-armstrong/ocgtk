class type dialog_t = object
    ...
    method add_action_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> int -> unit
    method add_button : string -> int -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
    method get_content_area : unit -> GBox.box_t
    method get_header_bar : unit -> GHeader_bar.header_bar_t
    method get_response_for_widget : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> int
    method get_widget_for_response : int -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
...
class dialog (obj : Dialog.t) : dialog_t = object (self)
  ...
  method add_button : string -> int -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t =
    fun button_text response_id ->
      new  GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget(Dialog.add_button obj button_text response_id)
  ...
  method get_widget_for_response : int -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun response_id ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Dialog.get_widget_for_response obj response_id)
