class type notebook_page_t = object
    method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
    method detachable : bool
    method set_detachable : bool -> unit
    method menu : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
    ...
    method tab : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
...
class notebook_page (obj : Notebook_page.t) : notebook_page_t = object (self)
  ...
  method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t =
    fun () ->
      new  GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget(Notebook_page.get_child obj)

  method detachable = Notebook_page.get_detachable obj
  method set_detachable v =  Notebook_page.set_detachable obj v

  method menu = new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget (Notebook_page.get_menu obj)
  ...
  method tab = new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget (Notebook_page.get_tab obj)
