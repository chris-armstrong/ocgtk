...
class header_bar (obj : Header_bar.t) : header_bar_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
    ...
    method get_decoration_layout : unit -> string option =
      fun () -> Header_bar.get_decoration_layout obj

    method get_show_title_buttons : unit -> bool =
      fun () -> Header_bar.get_show_title_buttons obj
    ...
    method set_decoration_layout : string option -> unit =
      fun layout -> Header_bar.set_decoration_layout obj layout

    method set_show_title_buttons : bool -> unit =
      fun setting -> Header_bar.set_show_title_buttons obj setting
...
let new_ () : header_bar_t = new header_bar (Header_bar.new_ ())
