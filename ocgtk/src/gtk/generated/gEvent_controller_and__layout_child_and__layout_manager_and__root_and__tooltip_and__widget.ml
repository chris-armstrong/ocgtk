...
and widget_t = object
  ...
  method allocate :
    int -> int -> int -> Ocgtk_gsk.Gsk.Transform.transform_t option -> unit
  ...
  method get_font_options :
    unit -> Ocgtk_cairo.Cairo.Font_options.font_options_t option

  method get_frame_clock :
    unit -> Ocgtk_gdk.Gdk.Frame_clock.frame_clock_t option
  ...
  method insert_action_group :
    string -> Ocgtk_gio.Gio.Action_group.action_group_t option -> unit
  ...
  method set_font_options :
    Ocgtk_cairo.Cairo.Font_options.font_options_t option -> unit
...
class event_controller
  ...
  object (self)
    method get_current_event : unit -> Ocgtk_gdk.Gdk.Event.event_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gdk.Gdk.Event.event ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Event_controller
           .get_current_event obj)

    method get_current_event_device :
        unit -> Ocgtk_gdk.Gdk.Device.device_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gdk.Gdk.Device.device ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Event_controller
           .get_current_event_device obj)

    method get_current_event_state : unit -> Ocgtk_gdk.Gdk.modifiertype =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Event_controller
        .get_current_event_state obj

    method get_current_event_time : unit -> UInt32.t =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Event_controller
        .get_current_event_time obj
    ...
    method set_propagation_limit : Gtk_enums.propagationlimit -> unit =
      fun limit ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Event_controller
        .set_propagation_limit obj limit

    method set_propagation_phase : Gtk_enums.propagationphase -> unit =
      fun phase ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Event_controller
        .set_propagation_phase obj phase

    method set_static_name : string option -> unit =
      fun name ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Event_controller
        .set_static_name obj name
  ...
  object (self)
    method allocate : widget_t -> int -> int -> int -> unit =
      fun widget width height baseline ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Layout_manager
        .allocate obj widget width height baseline
    ...
    method get_layout_child : widget_t -> layout_child_t =
      fun child ->
        ...
        new layout_child
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Layout_manager
           .get_layout_child obj child)

    method get_request_mode : unit -> Gtk_enums.sizerequestmode =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Layout_manager
        .get_request_mode obj
  ...
  object (self)
    ...
    method set_icon_from_gicon : Ocgtk_gio.Gio.Icon.icon_t option -> unit =
      fun gicon ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Tooltip
        .set_icon_from_gicon obj gicon

    method set_icon_from_icon_name : string option -> unit =
      fun icon_name ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Tooltip
        .set_icon_from_icon_name obj icon_name

    method set_markup : string option -> unit =
      fun markup ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Tooltip
        .set_markup obj markup
...
and widget
  ...
  object (self)
    inherit
      GAt_context_and__accessible.accessible
        (At_context_and__accessible.Accessible.from_gobject obj)
    ...
    method action_set_enabled : string -> bool -> unit =
      fun action_name enabled ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .action_set_enabled obj action_name enabled
    ...
    method activate_action_variant : string -> Gvariant.t option -> bool =
      fun name args ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .activate_action_variant obj name args

    method activate_default : unit -> unit =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .activate_default obj
    ...
    method add_controller : event_controller_t -> unit =
      fun controller ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .add_controller obj controller

    method add_css_class : string -> unit =
      fun css_class ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .add_css_class obj css_class
    ...
    method allocate :
      ...
      fun width height baseline transform ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .allocate obj width height baseline transform

    method child_focus : Gtk_enums.directiontype -> bool =
      fun direction ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .child_focus obj direction

    method compute_expand : Gtk_enums.orientation -> bool =
      fun orientation ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .compute_expand obj orientation
    ...
    method create_pango_context : unit -> Ocgtk_pango.Pango.Context.context_t =
      fun () ->
        new Ocgtk_pango.Pango.Context.context
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .create_pango_context obj)

    method create_pango_layout :
        string option -> Ocgtk_pango.Pango.Layout.layout_t =
      fun text ->
        new Ocgtk_pango.Pango.Layout.layout
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
    ...
    method dispose_template : int -> unit =
      fun widget_type ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .dispose_template obj widget_type

    method drag_check_threshold : int -> int -> int -> int -> bool =
      fun start_x start_y current_x current_y ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .drag_check_threshold obj start_x start_y current_x current_y
    ...
    method get_allocated_baseline : unit -> int =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .get_allocated_baseline obj

    method get_allocated_height : unit -> int =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .get_allocated_height obj
    ...
    method get_child_visible : unit -> bool =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .get_child_visible obj

    method get_clipboard : unit -> Ocgtk_gdk.Gdk.Clipboard.clipboard_t =
      fun () ->
        new Ocgtk_gdk.Gdk.Clipboard.clipboard
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .get_clipboard obj)
    ...
    method get_cursor : unit -> Ocgtk_gdk.Gdk.Cursor.cursor_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gdk.Gdk.Cursor.cursor ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .get_cursor obj)
    ...
    method get_font_options :
      ...
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_cairo.Cairo.Font_options.font_options ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .get_font_options obj)

    method get_frame_clock :
        unit -> Ocgtk_gdk.Gdk.Frame_clock.frame_clock_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gdk.Gdk.Frame_clock.frame_clock ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .get_frame_clock obj)
    ...
    method get_layout_manager : unit -> layout_manager_t option =
      fun () ->
        Option.map
          (fun ret -> new layout_manager ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .get_layout_manager obj)
    ...
    method get_native : unit -> GNative.native_t option =
      fun () ->
        Option.map
          (fun ret -> new GNative.native ret)
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .get_native obj)
    ...
    method get_style_context : unit -> GStyle_context.style_context_t =
      fun () ->
        new GStyle_context.style_context
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
    ...
    method get_template_child : int -> string -> [ `object_ ] Gobject.obj =
      fun widget_type name ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .get_template_child obj widget_type name

    method get_tooltip_markup : unit -> string option =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .get_tooltip_markup obj

    method get_tooltip_text : unit -> string option =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .get_tooltip_text obj
    ...
    method insert_action_group :
      ...
      fun name group ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .insert_action_group obj name group

    method insert_after : widget_t -> widget_t option -> unit =
      fun parent previous_sibling ->
        let parent = parent#as_widget in
        let previous_sibling =
          Option.map (fun c -> c#as_widget) previous_sibling
        in
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .insert_after obj parent previous_sibling
    ...
    method insert_before : widget_t -> widget_t option -> unit =
      fun parent next_sibling ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .insert_before obj parent next_sibling
    ...
    method keynav_failed : Gtk_enums.directiontype -> bool =
      fun direction ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .keynav_failed obj direction

    method list_mnemonic_labels : unit -> widget_t list =
      fun () ->
        (List.map (fun ret -> new widget ret))
          (Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
           .Widget
           .list_mnemonic_labels obj)
    ...
    method mnemonic_activate : bool -> bool =
      fun group_cycling ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .mnemonic_activate obj group_cycling
    ...
    method remove_controller : event_controller_t -> unit =
      fun controller ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .remove_controller obj controller

    method remove_css_class : string -> unit =
      fun css_class ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .remove_css_class obj css_class
    ...
    method remove_mnemonic_label : widget_t -> unit =
      fun label ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .remove_mnemonic_label obj label

    method remove_tick_callback : int -> unit =
      fun id ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .remove_tick_callback obj id

    method set_can_focus : bool -> unit =
      fun can_focus ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_can_focus obj can_focus

    method set_can_target : bool -> unit =
      fun can_target ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_can_target obj can_target

    method set_child_visible : bool -> unit =
      fun child_visible ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_child_visible obj child_visible

    method set_css_classes : string array -> unit =
      fun classes ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_css_classes obj classes
    ...
    method set_cursor_from_name : string option -> unit =
      fun name ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_cursor_from_name obj name

    method set_direction : Gtk_enums.textdirection -> unit =
      fun dir ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_direction obj dir
    ...
    method set_focus_child : widget_t option -> unit =
      fun child ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_focus_child obj child

    method set_focus_on_click : bool -> unit =
      fun focus_on_click ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_focus_on_click obj focus_on_click

    method set_focusable : bool -> unit =
      fun focusable ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_focusable obj focusable
    ...
    method set_font_options :
      ...
      fun options ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_font_options obj options

    method set_halign : Gtk_enums.align -> unit =
      fun align ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_halign obj align

    method set_has_tooltip : bool -> unit =
      fun has_tooltip ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_has_tooltip obj has_tooltip

    method set_hexpand : bool -> unit =
      fun expand ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_hexpand obj expand

    method set_hexpand_set : bool -> unit =
      fun set ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_hexpand_set obj set

    method set_layout_manager : layout_manager_t option -> unit =
      fun layout_manager ->
        let layout_manager =
          Option.map (fun c -> c#as_layout_manager) layout_manager
        in
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
    ...
    method set_margin_bottom : int -> unit =
      fun margin ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_margin_bottom obj margin

    method set_margin_end : int -> unit =
      fun margin ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_margin_end obj margin

    method set_margin_start : int -> unit =
      fun margin ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_margin_start obj margin

    method set_margin_top : int -> unit =
      fun margin ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_margin_top obj margin
    ...
    method set_receives_default : bool -> unit =
      fun receives_default ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_receives_default obj receives_default

    method set_sensitive : bool -> unit =
      fun sensitive ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_sensitive obj sensitive

    method set_size_request : int -> int -> unit =
      fun width height ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_size_request obj width height

    method set_state_flags : Gtk_enums.stateflags -> bool -> unit =
      fun flags clear ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_state_flags obj flags clear

    method set_tooltip_markup : string option -> unit =
      fun markup ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_tooltip_markup obj markup
    ...
    method set_valign : Gtk_enums.align -> unit =
      fun align ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_valign obj align

    method set_vexpand : bool -> unit =
      fun expand ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_vexpand obj expand

    method set_vexpand_set : bool -> unit =
      fun set ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .set_vexpand_set obj set
    ...
    method snapshot_child : widget_t -> GSnapshot.snapshot_t -> unit =
      fun child snapshot ->
        ...
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .snapshot_child obj child snapshot

    method trigger_tooltip_query : unit -> unit =
      fun () ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .trigger_tooltip_query obj
    ...
    method unset_state_flags : Gtk_enums.stateflags -> unit =
      fun flags ->
        Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
        .Widget
        .unset_state_flags obj flags

    method height_request =
      Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
      .Widget
      .get_height_request obj

    method set_height_request v =
      Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
      .Widget
      .set_height_request obj v

    method width_request =
      Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
      .Widget
      .get_width_request obj

    method set_width_request v =
      Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget
      .Widget
      .set_width_request obj v
