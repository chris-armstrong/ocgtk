...
class label (obj : Label.t) : label_t =
  object (self)
    ...
    method get_attributes :
      ...
      fun () ->
        Option.map
          ...
          (Label.get_attributes obj)

    method get_current_uri : unit -> string option =
      fun () -> Label.get_current_uri obj

    method get_ellipsize : unit -> Ocgtk_pango.Pango.ellipsizemode =
      fun () -> Label.get_ellipsize obj
    ...
    method get_extra_menu : unit -> Ocgtk_gio.Gio.Menu_model.menu_model_t option
      ...
      fun () ->
        Option.map
          ...
          (Label.get_extra_menu obj)

    method get_justify : unit -> Gtk_enums.justification =
      fun () -> Label.get_justify obj

    method get_label : unit -> string = fun () -> Label.get_label obj

    method get_layout : unit -> Ocgtk_pango.Pango.Layout.layout_t =
      fun () -> new Ocgtk_pango.Pango.Layout.layout (Label.get_layout obj)

    method get_lines : unit -> int = fun () -> Label.get_lines obj

    method get_max_width_chars : unit -> int =
      fun () -> Label.get_max_width_chars obj

    method get_mnemonic_keyval : unit -> int =
      fun () -> Label.get_mnemonic_keyval obj
    ...
    method get_natural_wrap_mode : unit -> Gtk_enums.naturalwrapmode =
      fun () -> Label.get_natural_wrap_mode obj

    method get_selectable : unit -> bool = fun () -> Label.get_selectable obj

    method get_single_line_mode : unit -> bool =
      fun () -> Label.get_single_line_mode obj
    ...
    method set_ellipsize : Ocgtk_pango.Pango.ellipsizemode -> unit =
      fun mode -> Label.set_ellipsize obj mode
    ...
    method set_justify : Gtk_enums.justification -> unit =
      fun jtype -> Label.set_justify obj jtype
    ...
    method set_markup_with_mnemonic : string -> unit =
      fun str -> Label.set_markup_with_mnemonic obj str
    ...
    method set_natural_wrap_mode : Gtk_enums.naturalwrapmode -> unit =
      fun wrap_mode -> Label.set_natural_wrap_mode obj wrap_mode

    method set_selectable : bool -> unit =
      fun setting -> Label.set_selectable obj setting

    method set_single_line_mode : bool -> unit =
      fun single_line_mode -> Label.set_single_line_mode obj single_line_mode
    ...
    method set_text_with_mnemonic : string -> unit =
      fun str -> Label.set_text_with_mnemonic obj str

    method set_use_markup : bool -> unit =
      fun setting -> Label.set_use_markup obj setting

    method set_use_underline : bool -> unit =
      fun setting -> Label.set_use_underline obj setting

    method set_width_chars : int -> unit =
      fun n_chars -> Label.set_width_chars obj n_chars

    method set_wrap : bool -> unit = fun wrap -> Label.set_wrap obj wrap

    method set_wrap_mode : Ocgtk_pango.Pango.wrapmode -> unit =
      fun wrap_mode -> Label.set_wrap_mode obj wrap_mode

    method set_xalign : float -> unit =
      fun xalign -> Label.set_xalign obj xalign

    method set_yalign : float -> unit =
      fun yalign -> Label.set_yalign obj yalign
