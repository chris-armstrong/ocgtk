...
class im_context (obj : Im_context.t) : im_context_t =
  object (self)
    ...
    method delete_surrounding : int -> int -> bool =
      fun offset n_chars -> Im_context.delete_surrounding obj offset n_chars
    ...
    method set_surrounding_with_selection : string -> int -> int -> int -> unit
      ...
      fun text len cursor_index anchor_index ->
        Im_context.set_surrounding_with_selection obj text len cursor_index
          anchor_index

    method set_use_preedit : bool -> unit =
      fun use_preedit -> Im_context.set_use_preedit obj use_preedit
