...
class type icon_theme_t = object
    ...
    method get_display : unit -> Ocgtk_gdk.Gdk.display_t option
    ...
    method has_gicon : Ocgtk_gio.Gio.icon_t -> bool
    method has_icon : string -> bool
    method lookup_by_gicon : Ocgtk_gio.Gio.icon_t -> int -> int -> Gtk_enums.textdirection -> Gtk_enums.iconlookupflags -> GIcon_paintable.icon_paintable_t
...
class icon_theme (obj : Icon_theme.t) : icon_theme_t = object (self)
