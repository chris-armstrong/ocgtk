...
external remove_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_size_group_remove_widget"

(** Returns the list of widgets associated with @size_group. *)
external get_widgets : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t list = "ml_gtk_size_group_get_widgets"
...
external add_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_size_group_add_widget"
