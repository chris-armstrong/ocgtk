class type cell_renderer_t = object
    method on_editing_canceled : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_editing_started : ?after:bool -> callback:(editable:GCell_editable.cell_editable_t -> path:string -> unit) -> unit -> Gobject.Signal.handler_id
    method activate : Ocgtk_gdk.Gdk.Event.event_t -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> string -> Ocgtk_gdk.Gdk.Rectangle.rectangle_t -> Ocgtk_gdk.Gdk.Rectangle.rectangle_t -> Gtk_enums.cellrendererstate -> bool
    ...
    method get_state : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> Gtk_enums.cellrendererstate -> Gtk_enums.stateflags
    ...
    method snapshot : GSnapshot.snapshot_t -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> Ocgtk_gdk.Gdk.Rectangle.rectangle_t -> Ocgtk_gdk.Gdk.Rectangle.rectangle_t -> Gtk_enums.cellrendererstate -> unit
    method start_editing : Ocgtk_gdk.Gdk.Event.event_t option -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> string -> Ocgtk_gdk.Gdk.Rectangle.rectangle_t -> Ocgtk_gdk.Gdk.Rectangle.rectangle_t -> Gtk_enums.cellrendererstate -> GCell_editable.cell_editable_t option
...
class cell_renderer (obj : Cell_renderer.t) : cell_renderer_t = object (self)
  ...
  method on_editing_started ?(after = false) ~callback () =
    Cell_renderer.on_editing_started ~after self#as_cell_renderer
      ~callback:(fun ~editable ~path -> callback ~editable:(new GCell_editable.cell_editable editable) ~path)
