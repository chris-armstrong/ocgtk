...
class cell_renderer_pixbuf (obj : Cell_renderer_pixbuf.t) : cell_renderer_pixbuf_t = object (self)
  ...
  method set_pixbuf : Ocgtk_gdkpixbuf.GdkPixbuf.pixbuf_t -> unit  = fun v ->  Cell_renderer_pixbuf.set_pixbuf obj v#as_pixbuf

  method pixbuf_expander_closed = new Ocgtk_gdkpixbuf.GdkPixbuf.pixbuf (Cell_renderer_pixbuf.get_pixbuf_expander_closed obj)
  method set_pixbuf_expander_closed : Ocgtk_gdkpixbuf.GdkPixbuf.pixbuf_t -> unit  = fun v ->  Cell_renderer_pixbuf.set_pixbuf_expander_closed obj v#as_pixbuf

  method pixbuf_expander_open = new Ocgtk_gdkpixbuf.GdkPixbuf.pixbuf (Cell_renderer_pixbuf.get_pixbuf_expander_open obj)
  method set_pixbuf_expander_open : Ocgtk_gdkpixbuf.GdkPixbuf.pixbuf_t -> unit  = fun v ->  Cell_renderer_pixbuf.set_pixbuf_expander_open obj v#as_pixbuf

  method texture = new Ocgtk_gdk.Gdk.texture (Cell_renderer_pixbuf.get_texture obj)
  method set_texture : Ocgtk_gdk.Gdk.texture_t -> unit  = fun v ->  Cell_renderer_pixbuf.set_texture obj v#as_texture
