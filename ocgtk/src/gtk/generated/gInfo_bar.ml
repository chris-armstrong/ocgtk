...
class info_bar (obj : Info_bar.t) : info_bar_t =
  object (self)
    ...
    method get_message_type : unit -> Gtk_enums.messagetype =
      fun () -> Info_bar.get_message_type obj
    ...
    method response : int -> unit =
      fun response_id -> Info_bar.response obj response_id

    method set_default_response : int -> unit =
      fun response_id -> Info_bar.set_default_response obj response_id

    method set_message_type : Gtk_enums.messagetype -> unit =
      fun message_type -> Info_bar.set_message_type obj message_type
    ...
    method set_revealed : bool -> unit =
      fun revealed -> Info_bar.set_revealed obj revealed

    method set_show_close_button : bool -> unit =
      fun setting -> Info_bar.set_show_close_button obj setting

    method as_info_bar = obj
  end

let new_ () : info_bar_t = new info_bar (Info_bar.new_ ())
