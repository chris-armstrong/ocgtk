...
class actionable (obj : Actionable.t) : actionable_t =
  object (self)
    method get_action_name : unit -> string option =
      fun () -> Actionable.get_action_name obj

    method get_action_target_value : unit -> Gvariant.t option =
      fun () -> Actionable.get_action_target_value obj

    method set_action_name : string option -> unit =
      fun action_name -> Actionable.set_action_name obj action_name

    method set_action_target_value : Gvariant.t option -> unit =
      fun target_value -> Actionable.set_action_target_value obj target_value
