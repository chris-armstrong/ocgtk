class type entry_t = object
    ...
    method on_icon_press : ?after:bool -> callback:(icon_pos:Gtk_enums.entryiconposition -> unit) -> unit -> Gobject.Signal.handler_id
    method on_icon_release : ?after:bool -> callback:(icon_pos:Gtk_enums.entryiconposition -> unit) -> unit -> Gobject.Signal.handler_id
