class type entry_t = object
  ...
  method get_icon_gicon :
    Gtk_enums.entryiconposition -> Ocgtk_gio.Gio.Icon.icon_t option

  method get_icon_name : Gtk_enums.entryiconposition -> string option

  method get_icon_paintable :
    Gtk_enums.entryiconposition -> Ocgtk_gdk.Gdk.Paintable.paintable_t option

  method get_icon_sensitive : Gtk_enums.entryiconposition -> bool

  method get_icon_storage_type :
    Gtk_enums.entryiconposition -> Gtk_enums.imagetype
  ...
  method set_icon_drag_source :
    ...
    Ocgtk_gdk.Gdk.Content_provider.content_provider_t ->
    Ocgtk_gdk.Gdk.dragaction ->
    unit

  method set_icon_from_gicon :
    Gtk_enums.entryiconposition -> Ocgtk_gio.Gio.Icon.icon_t option -> unit

  method set_icon_from_icon_name :
    Gtk_enums.entryiconposition -> string option -> unit
  ...
  method set_primary_icon_paintable :
    Ocgtk_gdk.Gdk.Paintable.paintable_t -> unit
  ...
  method set_secondary_icon_paintable :
    Ocgtk_gdk.Gdk.Paintable.paintable_t -> unit
...
class entry (obj : Entry.t) : entry_t =
  object (self)
    ...
    method get_attributes :
      ...
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_pango.Pango.Attr_list.attr_list ret)
          (Entry.get_attributes obj)

    method get_buffer : unit -> GEntry_buffer.entry_buffer_t =
      fun () -> new GEntry_buffer.entry_buffer (Entry.get_buffer obj)

    method get_completion : unit -> GEntry_completion.entry_completion_t option
        =
      fun () ->
        Option.map
          (fun ret -> new GEntry_completion.entry_completion ret)
          (Entry.get_completion obj)

    method get_current_icon_drag_source : unit -> int =
      fun () -> Entry.get_current_icon_drag_source obj
    ...
    method get_extra_menu : unit -> Ocgtk_gio.Gio.Menu_model.menu_model_t option
      ...
      fun () ->
        Option.map
          ...
          (Entry.get_extra_menu obj)

    method get_has_frame : unit -> bool = fun () -> Entry.get_has_frame obj

    method get_icon_activatable : Gtk_enums.entryiconposition -> bool =
      fun icon_pos -> Entry.get_icon_activatable obj icon_pos

    method get_icon_at_pos : int -> int -> int =
      fun x y -> Entry.get_icon_at_pos obj x y
    ...
    method get_icon_gicon :
      ...
      fun icon_pos ->
        Option.map
          ...
          (Entry.get_icon_gicon obj icon_pos)

    method get_icon_name : Gtk_enums.entryiconposition -> string option =
      fun icon_pos -> Entry.get_icon_name obj icon_pos
    ...
    method get_icon_paintable :
      ...
      fun icon_pos ->
        Option.map
          ...
          (Entry.get_icon_paintable obj icon_pos)

    method get_icon_sensitive : Gtk_enums.entryiconposition -> bool =
      fun icon_pos -> Entry.get_icon_sensitive obj icon_pos

    method get_icon_storage_type :
        Gtk_enums.entryiconposition -> Gtk_enums.imagetype =
      fun icon_pos -> Entry.get_icon_storage_type obj icon_pos

    method get_icon_tooltip_markup :
        Gtk_enums.entryiconposition -> string option =
      fun icon_pos -> Entry.get_icon_tooltip_markup obj icon_pos

    method get_icon_tooltip_text : Gtk_enums.entryiconposition -> string option
        =
      fun icon_pos -> Entry.get_icon_tooltip_text obj icon_pos

    method get_input_hints : unit -> Gtk_enums.inputhints =
      fun () -> Entry.get_input_hints obj

    method get_input_purpose : unit -> Gtk_enums.inputpurpose =
      fun () -> Entry.get_input_purpose obj

    method get_invisible_char : unit -> int =
      fun () -> Entry.get_invisible_char obj
    ...
    method get_placeholder_text : unit -> string option =
      fun () -> Entry.get_placeholder_text obj

    method get_progress_fraction : unit -> float =
      fun () -> Entry.get_progress_fraction obj

    method get_progress_pulse_step : unit -> float =
      fun () -> Entry.get_progress_pulse_step obj

    method get_tabs : unit -> Ocgtk_pango.Pango.Tab_array.tab_array_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_pango.Pango.Tab_array.tab_array ret)
          (Entry.get_tabs obj)

    method get_text_length : unit -> UInt16.t =
      fun () -> Entry.get_text_length obj

    method get_visibility : unit -> bool = fun () -> Entry.get_visibility obj

    method grab_focus_without_selecting : unit -> bool =
      fun () -> Entry.grab_focus_without_selecting obj

    method progress_pulse : unit -> unit = fun () -> Entry.progress_pulse obj

    method reset_im_context : unit -> unit =
      fun () -> Entry.reset_im_context obj

    method set_activates_default : bool -> unit =
      fun setting -> Entry.set_activates_default obj setting
    ...
    method set_completion : GEntry_completion.entry_completion_t option -> unit
      ...
      fun completion ->
        let completion =
          Option.map (fun c -> c#as_entry_completion) completion
        in
    ...
    method set_has_frame : bool -> unit =
      fun setting -> Entry.set_has_frame obj setting
    ...
    method set_icon_sensitive : Gtk_enums.entryiconposition -> bool -> unit =
      fun icon_pos sensitive -> Entry.set_icon_sensitive obj icon_pos sensitive

    method set_icon_tooltip_markup :
        Gtk_enums.entryiconposition -> string option -> unit =
      fun icon_pos tooltip -> Entry.set_icon_tooltip_markup obj icon_pos tooltip

    method set_icon_tooltip_text :
        Gtk_enums.entryiconposition -> string option -> unit =
      fun icon_pos tooltip -> Entry.set_icon_tooltip_text obj icon_pos tooltip

    method set_input_hints : Gtk_enums.inputhints -> unit =
      fun hints -> Entry.set_input_hints obj hints

    method set_input_purpose : Gtk_enums.inputpurpose -> unit =
      fun purpose -> Entry.set_input_purpose obj purpose

    method set_invisible_char : int -> unit =
      fun ch -> Entry.set_invisible_char obj ch
    ...
    method set_placeholder_text : string option -> unit =
      fun text -> Entry.set_placeholder_text obj text

    method set_progress_fraction : float -> unit =
      fun fraction -> Entry.set_progress_fraction obj fraction

    method set_progress_pulse_step : float -> unit =
      fun fraction -> Entry.set_progress_pulse_step obj fraction
    ...
    method set_visibility : bool -> unit =
      fun visible -> Entry.set_visibility obj visible

    method unset_invisible_char : unit -> unit =
      fun () -> Entry.unset_invisible_char obj

    method enable_emoji_completion = Entry.get_enable_emoji_completion obj

    method set_enable_emoji_completion v =
      Entry.set_enable_emoji_completion obj v
    ...
    method set_primary_icon_activatable v =
      Entry.set_primary_icon_activatable obj v

    method primary_icon_gicon =
      new Ocgtk_gio.Gio.Icon.icon (Entry.get_primary_icon_gicon obj)

    method set_primary_icon_gicon : Ocgtk_gio.Gio.Icon.icon_t -> unit =
      fun v -> Entry.set_primary_icon_gicon obj v#as_icon

    method primary_icon_name = Entry.get_primary_icon_name obj
    method set_primary_icon_name v = Entry.set_primary_icon_name obj v

    method primary_icon_paintable =
      new Ocgtk_gdk.Gdk.Paintable.paintable
        (Entry.get_primary_icon_paintable obj)

    method set_primary_icon_paintable :
        Ocgtk_gdk.Gdk.Paintable.paintable_t -> unit =
      fun v -> Entry.set_primary_icon_paintable obj v#as_paintable
    ...
    method primary_icon_tooltip_markup =
      Entry.get_primary_icon_tooltip_markup obj

    method set_primary_icon_tooltip_markup v =
      Entry.set_primary_icon_tooltip_markup obj v

    method primary_icon_tooltip_text = Entry.get_primary_icon_tooltip_text obj

    method set_primary_icon_tooltip_text v =
      Entry.set_primary_icon_tooltip_text obj v
    ...
    method set_secondary_icon_activatable v =
      Entry.set_secondary_icon_activatable obj v

    method secondary_icon_gicon =
      new Ocgtk_gio.Gio.Icon.icon (Entry.get_secondary_icon_gicon obj)

    method set_secondary_icon_gicon : Ocgtk_gio.Gio.Icon.icon_t -> unit =
      fun v -> Entry.set_secondary_icon_gicon obj v#as_icon
    ...
    method secondary_icon_paintable =
      new Ocgtk_gdk.Gdk.Paintable.paintable
        (Entry.get_secondary_icon_paintable obj)

    method set_secondary_icon_paintable :
        Ocgtk_gdk.Gdk.Paintable.paintable_t -> unit =
      fun v -> Entry.set_secondary_icon_paintable obj v#as_paintable

    method secondary_icon_sensitive = Entry.get_secondary_icon_sensitive obj

    method set_secondary_icon_sensitive v =
      Entry.set_secondary_icon_sensitive obj v

    method secondary_icon_storage_type =
      Entry.get_secondary_icon_storage_type obj

    method secondary_icon_tooltip_markup =
      Entry.get_secondary_icon_tooltip_markup obj

    method set_secondary_icon_tooltip_markup v =
      Entry.set_secondary_icon_tooltip_markup obj v

    method secondary_icon_tooltip_text =
      Entry.get_secondary_icon_tooltip_text obj

    method set_secondary_icon_tooltip_text v =
      Entry.set_secondary_icon_tooltip_text obj v
...
let new_ () : entry_t = new entry (Entry.new_ ())
