...
class shortcuts_shortcut (obj : Shortcuts_shortcut.t) : shortcuts_shortcut_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
    ...
    method set_accel_size_group : GSize_group.size_group_t -> unit =
      fun v -> Shortcuts_shortcut.set_accel_size_group obj v#as_size_group
    ...
    method set_icon : Ocgtk_gio.Gio.Icon.icon_t -> unit =
      fun v -> Shortcuts_shortcut.set_icon obj v#as_icon
    ...
    method set_title_size_group : GSize_group.size_group_t -> unit =
      fun v -> Shortcuts_shortcut.set_title_size_group obj v#as_size_group
