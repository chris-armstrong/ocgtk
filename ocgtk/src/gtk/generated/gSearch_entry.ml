...
class search_entry (obj : Search_entry.t) : search_entry_t = object (self)
  ...
  method get_key_capture_widget : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Search_entry.get_key_capture_widget obj)
