...
(** Create a new TreeRowReference *)
external new_proxy : [`object_] Gobject.obj -> Tree_model.t -> Tree_path.t -> t = "ml_gtk_tree_row_reference_new_proxy"
...
external get_type : unit -> Gobject.Type.t = "ml_gtk_tree_row_reference_get_type"
