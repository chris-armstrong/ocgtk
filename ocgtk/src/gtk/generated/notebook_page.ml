...
external get_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t = "ml_gtk_notebook_page_get_child"
...
(** Get property: menu *)
external get_menu : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t = "ml_gtk_notebook_page_get_menu"
...
(** Get property: tab *)
external get_tab : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t = "ml_gtk_notebook_page_get_tab"
