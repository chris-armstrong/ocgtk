...
class cell_renderer_toggle (obj : Cell_renderer_toggle.t) :
  ...
  object (self)
    ...
    method get_active : unit -> bool =
      fun () -> Cell_renderer_toggle.get_active obj

    method get_radio : unit -> bool =
      fun () -> Cell_renderer_toggle.get_radio obj

    method set_activatable : bool -> unit =
      fun setting -> Cell_renderer_toggle.set_activatable obj setting

    method set_active : bool -> unit =
      fun setting -> Cell_renderer_toggle.set_active obj setting

    method set_radio : bool -> unit =
      fun radio -> Cell_renderer_toggle.set_radio obj radio
