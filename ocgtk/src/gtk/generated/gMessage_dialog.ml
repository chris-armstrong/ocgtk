...
class message_dialog (obj : Message_dialog.t) : message_dialog_t =
  object (self)
    ...
    method get_message_area :
      ...
      fun () ->
        new
          GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
          .widget
          (Message_dialog.get_message_area obj)

    method set_markup : string -> unit =
      fun str -> Message_dialog.set_markup obj str
    ...
    method set_secondary_use_markup v =
      Message_dialog.set_secondary_use_markup obj v
