...
(see [method@Gtk.Widget.show]) in order to become the visible
child of @stack. *)
external set_visible_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_stack_set_visible_child"
...
external remove : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_stack_remove"
...
external get_visible_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_stack_get_visible_child"
...
external get_page : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Stack_page.t = "ml_gtk_stack_get_page"
...
external get_child_by_name : t -> string -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_stack_get_child_by_name"
...
external add_titled : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> string option -> string -> Stack_page.t = "ml_gtk_stack_add_titled"

(** Adds a child to @stack.

The child is identified by the @name. *)
external add_named : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> string option -> Stack_page.t = "ml_gtk_stack_add_named"

(** Adds a child to @stack. *)
external add_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Stack_page.t = "ml_gtk_stack_add_child"
