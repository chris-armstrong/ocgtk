...
class shortcuts_group (obj : Shortcuts_group.t) : shortcuts_group_t =
  object (self)
    ...
    method set_accel_size_group : GSize_group.size_group_t -> unit =
      fun v -> Shortcuts_group.set_accel_size_group obj v#as_size_group
    ...
    method set_title_size_group : GSize_group.size_group_t -> unit =
      fun v -> Shortcuts_group.set_title_size_group obj v#as_size_group
