...
val on_create_context : ?after:bool -> t -> callback:(unit -> Ocgtk_gdk.Gdk.Wrappers.Gl_context.t) -> Gobject.Signal.handler_id
val on_render : ?after:bool -> t -> callback:(context:Ocgtk_gdk.Gdk.Wrappers.Gl_context.t -> bool) -> Gobject.Signal.handler_id
