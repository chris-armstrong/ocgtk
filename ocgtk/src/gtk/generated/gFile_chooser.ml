class type file_chooser_t = object
  method add_choice :
    string -> string -> string array option -> string array option -> unit

  method add_filter : GFile_filter.file_filter_t -> unit

  method add_shortcut_folder :
    Ocgtk_gio.Gio.File.file_t -> (bool, GError.t) result
  ...
  method set_current_folder :
    Ocgtk_gio.Gio.File.file_t option -> (bool, GError.t) result
...
class file_chooser (obj : File_chooser.t) : file_chooser_t =
  object (self)
    method add_choice :
        string -> string -> string array option -> string array option -> unit =
    ...
    method get_action : unit -> Gtk_enums.filechooseraction =
      fun () -> File_chooser.get_action obj

    method get_choice : string -> string option =
      fun id -> File_chooser.get_choice obj id

    method get_create_folders : unit -> bool =
      fun () -> File_chooser.get_create_folders obj

    method get_current_folder : unit -> Ocgtk_gio.Gio.File.file_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gio.Gio.File.file ret)
          (File_chooser.get_current_folder obj)

    method get_current_name : unit -> string option =
      fun () -> File_chooser.get_current_name obj

    method get_file : unit -> Ocgtk_gio.Gio.File.file_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gio.Gio.File.file ret)
          (File_chooser.get_file obj)
    ...
    method get_select_multiple : unit -> bool =
      fun () -> File_chooser.get_select_multiple obj

    method get_shortcut_folders : unit -> Ocgtk_gio.Gio.List_model.list_model_t
        =
      fun () ->
        new Ocgtk_gio.Gio.List_model.list_model
          (File_chooser.get_shortcut_folders obj)

    method remove_choice : string -> unit =
      fun id -> File_chooser.remove_choice obj id
    ...
    method set_action : Gtk_enums.filechooseraction -> unit =
      fun action -> File_chooser.set_action obj action

    method set_choice : string -> string -> unit =
      fun id option -> File_chooser.set_choice obj id option

    method set_create_folders : bool -> unit =
      fun create_folders -> File_chooser.set_create_folders obj create_folders
    ...
    method set_current_name : string -> unit =
      fun name -> File_chooser.set_current_name obj name
