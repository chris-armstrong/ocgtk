...
val new_ : unit -> video_t
val new_for_file : Ocgtk_gio.Gio.File.file_t option -> video_t
val new_for_filename : string option -> video_t
val new_for_media_stream : GMedia_stream.media_stream_t option -> video_t
val new_for_resource : string option -> video_t
