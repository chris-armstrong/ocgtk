...
val on_accel_cleared : ?after:bool -> t -> callback:(path_string:string -> unit) -> Gobject.Signal.handler_id
val on_accel_edited : ?after:bool -> t -> callback:(path_string:string -> accel_key:int -> accel_mods:Ocgtk_gdk.Gdk_enums.modifiertype -> hardware_keycode:int -> unit) -> Gobject.Signal.handler_id
