...
class expander (obj : Expander.t) : expander_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Expander.get_label_widget obj)

    method get_resize_toplevel : unit -> bool =
      fun () -> Expander.get_resize_toplevel obj

    method get_use_markup : unit -> bool = fun () -> Expander.get_use_markup obj

    method get_use_underline : unit -> bool =
      fun () -> Expander.get_use_underline obj
    ...
    method set_expanded : bool -> unit =
      fun expanded -> Expander.set_expanded obj expanded

    method set_label : string option -> unit =
      fun label -> Expander.set_label obj label
    ...
    method set_resize_toplevel : bool -> unit =
      fun resize_toplevel -> Expander.set_resize_toplevel obj resize_toplevel

    method set_use_markup : bool -> unit =
      fun use_markup -> Expander.set_use_markup obj use_markup

    method set_use_underline : bool -> unit =
      fun use_underline -> Expander.set_use_underline obj use_underline
