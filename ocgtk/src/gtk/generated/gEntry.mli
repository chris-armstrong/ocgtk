class entry : Entry.t ->
  object
    ...
    method set_icon_drag_source : Gtk_enums.entryiconposition -> #Ocgtk_gdk.Gdk.content_provider -> Ocgtk_gdk.Gdk.dragaction -> unit
    method set_icon_from_gicon : Gtk_enums.entryiconposition -> #Ocgtk_gio.Gio.icon option -> unit
    method set_icon_from_icon_name : Gtk_enums.entryiconposition -> string option -> unit
    method set_icon_from_paintable : Gtk_enums.entryiconposition -> #Ocgtk_gdk.Gdk.paintable option -> unit
    ...
    method primary_icon_gicon : Ocgtk_gio.Gio.icon
    method set_primary_icon_gicon : #Ocgtk_gio.Gio.icon -> unit
    method primary_icon_name : string
    method set_primary_icon_name : string -> unit
    method primary_icon_paintable : Ocgtk_gdk.Gdk.paintable
    method set_primary_icon_paintable : #Ocgtk_gdk.Gdk.paintable -> unit
    ...
    method secondary_icon_gicon : Ocgtk_gio.Gio.icon
    method set_secondary_icon_gicon : #Ocgtk_gio.Gio.icon -> unit
    method secondary_icon_name : string
    method set_secondary_icon_name : string -> unit
    method secondary_icon_paintable : Ocgtk_gdk.Gdk.paintable
    method set_secondary_icon_paintable : #Ocgtk_gdk.Gdk.paintable -> unit
