...
external set_title_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_header_bar_set_title_widget"
...
external remove : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_header_bar_remove"

(** Adds @child to @bar, packed with reference to the
start of the @bar. *)
external pack_start : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_header_bar_pack_start"

(** Adds @child to @bar, packed with reference to the
end of the @bar. *)
external pack_end : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_header_bar_pack_end"

(** Retrieves the title widget of the header.

See [method@Gtk.HeaderBar.set_title_widget]. *)
external get_title_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_header_bar_get_title_widget"
