...
and tree_view_t = object
  ...
  method enable_model_drag_dest :
    Ocgtk_gdk.Gdk.Content_formats.content_formats_t ->
  ...
  method get_expander_column :
    unit -> GTree_view_column.tree_view_column_t option
  ...
  method move_column_after :
    GTree_view_column.tree_view_column_t ->
  ...
  method row_activated :
    Tree_path.t -> GTree_view_column.tree_view_column_t option -> unit
  ...
  method set_drag_dest_row :
    Tree_path.t option -> Gtk_enums.treeviewdropposition -> unit

  method set_enable_search : bool -> unit
  method set_enable_tree_lines : bool -> unit

  method set_expander_column :
    GTree_view_column.tree_view_column_t option -> unit
...
class tree_selection (obj : Tree_selection_and__tree_view.Tree_selection.t) :
  ...
  object (self)
    ...
    method get_mode : unit -> Gtk_enums.selectionmode =
      fun () -> Tree_selection_and__tree_view.Tree_selection.get_mode obj

    method get_tree_view : unit -> tree_view_t =
      fun () ->
        new tree_view
          (Tree_selection_and__tree_view.Tree_selection.get_tree_view obj)
    ...
    method select_all : unit -> unit =
      fun () -> Tree_selection_and__tree_view.Tree_selection.select_all obj
    ...
    method select_range : Tree_path.t -> Tree_path.t -> unit =
      fun start_path end_path ->
        Tree_selection_and__tree_view.Tree_selection.select_range obj start_path
          end_path
    ...
    method unselect_all : unit -> unit =
      fun () -> Tree_selection_and__tree_view.Tree_selection.unselect_all obj
    ...
    method unselect_range : Tree_path.t -> Tree_path.t -> unit =
      fun start_path end_path ->
        Tree_selection_and__tree_view.Tree_selection.unselect_range obj
          start_path end_path
...
and tree_view (obj : Tree_selection_and__tree_view.Tree_view.t) : tree_view_t =
  object (self)
    ...
    method collapse_all : unit -> unit =
      fun () -> Tree_selection_and__tree_view.Tree_view.collapse_all obj

    method collapse_row : Tree_path.t -> bool =
      fun path -> Tree_selection_and__tree_view.Tree_view.collapse_row obj path

    method columns_autosize : unit -> unit =
      fun () -> Tree_selection_and__tree_view.Tree_view.columns_autosize obj
    ...
    method create_row_drag_icon :
      ...
      fun path ->
        Option.map
          ...
          (Tree_selection_and__tree_view.Tree_view.create_row_drag_icon obj path)
    ...
    method enable_model_drag_dest :
      ...
      fun formats actions ->
        ...
        Tree_selection_and__tree_view.Tree_view.enable_model_drag_dest obj
          formats actions
    ...
    method enable_model_drag_source :
      ...
      fun start_button_mask formats actions ->
        let formats = formats#as_content_formats in
        Tree_selection_and__tree_view.Tree_view.enable_model_drag_source obj
          start_button_mask formats actions

    method expand_all : unit -> unit =
      fun () -> Tree_selection_and__tree_view.Tree_view.expand_all obj
    ...
    method get_column : int -> GTree_view_column.tree_view_column_t option =
      fun n ->
        Option.map
          (fun ret -> new GTree_view_column.tree_view_column ret)
          (Tree_selection_and__tree_view.Tree_view.get_column obj n)

    method get_columns : unit -> GTree_view_column.tree_view_column_t list =
      fun () ->
        (List.map (fun ret -> new GTree_view_column.tree_view_column ret))
          (Tree_selection_and__tree_view.Tree_view.get_columns obj)

    method get_enable_search : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_enable_search obj
    ...
    method get_expander_column :
      ...
      fun () ->
        Option.map
          (fun ret -> new GTree_view_column.tree_view_column ret)
          (Tree_selection_and__tree_view.Tree_view.get_expander_column obj)
    ...
    method get_grid_lines : unit -> Gtk_enums.treeviewgridlines =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_grid_lines obj
    ...
    method get_headers_visible : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_headers_visible obj

    method get_hover_expand : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_hover_expand obj

    method get_hover_selection : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_hover_selection obj
    ...
    method get_model : unit -> GTree_model.tree_model_t option =
      fun () ->
        Option.map
          ...
          (Tree_selection_and__tree_view.Tree_view.get_model obj)

    method get_n_columns : unit -> int =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_n_columns obj

    method get_reorderable : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_reorderable obj

    method get_rubber_banding : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_rubber_banding obj

    method get_search_column : unit -> int =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_search_column obj

    method get_search_entry : unit -> GEditable.editable_t option =
      fun () ->
        Option.map
          (fun ret -> new GEditable.editable ret)
          (Tree_selection_and__tree_view.Tree_view.get_search_entry obj)

    method get_selection : unit -> tree_selection_t =
      fun () ->
        new tree_selection
          (Tree_selection_and__tree_view.Tree_view.get_selection obj)

    method get_show_expanders : unit -> bool =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_show_expanders obj

    method get_tooltip_column : unit -> int =
      fun () -> Tree_selection_and__tree_view.Tree_view.get_tooltip_column obj

    method insert_column : GTree_view_column.tree_view_column_t -> int -> int =
      fun column position ->
        let column = column#as_tree_view_column in
        Tree_selection_and__tree_view.Tree_view.insert_column obj column
          position
    ...
    method move_column_after :
      ...
      fun column base_column ->
        let column = column#as_tree_view_column in
        let base_column =
          Option.map (fun c -> c#as_tree_view_column) base_column
        in
        Tree_selection_and__tree_view.Tree_view.move_column_after obj column
          base_column
    ...
    method row_expanded : Tree_path.t -> bool =
      fun path -> Tree_selection_and__tree_view.Tree_view.row_expanded obj path
    ...
    method scroll_to_cell :
      ...
      fun path column use_align row_align col_align ->
        let column = Option.map (fun c -> c#as_tree_view_column) column in
        Tree_selection_and__tree_view.Tree_view.scroll_to_cell obj path column
          use_align row_align col_align

    method scroll_to_point : int -> int -> unit =
      fun tree_x tree_y ->
        Tree_selection_and__tree_view.Tree_view.scroll_to_point obj tree_x
          tree_y

    method set_activate_on_single_click : bool -> unit =
      fun single ->
        Tree_selection_and__tree_view.Tree_view.set_activate_on_single_click obj
          single
    ...
    method set_cursor_on_cell :
      ...
      fun path focus_column focus_cell start_editing ->
        let focus_column =
          Option.map (fun c -> c#as_tree_view_column) focus_column
        in
        let focus_cell = Option.map (fun c -> c#as_cell_renderer) focus_cell in
        Tree_selection_and__tree_view.Tree_view.set_cursor_on_cell obj path
          focus_column focus_cell start_editing
    ...
    method set_enable_search : bool -> unit =
      fun enable_search ->
        Tree_selection_and__tree_view.Tree_view.set_enable_search obj
          enable_search

    method set_enable_tree_lines : bool -> unit =
      fun enabled ->
        Tree_selection_and__tree_view.Tree_view.set_enable_tree_lines obj
          enabled
    ...
    method set_headers_clickable : bool -> unit =
      fun setting ->
        Tree_selection_and__tree_view.Tree_view.set_headers_clickable obj
          setting

    method set_headers_visible : bool -> unit =
      fun headers_visible ->
        Tree_selection_and__tree_view.Tree_view.set_headers_visible obj
          headers_visible
    ...
    method set_level_indentation : int -> unit =
      fun indentation ->
        Tree_selection_and__tree_view.Tree_view.set_level_indentation obj
          indentation
    ...
    method set_tooltip_cell :
      ...
      fun tooltip path column cell ->
        ...
        Tree_selection_and__tree_view.Tree_view.set_tooltip_cell obj tooltip
          path column cell
    ...
    method unset_rows_drag_dest : unit -> unit =
      fun () -> Tree_selection_and__tree_view.Tree_view.unset_rows_drag_dest obj

    method unset_rows_drag_source : unit -> unit =
      fun () ->
        Tree_selection_and__tree_view.Tree_view.unset_rows_drag_source obj

    method enable_grid_lines =
      Tree_selection_and__tree_view.Tree_view.get_enable_grid_lines obj

    method set_enable_grid_lines v =
      Tree_selection_and__tree_view.Tree_view.set_enable_grid_lines obj v
