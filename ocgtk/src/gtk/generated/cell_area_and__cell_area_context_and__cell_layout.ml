...
module rec Cell_area : sig
  ...
  external snapshot : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Snapshot.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Gtk_enums.cellrendererstate -> bool -> unit = "ml_gtk_cell_area_snapshot_bytecode" "ml_gtk_cell_area_snapshot_native"
  ...
  external request_renderer : t -> Cell_renderer.t -> Gtk_enums.orientation -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int -> int * int = "ml_gtk_cell_area_request_renderer"
  ...
  external inner_cell_area : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t = "ml_gtk_cell_area_inner_cell_area"
  ...
  external get_preferred_width_for_height : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int -> int * int = "ml_gtk_cell_area_get_preferred_width_for_height"
  ...
  requests. *)
  external get_preferred_width : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int * int = "ml_gtk_cell_area_get_preferred_width"
  ...
  external get_preferred_height_for_width : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int -> int * int = "ml_gtk_cell_area_get_preferred_height_for_width"
  ...
  requests. *)
  external get_preferred_height : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int * int = "ml_gtk_cell_area_get_preferred_height"
  ...
  external get_cell_at_position : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> int -> int -> Cell_renderer.t * Ocgtk_gdk.Gdk.Wrappers.Rectangle.t = "ml_gtk_cell_area_get_cell_at_position_bytecode" "ml_gtk_cell_area_get_cell_at_position_native"

  (** Derives the allocation of @renderer inside @area if @area
  were to be rendered in @cell_area. *)
  external get_cell_allocation : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Cell_renderer.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t = "ml_gtk_cell_area_get_cell_allocation"
  ...
  external event : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Ocgtk_gdk.Gdk.Wrappers.Event.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Gtk_enums.cellrendererstate -> int = "ml_gtk_cell_area_event_bytecode" "ml_gtk_cell_area_event_native"
  ...
  external cell_set_property : t -> Cell_renderer.t -> string -> Gobject.Value.t -> unit = "ml_gtk_cell_area_cell_set_property"

  (** Gets the value of a cell property for @renderer in @area. *)
  external cell_get_property : t -> Cell_renderer.t -> string -> Gobject.Value.t -> unit = "ml_gtk_cell_area_cell_get_property"
  ...
  implementation. *)
  external activate_cell : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Cell_renderer.t -> Ocgtk_gdk.Gdk.Wrappers.Event.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Gtk_enums.cellrendererstate -> bool = "ml_gtk_cell_area_activate_cell_bytecode" "ml_gtk_cell_area_activate_cell_native"

  (** Activates @area, usually by activating the currently focused
  cell, however some subclasses which embed widgets in the area
  can also activate a widget if it currently has the focus. *)
  external activate : t -> Cell_area_context.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Gtk_enums.cellrendererstate -> bool -> bool = "ml_gtk_cell_area_activate_bytecode" "ml_gtk_cell_area_activate_native"

  (* Properties *)

  val on_focus_changed : ?after:bool -> t -> callback:(renderer:Cell_renderer.t -> path:string -> unit) -> Gobject.Signal.handler_id
  val on_remove_editable : ?after:bool -> t -> callback:(renderer:Cell_renderer.t -> editable:Cell_editable.t -> unit) -> Gobject.Signal.handler_id
  ...
  let on_focus_changed ?after obj ~callback =
    let closure = Gobject.Closure.create (fun argv ->
      let renderer = (let v = (Gobject.Closure.nth argv ~pos:1) in Gobject.Value.get_object_exn v) in
      let path = (let v = (Gobject.Closure.nth argv ~pos:2) in Gobject.Value.get_string v) in
  ...
  let on_remove_editable ?after obj ~callback =
    let closure = Gobject.Closure.create (fun argv ->
      let renderer = (let v = (Gobject.Closure.nth argv ~pos:1) in Gobject.Value.get_object_exn v) in
      let editable = (let v = (Gobject.Closure.nth argv ~pos:2) in Gobject.Value.get_object_exn v) in
