...
@window. *)
external snapshot : t -> Snapshot.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Gtk_enums.cellrendererstate -> unit = "ml_gtk_cell_renderer_snapshot_bytecode" "ml_gtk_cell_renderer_snapshot_native"
...
external get_state : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> Gtk_enums.cellrendererstate -> Gtk_enums.stateflags = "ml_gtk_cell_renderer_get_state"
...
external get_preferred_width_for_height : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int -> int * int = "ml_gtk_cell_renderer_get_preferred_width_for_height"

(** Retrieves a renderer’s natural size when rendered to @widget. *)
external get_preferred_width : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int * int = "ml_gtk_cell_renderer_get_preferred_width"

(** Retrieves the minimum and natural size of a cell taking
into account the widget’s preference for height-for-width management. *)
external get_preferred_size : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Requisition.t * Requisition.t = "ml_gtk_cell_renderer_get_preferred_size"

(** Retrieves a cell renderers’s minimum and natural height if it were rendered to
@widget with the specified @width. *)
external get_preferred_height_for_width : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int -> int * int = "ml_gtk_cell_renderer_get_preferred_height_for_width"

(** Retrieves a renderer’s natural size when rendered to @widget. *)
external get_preferred_height : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int * int = "ml_gtk_cell_renderer_get_preferred_height"
...
external get_aligned_area : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Gtk_enums.cellrendererstate -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t = "ml_gtk_cell_renderer_get_aligned_area"

(** Passes an activate event to the cell renderer for possible processing.
Some cell renderers may use events; for example, `GtkCellRendererToggle`
toggles when it gets a mouse click. *)
external activate : t -> Ocgtk_gdk.Gdk.Wrappers.Event.t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> string -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Ocgtk_gdk.Gdk.Wrappers.Rectangle.t -> Gtk_enums.cellrendererstate -> bool = "ml_gtk_cell_renderer_activate_bytecode" "ml_gtk_cell_renderer_activate_native"
...
val on_editing_canceled : ?after:bool -> t -> callback:(unit -> unit) -> Gobject.Signal.handler_id
val on_editing_started : ?after:bool -> t -> callback:(editable:Cell_editable.t -> path:string -> unit) -> Gobject.Signal.handler_id
