...
class cell_renderer_text (obj : Cell_renderer_text.t) : cell_renderer_text_t =
  object (self)
    ...
    method attributes =
      new Ocgtk_pango.Pango.Attr_list.attr_list
        (Cell_renderer_text.get_attributes obj)

    method set_attributes : Ocgtk_pango.Pango.Attr_list.attr_list_t -> unit =
      fun v -> Cell_renderer_text.set_attributes obj v#as_attr_list

    method set_background v = Cell_renderer_text.set_background obj v

    method background_rgba =
      new Ocgtk_gdk.Gdk.Rgb_a.rgb_a (Cell_renderer_text.get_background_rgba obj)

    method set_background_rgba : Ocgtk_gdk.Gdk.Rgb_a.rgb_a_t -> unit =
      fun v -> Cell_renderer_text.set_background_rgba obj v#as_rgb_a
    ...
    method font_desc =
      new Ocgtk_pango.Pango.Font_description.font_description
        (Cell_renderer_text.get_font_desc obj)

    method set_font_desc :
        Ocgtk_pango.Pango.Font_description.font_description_t -> unit =
      fun v -> Cell_renderer_text.set_font_desc obj v#as_font_description

    method set_foreground v = Cell_renderer_text.set_foreground obj v

    method foreground_rgba =
      new Ocgtk_gdk.Gdk.Rgb_a.rgb_a (Cell_renderer_text.get_foreground_rgba obj)

    method set_foreground_rgba : Ocgtk_gdk.Gdk.Rgb_a.rgb_a_t -> unit =
      fun v -> Cell_renderer_text.set_foreground_rgba obj v#as_rgb_a
    ...
    method set_placeholder_text v =
      Cell_renderer_text.set_placeholder_text obj v
    ...
    method single_paragraph_mode =
      Cell_renderer_text.get_single_paragraph_mode obj

    method set_single_paragraph_mode v =
      Cell_renderer_text.set_single_paragraph_mode obj v
    ...
    method set_strikethrough_set v =
      Cell_renderer_text.set_strikethrough_set obj v
