...
class font_dialog_button (obj : Font_dialog_button.t) : font_dialog_button_t =
  object (self)
    ...
    method get_dialog : unit -> GFont_dialog.font_dialog_t option =
      fun () ->
        Option.map
          (fun ret -> new GFont_dialog.font_dialog ret)
          (Font_dialog_button.get_dialog obj)
    ...
    method get_font_desc :
      ...
      fun () ->
        Option.map
          ...
          (Font_dialog_button.get_font_desc obj)

    method get_font_features : unit -> string option =
      fun () -> Font_dialog_button.get_font_features obj

    method get_language : unit -> Ocgtk_pango.Pango.Language.language_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_pango.Pango.Language.language ret)
          (Font_dialog_button.get_language obj)

    method get_level : unit -> Gtk_enums.fontlevel =
      fun () -> Font_dialog_button.get_level obj

    method get_use_font : unit -> bool =
      fun () -> Font_dialog_button.get_use_font obj

    method get_use_size : unit -> bool =
      fun () -> Font_dialog_button.get_use_size obj
    ...
    method set_level : Gtk_enums.fontlevel -> unit =
      fun level -> Font_dialog_button.set_level obj level

    method set_use_font : bool -> unit =
      fun use_font -> Font_dialog_button.set_use_font obj use_font

    method set_use_size : bool -> unit =
      fun use_size -> Font_dialog_button.set_use_size obj use_size
