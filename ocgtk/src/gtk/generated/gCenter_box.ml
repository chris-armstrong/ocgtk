...
class center_box (obj : Center_box.t) : center_box_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
    ...
    method get_baseline_position : unit -> Gtk_enums.baselineposition =
      fun () -> Center_box.get_baseline_position obj
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Center_box.get_center_widget obj)
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Center_box.get_end_widget obj)

    method get_shrink_center_last : unit -> bool =
      fun () -> Center_box.get_shrink_center_last obj
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Center_box.get_start_widget obj)

    method set_baseline_position : Gtk_enums.baselineposition -> unit =
      fun position -> Center_box.set_baseline_position obj position
...
let new_ () : center_box_t = new center_box (Center_box.new_ ())
