...
module rec Application : sig
  ...
  val on_window_added : ?after:bool -> t -> callback:(window:Window.t -> unit) -> Gobject.Signal.handler_id
  val on_window_removed : ?after:bool -> t -> callback:(window:Window.t -> unit) -> Gobject.Signal.handler_id
  ...
  let on_window_added ?after obj ~callback =
    let closure = Gobject.Closure.create (fun argv ->
      let window = (let v = (Gobject.Closure.nth argv ~pos:1) in Gobject.Value.get_object_exn v) in
      callback ~window)
   in
...
and Window
 : sig
  ...
  external set_titlebar : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_window_set_titlebar"
  ...
  external set_focus : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_window_set_focus"
  ...
  external set_default_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_window_set_default_widget"
  ...
  external set_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_window_set_child"
  ...
  external get_titlebar : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_window_get_titlebar"
  ...
  external get_focus : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_window_get_focus"
  ...
  external get_default_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_window_get_default_widget"
  ...
  external get_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_window_get_child"
  ...
  external get_focus_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t = "ml_gtk_window_get_focus_widget"

  (** Set property: focus-widget *)
  external set_focus_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_window_set_focus_widget"
  ...
  let on_enable_debugging ?after obj ~callback =
    let closure = Gobject.Closure.create (fun argv ->
      let toggle = (let v = (Gobject.Closure.nth argv ~pos:1) in Gobject.Value.get_boolean v) in
