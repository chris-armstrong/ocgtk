...
class combo_box (obj : Combo_box.t) : combo_box_t =
  object (self)
    ...
    method get_active_id : unit -> string option =
      fun () -> Combo_box.get_active_id obj

    method get_button_sensitivity : unit -> Gtk_enums.sensitivitytype =
      fun () -> Combo_box.get_button_sensitivity obj
    ...
    method get_entry_text_column : unit -> int =
      fun () -> Combo_box.get_entry_text_column obj
    ...
    method get_model : unit -> GTree_model.tree_model_t option =
      fun () ->
        Option.map
          ...
          (Combo_box.get_model obj)

    method get_popup_fixed_width : unit -> bool =
      fun () -> Combo_box.get_popup_fixed_width obj
    ...
    method set_active : int -> unit =
      fun index_ -> Combo_box.set_active obj index_

    method set_active_id : string option -> bool =
      fun active_id -> Combo_box.set_active_id obj active_id

    method set_active_iter : Tree_iter.t option -> unit =
      fun iter -> Combo_box.set_active_iter obj iter
    ...
    method set_entry_text_column : int -> unit =
      fun text_column -> Combo_box.set_entry_text_column obj text_column

    method set_id_column : int -> unit =
      fun id_column -> Combo_box.set_id_column obj id_column
    ...
    method set_popup_fixed_width : bool -> unit =
      fun fixed -> Combo_box.set_popup_fixed_width obj fixed
...
let new_ () : combo_box_t = new combo_box (Combo_box.new_ ())
