...
class assistant_signals (obj : Assistant.t) =
  object
    method on_apply ~callback =
      Gobject.Signal.connect_simple obj ~name:"apply" ~callback ~after:false
    ...
    method on_cancel ~callback =
      Gobject.Signal.connect_simple obj ~name:"cancel" ~callback ~after:false
    ...
    method on_escape ~callback =
      Gobject.Signal.connect_simple obj ~name:"escape" ~callback ~after:false
