...
class type icon_view_t = object
  ...
  method set_drag_dest_item :
    Tree_path.t option -> Gtk_enums.iconviewdropposition -> unit
...
class icon_view (obj : Icon_view.t) : icon_view_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
    ...
    method create_drag_icon :
      ...
      fun path ->
        Option.map
          ...
          (Icon_view.create_drag_icon obj path)
    ...
    method get_activate_on_single_click : unit -> bool =
      fun () -> Icon_view.get_activate_on_single_click obj

    method get_column_spacing : unit -> int =
      fun () -> Icon_view.get_column_spacing obj

    method get_columns : unit -> int = fun () -> Icon_view.get_columns obj

    method get_item_column : Tree_path.t -> int =
      fun path -> Icon_view.get_item_column obj path

    method get_item_orientation : unit -> Gtk_enums.orientation =
      fun () -> Icon_view.get_item_orientation obj

    method get_item_padding : unit -> int =
      fun () -> Icon_view.get_item_padding obj

    method get_item_row : Tree_path.t -> int =
      fun path -> Icon_view.get_item_row obj path

    method get_item_width : unit -> int = fun () -> Icon_view.get_item_width obj
    method get_margin : unit -> int = fun () -> Icon_view.get_margin obj

    method get_markup_column : unit -> int =
      fun () -> Icon_view.get_markup_column obj

    method get_model : unit -> GTree_model.tree_model_t option =
      fun () ->
        Option.map
          (fun ret -> new GTree_model.tree_model ret)
          (Icon_view.get_model obj)

    method get_path_at_pos : int -> int -> Tree_path.t option =
      fun x y -> Icon_view.get_path_at_pos obj x y

    method get_pixbuf_column : unit -> int =
      fun () -> Icon_view.get_pixbuf_column obj

    method get_reorderable : unit -> bool =
      fun () -> Icon_view.get_reorderable obj

    method get_row_spacing : unit -> int =
      fun () -> Icon_view.get_row_spacing obj

    method get_selected_items : unit -> Tree_path.t list =
      fun () -> Icon_view.get_selected_items obj

    method get_selection_mode : unit -> Gtk_enums.selectionmode =
      fun () -> Icon_view.get_selection_mode obj

    method get_spacing : unit -> int = fun () -> Icon_view.get_spacing obj

    method get_text_column : unit -> int =
      fun () -> Icon_view.get_text_column obj

    method get_tooltip_column : unit -> int =
      fun () -> Icon_view.get_tooltip_column obj

    method item_activated : Tree_path.t -> unit =
      fun path -> Icon_view.item_activated obj path

    method path_is_selected : Tree_path.t -> bool =
      fun path -> Icon_view.path_is_selected obj path
    ...
    method select_path : Tree_path.t -> unit =
      fun path -> Icon_view.select_path obj path

    method set_activate_on_single_click : bool -> unit =
      fun single -> Icon_view.set_activate_on_single_click obj single

    method set_column_spacing : int -> unit =
      fun column_spacing -> Icon_view.set_column_spacing obj column_spacing

    method set_columns : int -> unit =
      fun columns -> Icon_view.set_columns obj columns

    method set_drag_dest_item :
        Tree_path.t option -> Gtk_enums.iconviewdropposition -> unit =
      fun path pos -> Icon_view.set_drag_dest_item obj path pos

    method set_item_orientation : Gtk_enums.orientation -> unit =
      fun orientation -> Icon_view.set_item_orientation obj orientation

    method set_item_padding : int -> unit =
      fun item_padding -> Icon_view.set_item_padding obj item_padding

    method set_item_width : int -> unit =
      fun item_width -> Icon_view.set_item_width obj item_width

    method set_margin : int -> unit =
      fun margin -> Icon_view.set_margin obj margin

    method set_markup_column : int -> unit =
      fun column -> Icon_view.set_markup_column obj column
    ...
    method set_pixbuf_column : int -> unit =
      fun column -> Icon_view.set_pixbuf_column obj column

    method set_reorderable : bool -> unit =
      fun reorderable -> Icon_view.set_reorderable obj reorderable

    method set_row_spacing : int -> unit =
      fun row_spacing -> Icon_view.set_row_spacing obj row_spacing

    method set_selection_mode : Gtk_enums.selectionmode -> unit =
      fun mode -> Icon_view.set_selection_mode obj mode

    method set_spacing : int -> unit =
      fun spacing -> Icon_view.set_spacing obj spacing

    method set_text_column : int -> unit =
      fun column -> Icon_view.set_text_column obj column
    ...
    method set_tooltip_column : int -> unit =
      fun column -> Icon_view.set_tooltip_column obj column
    ...
    method unselect_path : Tree_path.t -> unit =
      fun path -> Icon_view.unselect_path obj path

    method unset_model_drag_dest : unit -> unit =
      fun () -> Icon_view.unset_model_drag_dest obj

    method unset_model_drag_source : unit -> unit =
      fun () -> Icon_view.unset_model_drag_source obj

    method cell_area =
      new GCell_area_and__cell_area_context_and__cell_layout.cell_area
        (Icon_view.get_cell_area obj)

    method as_icon_view = obj
  end

let new_ () : icon_view_t = new icon_view (Icon_view.new_ ())
