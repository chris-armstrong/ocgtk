...
class box (obj : Box.t) : box_t =
  object (self)
    ...
    method get_baseline_child : unit -> int =
      fun () -> Box.get_baseline_child obj

    method get_baseline_position : unit -> Gtk_enums.baselineposition =
      fun () -> Box.get_baseline_position obj
    ...
    method set_baseline_child : int -> unit =
      fun child -> Box.set_baseline_child obj child

    method set_baseline_position : Gtk_enums.baselineposition -> unit =
      fun position -> Box.set_baseline_position obj position

    method set_homogeneous : bool -> unit =
      fun homogeneous -> Box.set_homogeneous obj homogeneous

    method set_spacing : int -> unit =
      fun spacing -> Box.set_spacing obj spacing
