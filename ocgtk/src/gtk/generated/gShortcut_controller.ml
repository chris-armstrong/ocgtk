...
class shortcut_controller (obj : Shortcut_controller.t) : shortcut_controller_t
  =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
    ...
    method get_mnemonics_modifiers : unit -> Ocgtk_gdk.Gdk.modifiertype =
      fun () -> Shortcut_controller.get_mnemonics_modifiers obj

    method get_scope : unit -> Gtk_enums.shortcutscope =
      fun () -> Shortcut_controller.get_scope obj
    ...
    method set_mnemonics_modifiers : Ocgtk_gdk.Gdk.modifiertype -> unit =
      fun modifiers -> Shortcut_controller.set_mnemonics_modifiers obj modifiers

    method set_scope : Gtk_enums.shortcutscope -> unit =
      fun scope -> Shortcut_controller.set_scope obj scope
    ...
    method set_mnemonic_modifiers v =
      Shortcut_controller.set_mnemonic_modifiers obj v
...
let new_for_model (model : Ocgtk_gio.Gio.List_model.list_model_t) :
    shortcut_controller_t =
