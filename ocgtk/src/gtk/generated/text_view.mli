...
val on_move_cursor : ?after:bool -> t -> callback:(step:Gtk_enums.movementstep -> count:int -> extend_selection:bool -> unit) -> Gobject.Signal.handler_id
val on_move_viewport : ?after:bool -> t -> callback:(step:Gtk_enums.scrollstep -> count:int -> unit) -> Gobject.Signal.handler_id
...
val on_select_all : ?after:bool -> t -> callback:(select:bool -> unit) -> Gobject.Signal.handler_id
val on_set_anchor : ?after:bool -> t -> callback:(unit -> unit) -> Gobject.Signal.handler_id
val on_toggle_cursor_visible : ?after:bool -> t -> callback:(unit -> unit) -> Gobject.Signal.handler_id
