class type text_view_t = object
    ...
    method on_delete_from_cursor : ?after:bool -> callback:(type_:Gtk_enums.deletetype -> count:int -> unit) -> unit -> Gobject.Signal.handler_id
    ...
    method on_move_cursor : ?after:bool -> callback:(step:Gtk_enums.movementstep -> count:int -> extend_selection:bool -> unit) -> unit -> Gobject.Signal.handler_id
    method on_move_viewport : ?after:bool -> callback:(step:Gtk_enums.scrollstep -> count:int -> unit) -> unit -> Gobject.Signal.handler_id
    ...
    method add_child_at_anchor : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> GText_child_anchor.text_child_anchor_t -> unit
    method add_overlay : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> int -> int -> unit
    ...
    method get_gutter : Gtk_enums.textwindowtype -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option
    ...
    method move_overlay : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> int -> int -> unit
    ...
    method set_gutter : Gtk_enums.textwindowtype -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option -> unit
...
class text_view (obj : Text_view.t) : text_view_t = object (self)
  ...
  method get_gutter : Gtk_enums.textwindowtype -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun win ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Text_view.get_gutter obj win)
