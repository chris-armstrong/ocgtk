...
class type text_view_t = object
  ...
  method backward_display_line :
    Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool
  ...
  method get_buffer :
    unit -> GText_buffer_and__text_iter_and__text_mark.text_buffer_t
  ...
  method move_visually :
    Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> int -> bool
  ...
  method scroll_mark_onscreen :
    GText_buffer_and__text_iter_and__text_mark.text_mark_t -> unit
  ...
  method scroll_to_mark :
    GText_buffer_and__text_iter_and__text_mark.text_mark_t ->
    float ->
    bool ->
    float ->
    float ->
  ...
  method set_buffer :
    GText_buffer_and__text_iter_and__text_mark.text_buffer_t option -> unit
...
class text_view (obj : Text_view.t) : text_view_t =
  object (self)
    ...
    method backward_display_line :
        Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool =
      fun iter -> Text_view.backward_display_line obj iter

    method backward_display_line_start :
        Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool =
      fun iter -> Text_view.backward_display_line_start obj iter

    method forward_display_line :
        Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool =
      fun iter -> Text_view.forward_display_line obj iter

    method forward_display_line_end :
        Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool =
      fun iter -> Text_view.forward_display_line_end obj iter

    method get_accepts_tab : unit -> bool =
      fun () -> Text_view.get_accepts_tab obj

    method get_bottom_margin : unit -> int =
      fun () -> Text_view.get_bottom_margin obj

    method get_buffer :
        unit -> GText_buffer_and__text_iter_and__text_mark.text_buffer_t =
      fun () ->
        new GText_buffer_and__text_iter_and__text_mark.text_buffer
          (Text_view.get_buffer obj)

    method get_cursor_visible : unit -> bool =
      fun () -> Text_view.get_cursor_visible obj
    ...
    method get_input_hints : unit -> Gtk_enums.inputhints =
      fun () -> Text_view.get_input_hints obj

    method get_input_purpose : unit -> Gtk_enums.inputpurpose =
      fun () -> Text_view.get_input_purpose obj

    method get_justification : unit -> Gtk_enums.justification =
      fun () -> Text_view.get_justification obj

    method get_left_margin : unit -> int =
      fun () -> Text_view.get_left_margin obj
    ...
    method get_pixels_above_lines : unit -> int =
      fun () -> Text_view.get_pixels_above_lines obj

    method get_pixels_below_lines : unit -> int =
      fun () -> Text_view.get_pixels_below_lines obj

    method get_pixels_inside_wrap : unit -> int =
      fun () -> Text_view.get_pixels_inside_wrap obj

    method get_right_margin : unit -> int =
      fun () -> Text_view.get_right_margin obj
    ...
    method move_visually :
        Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> int -> bool =
      fun iter count -> Text_view.move_visually obj iter count
    ...
    method reset_cursor_blink : unit -> unit =
      fun () -> Text_view.reset_cursor_blink obj

    method reset_im_context : unit -> unit =
      fun () -> Text_view.reset_im_context obj
    ...
    method set_accepts_tab : bool -> unit =
      fun accepts_tab -> Text_view.set_accepts_tab obj accepts_tab

    method set_bottom_margin : int -> unit =
      fun bottom_margin -> Text_view.set_bottom_margin obj bottom_margin
    ...
    method set_cursor_visible : bool -> unit =
      fun setting -> Text_view.set_cursor_visible obj setting

    method set_editable : bool -> unit =
      fun setting -> Text_view.set_editable obj setting
    ...
    method set_indent : int -> unit =
      fun indent -> Text_view.set_indent obj indent

    method set_input_hints : Gtk_enums.inputhints -> unit =
      fun hints -> Text_view.set_input_hints obj hints

    method set_input_purpose : Gtk_enums.inputpurpose -> unit =
      fun purpose -> Text_view.set_input_purpose obj purpose

    method set_justification : Gtk_enums.justification -> unit =
      fun justification -> Text_view.set_justification obj justification

    method set_left_margin : int -> unit =
      fun left_margin -> Text_view.set_left_margin obj left_margin

    method set_monospace : bool -> unit =
      fun monospace -> Text_view.set_monospace obj monospace

    method set_overwrite : bool -> unit =
      fun overwrite -> Text_view.set_overwrite obj overwrite
    ...
    method set_right_margin : int -> unit =
      fun right_margin -> Text_view.set_right_margin obj right_margin
    ...
    method set_top_margin : int -> unit =
      fun top_margin -> Text_view.set_top_margin obj top_margin

    method set_wrap_mode : Gtk_enums.wrapmode -> unit =
      fun wrap_mode -> Text_view.set_wrap_mode obj wrap_mode

    method starts_display_line :
        Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool =
      fun iter -> Text_view.starts_display_line obj iter
...
let new_ () : text_view_t = new text_view (Text_view.new_ ())

let new_with_buffer
    (buffer : GText_buffer_and__text_iter_and__text_mark.text_buffer_t) :
    text_view_t =
