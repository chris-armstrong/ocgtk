...
external remove : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> unit = "ml_gtk_grid_remove"

(** Queries the attach points and spans of @child inside the given `GtkGrid`. *)
external query_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int * int * int * int = "ml_gtk_grid_query_child"
...
external insert_next_to : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> Gtk_enums.positiontype -> unit = "ml_gtk_grid_insert_next_to"
...
cell at @column, @row. *)
external get_child_at : t -> int -> int -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_grid_get_child_at"
...
by @width and @height. *)
external attach : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t -> int -> int -> int -> int -> unit = "ml_gtk_grid_attach_bytecode" "ml_gtk_grid_attach_native"
