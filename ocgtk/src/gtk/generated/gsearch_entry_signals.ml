...
The default bindings for this signal is Ctrl-g. *)
  method on_next_match ~callback =
    Gobject.Signal.connect_simple obj ~name:"next-match" ~callback ~after:false
...
The default bindings for this signal is Ctrl-Shift-g. *)
  method on_previous_match ~callback =
    Gobject.Signal.connect_simple obj ~name:"previous-match" ~callback ~after:false
...
property. *)
  method on_search_changed ~callback =
    Gobject.Signal.connect_simple obj ~name:"search-changed" ~callback ~after:false

  (** Emitted when the user initiated a search on the entry. *)
  method on_search_started ~callback =
    Gobject.Signal.connect_simple obj ~name:"search-started" ~callback ~after:false
...
The default bindings for this signal is Escape. *)
  method on_stop_search ~callback =
    Gobject.Signal.connect_simple obj ~name:"stop-search" ~callback ~after:false
