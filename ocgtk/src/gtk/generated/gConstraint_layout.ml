...
class constraint_layout (obj : Constraint_layout.t) : constraint_layout_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .layout_manager
    ...
    method observe_constraints : unit -> Ocgtk_gio.Gio.List_model.list_model_t =
      fun () ->
        new Ocgtk_gio.Gio.List_model.list_model
          (Constraint_layout.observe_constraints obj)

    method observe_guides : unit -> Ocgtk_gio.Gio.List_model.list_model_t =
      fun () ->
        new Ocgtk_gio.Gio.List_model.list_model
          (Constraint_layout.observe_guides obj)

    method remove_all_constraints : unit -> unit =
      fun () -> Constraint_layout.remove_all_constraints obj
