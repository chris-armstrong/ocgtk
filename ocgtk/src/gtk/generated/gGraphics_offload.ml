...
class graphics_offload (obj : Graphics_offload.t) : graphics_offload_t = object (self)
  ...
  method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Graphics_offload.get_child obj)
...
let new_ (child : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option) : graphics_offload_t =
  let child = Option.map (fun c -> c#as_widget) child in
