...
class graphics_offload (obj : Graphics_offload.t) : graphics_offload_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Graphics_offload.get_child obj)
    ...
    method set_enabled : Gtk_enums.graphicsoffloadenabled -> unit =
      fun enabled -> Graphics_offload.set_enabled obj enabled
