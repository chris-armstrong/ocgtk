...
class tree_model_filter (obj : Tree_model_filter.t) : tree_model_filter_t =
  object (self)
    inherit
    ...
    method clear_cache : unit -> unit =
      fun () -> Tree_model_filter.clear_cache obj
    ...
    method get_model : unit -> GTree_model.tree_model_t =
      fun () -> new GTree_model.tree_model (Tree_model_filter.get_model obj)

    method refilter : unit -> unit = fun () -> Tree_model_filter.refilter obj

    method set_visible_column : int -> unit =
      fun column -> Tree_model_filter.set_visible_column obj column

    method child_model =
      new GTree_model.tree_model (Tree_model_filter.get_child_model obj)
