...
val on_got_page_size : ?after:bool -> t -> callback:(context:Print_context.t -> page_setup:Page_setup.t -> unit) -> Gobject.Signal.handler_id
val on_ready : ?after:bool -> t -> callback:(context:Print_context.t -> unit) -> Gobject.Signal.handler_id
