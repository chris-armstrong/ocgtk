...
external set_key_capture_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_search_entry_set_key_capture_widget"
...
external get_key_capture_widget : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_search_entry_get_key_capture_widget"
...
val on_stop_search : ?after:bool -> t -> callback:(unit -> unit) -> Gobject.Signal.handler_id
