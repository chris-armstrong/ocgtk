class type grid_layout_child_t = object
    inherit GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.layout_child_t
...
class grid_layout_child (obj : Grid_layout_child.t) : grid_layout_child_t = object (self)
  inherit GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.layout_child (obj :> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Layout_child.t)
