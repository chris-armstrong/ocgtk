...
of this expression. *)
external get_value_type : t -> Gobject.Type.t = "ml_gtk_expression_get_value_type"
...
will be returned. *)
external evaluate : t -> [`object_] Gobject.obj option -> Gobject.Value.t -> bool = "ml_gtk_expression_evaluate"
