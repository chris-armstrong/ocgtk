...
class gl_area (obj : Gl_area.t) : gl_area_t =
  object (self)
    ...
    method get_allowed_apis : unit -> Ocgtk_gdk.Gdk.glapi =
      fun () -> Gl_area.get_allowed_apis obj

    method get_api : unit -> Ocgtk_gdk.Gdk.glapi = fun () -> Gl_area.get_api obj

    method get_auto_render : unit -> bool =
      fun () -> Gl_area.get_auto_render obj
    ...
    method get_has_stencil_buffer : unit -> bool =
      fun () -> Gl_area.get_has_stencil_buffer obj
    ...
    method set_allowed_apis : Ocgtk_gdk.Gdk.glapi -> unit =
      fun apis -> Gl_area.set_allowed_apis obj apis
    ...
    method set_required_version : int -> int -> unit =
      fun major minor -> Gl_area.set_required_version obj major minor

    method set_use_es : bool -> unit =
      fun use_es -> Gl_area.set_use_es obj use_es

    method as_gl_area = obj
  end

let new_ () : gl_area_t = new gl_area (Gl_area.new_ ())
