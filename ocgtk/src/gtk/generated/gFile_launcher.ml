class type file_launcher_t = object
  ...
  method open_containing_folder_finish :
    Ocgtk_gio.Gio.Async_result.async_result_t -> (bool, GError.t) result
...
class file_launcher (obj : File_launcher.t) : file_launcher_t =
  object (self)
    method get_always_ask : unit -> bool =
      fun () -> File_launcher.get_always_ask obj

    method get_file : unit -> Ocgtk_gio.Gio.File.file_t option =
      fun () ->
        Option.map
          (fun ret -> new Ocgtk_gio.Gio.File.file ret)
          (File_launcher.get_file obj)

    method get_writable : unit -> bool =
      fun () -> File_launcher.get_writable obj
    ...
    method set_always_ask : bool -> unit =
      fun always_ask -> File_launcher.set_always_ask obj always_ask
    ...
    method set_writable : bool -> unit =
      fun writable -> File_launcher.set_writable obj writable
