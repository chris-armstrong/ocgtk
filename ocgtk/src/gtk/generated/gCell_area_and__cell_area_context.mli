...
class cell_area : Cell_area_and__cell_area_context.Cell_area.t ->
  object
    ...
    method activate : <as_cell_area_context: Cell_area_and__cell_area_context.Cell_area_context.t; ..> -> #GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget.widget -> #Ocgtk_gdk.Gdk.rectangle -> Gtk_enums.cellrendererstate -> bool -> bool
    method activate_cell : #GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget.widget -> #GCell_renderer.cell_renderer -> #Ocgtk_gdk.Gdk.event -> #Ocgtk_gdk.Gdk.rectangle -> Gtk_enums.cellrendererstate -> bool
    ...
    method event : <as_cell_area_context: Cell_area_and__cell_area_context.Cell_area_context.t; ..> -> #GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget.widget -> #Ocgtk_gdk.Gdk.event -> #Ocgtk_gdk.Gdk.rectangle -> Gtk_enums.cellrendererstate -> int
    ...
    method snapshot : <as_cell_area_context: Cell_area_and__cell_area_context.Cell_area_context.t; ..> -> #GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget.widget -> #GSnapshot.snapshot -> #Ocgtk_gdk.Gdk.rectangle -> #Ocgtk_gdk.Gdk.rectangle -> Gtk_enums.cellrendererstate -> bool -> unit
