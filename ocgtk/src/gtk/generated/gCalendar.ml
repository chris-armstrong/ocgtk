...
class calendar (obj : Calendar.t) : calendar_t =
  object (self)
    ...
    method get_day_is_marked : int -> bool =
      fun day -> Calendar.get_day_is_marked obj day

    method get_month : unit -> int = fun () -> Calendar.get_month obj

    method get_show_day_names : unit -> bool =
      fun () -> Calendar.get_show_day_names obj

    method get_show_heading : unit -> bool =
      fun () -> Calendar.get_show_heading obj

    method get_show_week_numbers : unit -> bool =
      fun () -> Calendar.get_show_week_numbers obj
    ...
    method set_show_day_names : bool -> unit =
      fun value -> Calendar.set_show_day_names obj value

    method set_show_heading : bool -> unit =
      fun value -> Calendar.set_show_heading obj value

    method set_show_week_numbers : bool -> unit =
      fun value -> Calendar.set_show_week_numbers obj value
...
let new_ () : calendar_t = new calendar (Calendar.new_ ())
