...
class scrolled_window (obj : Scrolled_window.t) : scrolled_window_t =
  object (self)
    ...
    method get_hadjustment : unit -> GAdjustment.adjustment_t =
      fun () -> new GAdjustment.adjustment (Scrolled_window.get_hadjustment obj)

    method get_has_frame : unit -> bool =
      fun () -> Scrolled_window.get_has_frame obj
    ...
    method get_kinetic_scrolling : unit -> bool =
      fun () -> Scrolled_window.get_kinetic_scrolling obj

    method get_max_content_height : unit -> int =
      fun () -> Scrolled_window.get_max_content_height obj

    method get_max_content_width : unit -> int =
      fun () -> Scrolled_window.get_max_content_width obj

    method get_min_content_height : unit -> int =
      fun () -> Scrolled_window.get_min_content_height obj

    method get_min_content_width : unit -> int =
      fun () -> Scrolled_window.get_min_content_width obj

    method get_overlay_scrolling : unit -> bool =
      fun () -> Scrolled_window.get_overlay_scrolling obj

    method get_placement : unit -> Gtk_enums.cornertype =
      fun () -> Scrolled_window.get_placement obj

    method get_propagate_natural_height : unit -> bool =
      fun () -> Scrolled_window.get_propagate_natural_height obj

    method get_propagate_natural_width : unit -> bool =
      fun () -> Scrolled_window.get_propagate_natural_width obj

    method get_vadjustment : unit -> GAdjustment.adjustment_t =
      fun () -> new GAdjustment.adjustment (Scrolled_window.get_vadjustment obj)
    ...
    method set_has_frame : bool -> unit =
      fun has_frame -> Scrolled_window.set_has_frame obj has_frame
    ...
    method set_max_content_height : int -> unit =
      fun height -> Scrolled_window.set_max_content_height obj height

    method set_max_content_width : int -> unit =
      fun width -> Scrolled_window.set_max_content_width obj width

    method set_min_content_height : int -> unit =
      fun height -> Scrolled_window.set_min_content_height obj height

    method set_min_content_width : int -> unit =
      fun width -> Scrolled_window.set_min_content_width obj width
    ...
    method set_placement : Gtk_enums.cornertype -> unit =
      fun window_placement -> Scrolled_window.set_placement obj window_placement
    ...
    method set_propagate_natural_width : bool -> unit =
      fun propagate -> Scrolled_window.set_propagate_natural_width obj propagate
    ...
    method unset_placement : unit -> unit =
      fun () -> Scrolled_window.unset_placement obj
...
let new_ () : scrolled_window_t = new scrolled_window (Scrolled_window.new_ ())
