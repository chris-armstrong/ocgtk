class type scrolled_window_t = object
    ...
    method on_edge_overshot : ?after:bool -> callback:(pos:Gtk_enums.positiontype -> unit) -> unit -> Gobject.Signal.handler_id
    method on_edge_reached : ?after:bool -> callback:(pos:Gtk_enums.positiontype -> unit) -> unit -> Gobject.Signal.handler_id
    method on_move_focus_out : ?after:bool -> callback:(direction_type:Gtk_enums.directiontype -> unit) -> unit -> Gobject.Signal.handler_id
    method on_scroll_child : ?after:bool -> callback:(scroll:Gtk_enums.scrolltype -> horizontal:bool -> bool) -> unit -> Gobject.Signal.handler_id
    ...
    method get_hscrollbar : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
    ...
    method get_vscrollbar : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t
...
class scrolled_window (obj : Scrolled_window.t) : scrolled_window_t = object (self)
  ...
  method get_child : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t option =
    fun () ->
      Option.map (fun ret -> new GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget ret) (Scrolled_window.get_child obj)
  ...
  method get_hscrollbar : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t =
    fun () ->
      new  GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget(Scrolled_window.get_hscrollbar obj)
  ...
  method get_vscrollbar : unit -> GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t =
    fun () ->
      new  GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget(Scrolled_window.get_vscrollbar obj)
