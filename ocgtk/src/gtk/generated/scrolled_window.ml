...
external set_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option -> unit = "ml_gtk_scrolled_window_set_child"

(** Returns the vertical scrollbar of @scrolled_window. *)
external get_vscrollbar : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t = "ml_gtk_scrolled_window_get_vscrollbar"
...
external get_hscrollbar : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t = "ml_gtk_scrolled_window_get_hscrollbar"
...
external get_child : t -> Event_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.Widget.t option = "ml_gtk_scrolled_window_get_child"

(* Properties *)

(** Get property: hscrollbar-policy *)
external get_hscrollbar_policy : t -> Gtk_enums.policytype = "ml_gtk_scrolled_window_get_hscrollbar_policy"

(** Set property: hscrollbar-policy *)
external set_hscrollbar_policy : t -> Gtk_enums.policytype -> unit = "ml_gtk_scrolled_window_set_hscrollbar_policy"

(** Get property: vscrollbar-policy *)
external get_vscrollbar_policy : t -> Gtk_enums.policytype = "ml_gtk_scrolled_window_get_vscrollbar_policy"

(** Set property: vscrollbar-policy *)
external set_vscrollbar_policy : t -> Gtk_enums.policytype -> unit = "ml_gtk_scrolled_window_set_vscrollbar_policy"

(** Get property: window-placement *)
external get_window_placement : t -> Gtk_enums.cornertype = "ml_gtk_scrolled_window_get_window_placement"

(** Set property: window-placement *)
external set_window_placement : t -> Gtk_enums.cornertype -> unit = "ml_gtk_scrolled_window_set_window_placement"

let on_edge_overshot ?after obj ~callback =
  let closure = Gobject.Closure.create (fun argv ->
    let pos = (let v = (Gobject.Closure.nth argv ~pos:1) in Gtk_enums.positiontype_of_int (Gobject.Value.get_enum_int v)) in
    callback ~pos)
 in
...
let on_move_focus_out ?after obj ~callback =
  let closure = Gobject.Closure.create (fun argv ->
    let direction_type = (let v = (Gobject.Closure.nth argv ~pos:1) in Gtk_enums.directiontype_of_int (Gobject.Value.get_enum_int v)) in
...
let on_scroll_child ?after obj ~callback =
  let closure = Gobject.Closure.create (fun argv ->
    let scroll = (let v = (Gobject.Closure.nth argv ~pos:1) in Gtk_enums.scrolltype_of_int (Gobject.Value.get_enum_int v)) in
    let horizontal = (let v = (Gobject.Closure.nth argv ~pos:2) in Gobject.Value.get_boolean v) in
