...
class tree_model_sort (obj : Tree_model_sort.t) : tree_model_sort_t =
  object (self)
    inherit
    ...
    method clear_cache : unit -> unit =
      fun () -> Tree_model_sort.clear_cache obj
    ...
    method get_model : unit -> GTree_model.tree_model_t =
      fun () -> new GTree_model.tree_model (Tree_model_sort.get_model obj)

    method iter_is_valid : Tree_iter.t -> bool =
      fun iter -> Tree_model_sort.iter_is_valid obj iter

    method reset_default_sort_func : unit -> unit =
      fun () -> Tree_model_sort.reset_default_sort_func obj
