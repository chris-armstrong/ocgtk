...
class type text_buffer_t = object
    method on_begin_user_action : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_changed : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_end_user_action : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_mark_deleted : ?after:bool -> callback:(mark:text_mark_t -> unit) -> unit -> Gobject.Signal.handler_id
    method on_modified_changed : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_paste_done : ?after:bool -> callback:(clipboard:Ocgtk_gdk.Gdk.Clipboard.clipboard_t -> unit) -> unit -> Gobject.Signal.handler_id
    method on_redo : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    method on_undo : ?after:bool -> callback:(unit -> unit) -> unit -> Gobject.Signal.handler_id
    ...
    method get_selection_content : unit -> Ocgtk_gdk.Gdk.Content_provider.content_provider_t
    ...
    method insert_paintable : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Ocgtk_gdk.Gdk.Paintable.paintable_t -> unit
    ...
    method paste_clipboard : Ocgtk_gdk.Gdk.Clipboard.clipboard_t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t option -> bool -> unit
    ...
    method remove_selection_clipboard : Ocgtk_gdk.Gdk.Clipboard.clipboard_t -> unit
...
class text_buffer (obj : Text_buffer_and__text_iter_and__text_mark.Text_buffer.t) : text_buffer_t = object (self)
  method on_begin_user_action ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_begin_user_action ~after self#as_text_buffer ~callback

  method on_changed ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_changed ~after self#as_text_buffer ~callback

  method on_end_user_action ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_end_user_action ~after self#as_text_buffer ~callback

  method on_mark_deleted ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_mark_deleted ~after self#as_text_buffer
      ~callback:(fun ~mark -> callback ~mark:(new text_mark mark))

  method on_modified_changed ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_modified_changed ~after self#as_text_buffer ~callback

  method on_paste_done ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_paste_done ~after self#as_text_buffer
      ~callback:(fun ~clipboard -> callback ~clipboard:(new Ocgtk_gdk.Gdk.Clipboard.clipboard clipboard))

  method on_redo ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_redo ~after self#as_text_buffer ~callback

  method on_undo ?(after = false) ~callback () =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.on_undo ~after self#as_text_buffer ~callback
  ...
  method apply_tag_by_name : string -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> unit =
    fun name start end_ ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.apply_tag_by_name obj name start end_)

  method backspace : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool -> bool -> bool =
    fun iter interactive default_editable ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.backspace obj iter interactive default_editable)

  method begin_irreversible_action : unit -> unit =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.begin_irreversible_action obj)
  ...
  method delete : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> unit =
    fun start end_ ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.delete obj start end_)
  ...
  method delete_mark_by_name : string -> unit =
    fun name ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.delete_mark_by_name obj name)

  method delete_selection : bool -> bool -> bool =
    fun interactive default_editable ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.delete_selection obj interactive default_editable)

  method end_irreversible_action : unit -> unit =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.end_irreversible_action obj)

  method end_user_action : unit -> unit =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.end_user_action obj)
  ...
  method get_enable_undo : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.get_enable_undo obj)
  ...
  method get_max_undo_levels : unit -> int =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.get_max_undo_levels obj)
  ...
  method get_selection_content : unit -> Ocgtk_gdk.Gdk.Content_provider.content_provider_t =
    fun () ->
      new  Ocgtk_gdk.Gdk.Content_provider.content_provider(Text_buffer_and__text_iter_and__text_mark.Text_buffer.get_selection_content obj)
  ...
  method get_text : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool -> string =
    fun start end_ include_hidden_chars ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.get_text obj start end_ include_hidden_chars)

  method insert : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> string -> int -> unit =
    fun iter text len ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.insert obj iter text len)
  ...
  method insert_interactive : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> string -> int -> bool -> bool =
    fun iter text len default_editable ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.insert_interactive obj iter text len default_editable)

  method insert_interactive_at_cursor : string -> int -> bool -> bool =
    fun text len default_editable ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.insert_interactive_at_cursor obj text len default_editable)
  ...
  method redo : unit -> unit =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.redo obj)
  ...
  method remove_tag_by_name : string -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> unit =
    fun name start end_ ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.remove_tag_by_name obj name start end_)

  method select_range : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> unit =
    fun ins bound ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.select_range obj ins bound)

  method set_enable_undo : bool -> unit =
    fun enable_undo ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.set_enable_undo obj enable_undo)

  method set_max_undo_levels : int -> unit =
    fun max_undo_levels ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.set_max_undo_levels obj max_undo_levels)

  method set_modified : bool -> unit =
    fun setting ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.set_modified obj setting)

  method set_text : string -> int -> unit =
    fun text len ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.set_text obj text len)

  method undo : unit -> unit =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_buffer.undo obj)
...
and text_iter (obj : Text_buffer_and__text_iter_and__text_mark.Text_iter.t) : text_iter_t = object (self)
  ...
  method backward_chars : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_chars obj count)

  method backward_cursor_position : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_cursor_position obj)

  method backward_cursor_positions : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_cursor_positions obj count)
  ...
  method backward_lines : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_lines obj count)

  method backward_sentence_start : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_sentence_start obj)
  ...
  method backward_visible_cursor_position : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_visible_cursor_position obj)

  method backward_visible_cursor_positions : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_visible_cursor_positions obj count)

  method backward_visible_line : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_visible_line obj)

  method backward_visible_lines : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_visible_lines obj count)

  method backward_visible_word_start : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_visible_word_start obj)

  method backward_visible_word_starts : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_visible_word_starts obj count)

  method backward_word_start : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_word_start obj)

  method backward_word_starts : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.backward_word_starts obj count)

  method can_insert : bool -> bool =
    fun default_editability ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.can_insert obj default_editability)
  ...
  method editable : bool -> bool =
    fun default_setting ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.editable obj default_setting)
  ...
  method forward_chars : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_chars obj count)

  method forward_cursor_position : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_cursor_position obj)

  method forward_cursor_positions : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_cursor_positions obj count)
  ...
  method forward_lines : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_lines obj count)

  method forward_sentence_end : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_sentence_end obj)

  method forward_sentence_ends : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_sentence_ends obj count)
  ...
  method forward_visible_cursor_position : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_visible_cursor_position obj)

  method forward_visible_cursor_positions : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_visible_cursor_positions obj count)

  method forward_visible_line : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_visible_line obj)

  method forward_visible_lines : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_visible_lines obj count)

  method forward_visible_word_end : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_visible_word_end obj)

  method forward_visible_word_ends : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_visible_word_ends obj count)
  ...
  method forward_word_ends : int -> bool =
    fun count ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.forward_word_ends obj count)
  ...
  method get_language : unit -> Ocgtk_pango.Pango.Language.language_t =
    fun () ->
      new  Ocgtk_pango.Pango.Language.language(Text_buffer_and__text_iter_and__text_mark.Text_iter.get_language obj)
  ...
  method get_paintable : unit -> Ocgtk_gdk.Gdk.Paintable.paintable_t option =
    fun () ->
      Option.map (fun ret -> new Ocgtk_gdk.Gdk.Paintable.paintable ret) (Text_buffer_and__text_iter_and__text_mark.Text_iter.get_paintable obj)
  ...
  method get_visible_line_index : unit -> int =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.get_visible_line_index obj)

  method get_visible_line_offset : unit -> int =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.get_visible_line_offset obj)

  method get_visible_slice : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> string =
    fun end_ ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.get_visible_slice obj end_)
  ...
  method in_range : Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t -> bool =
    fun start end_ ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.in_range obj start end_)
  ...
  method is_cursor_position : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.is_cursor_position obj)

  method is_end : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.is_end obj)

  method is_start : unit -> bool =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.is_start obj)
  ...
  method set_line : int -> unit =
    fun line_number ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.set_line obj line_number)

  method set_line_index : int -> unit =
    fun byte_on_line ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.set_line_index obj byte_on_line)

  method set_line_offset : int -> unit =
    fun char_on_line ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.set_line_offset obj char_on_line)

  method set_offset : int -> unit =
    fun char_offset ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.set_offset obj char_offset)

  method set_visible_line_index : int -> unit =
    fun byte_on_line ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.set_visible_line_index obj byte_on_line)

  method set_visible_line_offset : int -> unit =
    fun char_on_line ->
      (Text_buffer_and__text_iter_and__text_mark.Text_iter.set_visible_line_offset obj char_on_line)
...
and text_mark (obj : Text_buffer_and__text_iter_and__text_mark.Text_mark.t) : text_mark_t = object (self)
  ...
  method get_name : unit -> string option =
    fun () ->
      (Text_buffer_and__text_iter_and__text_mark.Text_mark.get_name obj)
  ...
  method set_visible : bool -> unit =
    fun setting ->
      (Text_buffer_and__text_iter_and__text_mark.Text_mark.set_visible obj setting)
