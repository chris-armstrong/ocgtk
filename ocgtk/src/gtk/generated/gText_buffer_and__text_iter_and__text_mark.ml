...
and text_iter_t = object
  ...
  method get_marks :
    unit -> Text_buffer_and__text_iter_and__text_mark.Text_mark.t list
...
and text_iter (obj : Text_buffer_and__text_iter_and__text_mark.Text_iter.t) :
  ...
  object (self)
    ...
    method copy : unit -> Text_buffer_and__text_iter_and__text_mark.Text_iter.t
        =
      fun () -> Text_buffer_and__text_iter_and__text_mark.Text_iter.copy obj
    ...
    method free : unit -> unit =
      fun () -> Text_buffer_and__text_iter_and__text_mark.Text_iter.free obj
    ...
    method get_tags : unit -> Text_tag.t list =
      fun () -> Text_buffer_and__text_iter_and__text_mark.Text_iter.get_tags obj
    ...
    method get_toggled_tags : bool -> Text_tag.t list =
      fun toggled_on ->
        Text_buffer_and__text_iter_and__text_mark.Text_iter.get_toggled_tags obj
          toggled_on
