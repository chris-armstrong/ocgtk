...
class search_bar (obj : Search_bar.t) : search_bar_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .widget
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Search_bar.get_key_capture_widget obj)

    method get_search_mode : unit -> bool =
      fun () -> Search_bar.get_search_mode obj

    method get_show_close_button : unit -> bool =
      fun () -> Search_bar.get_show_close_button obj
    ...
    method set_search_mode : bool -> unit =
      fun search_mode -> Search_bar.set_search_mode obj search_mode

    method set_show_close_button : bool -> unit =
      fun visible -> Search_bar.set_show_close_button obj visible
...
let new_ () : search_bar_t = new search_bar (Search_bar.new_ ())
