class type popover_menu_t = object
    ...
    method add_child : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> string -> bool
    method get_flags : unit -> Gtk_enums.popovermenuflags
    method get_menu_model : unit -> Ocgtk_gio.Gio.Menu_model.menu_model_t option
    method remove_child : GEvent_controller_and__layout_child_and__layout_manager_and__root_and__tooltip_and__widget.widget_t -> bool
...
val new_from_model : Ocgtk_gio.Gio.Menu_model.menu_model_t option -> popover_menu_t
val new_from_model_full : Ocgtk_gio.Gio.Menu_model.menu_model_t -> Gtk_enums.popovermenuflags -> popover_menu_t
