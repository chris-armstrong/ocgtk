...
class alternative_trigger (obj : Alternative_trigger.t) : alternative_trigger_t
  =
  object (self)
    ...
    method get_first : unit -> GShortcut_trigger.shortcut_trigger_t =
      fun () ->
        new GShortcut_trigger.shortcut_trigger
          (Alternative_trigger.get_first obj)

    method get_second : unit -> GShortcut_trigger.shortcut_trigger_t =
      fun () ->
        new GShortcut_trigger.shortcut_trigger
          (Alternative_trigger.get_second obj)

    method as_alternative_trigger = obj
  end

let new_ (first : GShortcut_trigger.shortcut_trigger_t)
    (second : GShortcut_trigger.shortcut_trigger_t) : alternative_trigger_t =
