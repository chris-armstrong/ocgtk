...
class text_view_signals (obj : Text_view.t) =
  object
...
<kbd>Ctrl</kbd>+<kbd>;</kbd> *)
    ...
    (** Gets emitted when the user initiates settings the "anchor" mark.
        ...
        [keybinding signal](class.SignalAction.html) which gets emitted when the
        user initiates setting the "anchor" mark. The "anchor" mark gets placed
        at the same position as the "insert" mark.
