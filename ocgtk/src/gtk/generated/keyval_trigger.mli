...
external new_ : int -> Ocgtk_gdk.Gdk.modifiertype -> t = "ml_gtk_keyval_trigger_new"

(* Methods *)
(** Gets the modifiers that must be present to succeed
triggering @self. *)
external get_modifiers : t -> Ocgtk_gdk.Gdk.modifiertype = "ml_gtk_keyval_trigger_get_modifiers"
