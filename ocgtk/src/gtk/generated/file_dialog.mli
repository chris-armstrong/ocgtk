...
external set_initial_folder : t -> Ocgtk_gio.Gio.Wrappers.File.t option -> unit = "ml_gtk_file_dialog_set_initial_folder"
...
external set_initial_file : t -> Ocgtk_gio.Gio.Wrappers.File.t option -> unit = "ml_gtk_file_dialog_set_initial_file"

(** Sets the filters that will be offered to the user
in the file chooser dialog. *)
external set_filters : t -> Ocgtk_gio.Gio.Wrappers.List_model.t option -> unit = "ml_gtk_file_dialog_set_filters"
...
external select_multiple_folders_finish : t -> Ocgtk_gio.Gio.Wrappers.Async_result.t -> (Ocgtk_gio.Gio.Wrappers.List_model.t option, GError.t) result = "ml_gtk_file_dialog_select_multiple_folders_finish"

(** Finishes the [method@Gtk.FileDialog.select_folder] call and
returns the resulting file. *)
external select_folder_finish : t -> Ocgtk_gio.Gio.Wrappers.Async_result.t -> (Ocgtk_gio.Gio.Wrappers.File.t option, GError.t) result = "ml_gtk_file_dialog_select_folder_finish"

(** Finishes the [method@Gtk.FileDialog.save] call and
returns the resulting file. *)
external save_finish : t -> Ocgtk_gio.Gio.Wrappers.Async_result.t -> (Ocgtk_gio.Gio.Wrappers.File.t option, GError.t) result = "ml_gtk_file_dialog_save_finish"

(** Finishes the [method@Gtk.FileDialog.open] call and
returns the resulting files in a `GListModel`. *)
external open_multiple_finish : t -> Ocgtk_gio.Gio.Wrappers.Async_result.t -> (Ocgtk_gio.Gio.Wrappers.List_model.t option, GError.t) result = "ml_gtk_file_dialog_open_multiple_finish"

(** Finishes the [method@Gtk.FileDialog.open] call and
returns the resulting file. *)
external open_finish : t -> Ocgtk_gio.Gio.Wrappers.Async_result.t -> (Ocgtk_gio.Gio.Wrappers.File.t option, GError.t) result = "ml_gtk_file_dialog_open_finish"
...
initial folder in the file chooser dialog. *)
external get_initial_folder : t -> Ocgtk_gio.Gio.Wrappers.File.t option = "ml_gtk_file_dialog_get_initial_folder"

(** Gets the file that will be initially selected in
the file chooser dialog. *)
external get_initial_file : t -> Ocgtk_gio.Gio.Wrappers.File.t option = "ml_gtk_file_dialog_get_initial_file"

(** Gets the filters that will be offered to the user
in the file chooser dialog. *)
external get_filters : t -> Ocgtk_gio.Gio.Wrappers.List_model.t option = "ml_gtk_file_dialog_get_filters"
