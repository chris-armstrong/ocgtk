...
class center_layout (obj : Center_layout.t) : center_layout_t =
  object (self)
    inherit
      GEvent_controller_and__layout_child_and__layout_manager_and__root_and__widget
      .layout_manager
    ...
    method get_baseline_position : unit -> Gtk_enums.baselineposition =
      fun () -> Center_layout.get_baseline_position obj
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Center_layout.get_center_widget obj)
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Center_layout.get_end_widget obj)

    method get_orientation : unit -> Gtk_enums.orientation =
      fun () -> Center_layout.get_orientation obj

    method get_shrink_center_last : unit -> bool =
      fun () -> Center_layout.get_shrink_center_last obj
        ...
        Option.map
          (fun ret ->
            new
              ...
              .widget
              ret)
          (Center_layout.get_start_widget obj)
    ...
    method set_orientation : Gtk_enums.orientation -> unit =
      fun orientation -> Center_layout.set_orientation obj orientation
...
let new_ () : center_layout_t = new center_layout (Center_layout.new_ ())
