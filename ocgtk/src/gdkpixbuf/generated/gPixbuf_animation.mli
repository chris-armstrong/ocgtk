...
val new_from_stream : Ocgtk_gio.Gio.Input_stream.input_stream_t -> Ocgtk_gio.Gio.Cancellable.cancellable_t option -> (pixbuf_animation_t, GError.t) result
val new_from_stream_finish : Ocgtk_gio.Gio.Async_result.async_result_t -> (pixbuf_animation_t, GError.t) result
