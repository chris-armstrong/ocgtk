...
module Pixbuf = GPixbuf
module Pixbuf_animation = GPixbuf_animation
module Pixbuf_animation_iter = GPixbuf_animation_iter
module Pixbuf_format = GPixbuf_format
module Pixbuf_loader = GPixbuf_loader
module Pixbuf_simple_anim = GPixbuf_simple_anim
module Pixbuf_simple_anim_iter = GPixbuf_simple_anim_iter
