...
class pixbuf_simple_anim (obj : Pixbuf_simple_anim.t) : pixbuf_simple_anim_t =
  object (self)
    ...
    method get_loop : unit -> bool = fun () -> Pixbuf_simple_anim.get_loop obj

    method set_loop : bool -> unit =
      fun loop -> Pixbuf_simple_anim.set_loop obj loop
