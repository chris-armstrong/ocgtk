  ...
  object (self)
    ...
    method init_from_quaternion :
      ...
      fun q order ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Euler
        .init_from_quaternion obj q order
    ...
    method init_from_radians :
      ...
      fun x y z order ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Euler
        .init_from_radians obj x y z order
    ...
    method init_with_order :
      ...
      fun x y z order ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Euler
        .init_with_order obj x y z order
  ...
  object (self)
    ...
    method init_from_2d :
      ...
      fun xx yx xy yy x_0 y_0 ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .init_from_2d obj xx yx xy yy x_0 y_0
    ...
    method init_from_vec4 :
      ...
      fun v0 v1 v2 v3 ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .init_from_vec4 obj v0 v1 v2 v3
    ...
    method init_frustum :
      ...
      fun left right bottom top z_near z_far ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .init_frustum obj left right bottom top z_near z_far
    ...
    method init_look_at :
      ...
      fun eye center up ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .init_look_at obj eye center up
    ...
    method init_ortho :
      ...
      fun left right top bottom z_near z_far ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .init_ortho obj left right top bottom z_near z_far
    ...
    method init_perspective :
      ...
      fun fovy aspect z_near z_far ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .init_perspective obj fovy aspect z_near z_far
    ...
    method scale : float -> float -> float -> unit =
      fun factor_x factor_y factor_z ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Matrix
        .scale obj factor_x factor_y factor_z
  ...
  object (self)
    ...
    method init_from_point :
      ...
      fun normal point ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Plane
        .init_from_point obj normal point
  ...
  object (self)
    ...
    method init_from_angle_vec3 :
      ...
      fun angle axis ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Quaternion
        .init_from_angle_vec3 obj angle axis
    ...
    method init_from_angles :
      ...
      fun deg_x deg_y deg_z ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Quaternion
        .init_from_angles obj deg_x deg_y deg_z
    ...
    method init_from_radians :
      ...
      fun rad_x rad_y rad_z ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle
        .Quaternion
        .init_from_radians obj rad_x rad_y rad_z
...
and ray
  ...
  object (self)
    ...
    method get_distance_to_plane :
      ...
      fun p ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Ray
        .get_distance_to_plane obj p

    method get_distance_to_point : Point3_d.t -> float =
      fun p ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Ray
        .get_distance_to_point obj p
    ...
    method init_from_vec3 :
      ...
      fun origin direction ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Ray
        .init_from_vec3 obj origin direction

    method intersects_box : Box_and__sphere.Box.t -> bool =
      fun b ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Ray
        .intersects_box obj b

    method intersects_sphere : Box_and__sphere.Sphere.t -> bool =
      fun s ->
        Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Ray
        .intersects_sphere obj s
