...
class euler (obj : Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Euler.t) = object (self)
...
and matrix (obj : Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Matrix.t) = object (self)
...
and plane (obj : Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Plane.t) = object (self)
...
and quaternion (obj : Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Quaternion.t) = object (self)
...
and ray (obj : Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Ray.t) = object (self)
...
and triangle (obj : Euler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.Triangle.t) = object (self)
