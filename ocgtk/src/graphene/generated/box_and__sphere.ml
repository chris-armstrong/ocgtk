...
module rec Box : sig
  ...
  graphene_box_empty(). *)
  external init_from_vectors : t -> int -> Vec3_and__vec4.Vec3.t array -> t = "ml_graphene_box_init_from_vectors"

  (** Initializes the given #graphene_box_t with two vertices
  stored inside #graphene_vec3_t. *)
  external init_from_vec3 : t -> Vec3_and__vec4.Vec3.t option -> Vec3_and__vec4.Vec3.t option -> t = "ml_graphene_box_init_from_vec3"
  ...
  graphene_box_empty(). *)
  external init_from_points : t -> int -> Point3_d.t array -> t = "ml_graphene_box_init_from_points"
  ...
  (** Initializes the given #graphene_box_t with two vertices. *)
  external init : t -> Point3_d.t option -> Point3_d.t option -> t = "ml_graphene_box_init"

  (** Retrieves the size of the @box on the X axis. *)
  external get_width : t -> float = "ml_graphene_box_get_width"

  (** Computes the vertices of the given #graphene_box_t. *)
  external get_vertices : t -> Vec3_and__vec4.Vec3.t array = "ml_graphene_box_get_vertices"
  ...
  #graphene_box_t. *)
  external get_bounding_sphere : t -> Sphere.t = "ml_graphene_box_get_bounding_sphere"
  ...
  given vector. *)
  external expand_vec3 : t -> Vec3_and__vec4.Vec3.t -> t = "ml_graphene_box_expand_vec3"
  ...
  external contains_point : t -> Point3_d.t -> bool = "ml_graphene_box_contains_point"
...
and Sphere
 : sig
  ...
  external init_from_vectors : t -> int -> Vec3_and__vec4.Vec3.t array -> Point3_d.t option -> t = "ml_graphene_sphere_init_from_vectors"
  ...
  external init_from_points : t -> int -> Point3_d.t array -> Point3_d.t option -> t = "ml_graphene_sphere_init_from_points"

  (** Initializes the given #graphene_sphere_t with the given @center and @radius. *)
  external init : t -> Point3_d.t option -> float -> t = "ml_graphene_sphere_init"
  ...
  external contains_point : t -> Point3_d.t -> bool = "ml_graphene_sphere_contains_point"
