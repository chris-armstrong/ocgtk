...
module rec Euler : sig
  ...
  #graphene_euler_t. *)
  external reorder : t -> Graphene_enums.eulerorder -> t = "ml_graphene_euler_reorder"

  (** Initializes a #graphene_euler_t with the given angles and @order. *)
  external init_with_order : t -> float -> float -> float -> Graphene_enums.eulerorder -> t = "ml_graphene_euler_init_with_order"
  ...
  external init_from_vec3 : t -> Vec3_and__vec4.Vec3.t option -> Graphene_enums.eulerorder -> t = "ml_graphene_euler_init_from_vec3"

  (** Initializes a #graphene_euler_t using the given angles
  and order of rotation. *)
  external init_from_radians : t -> float -> float -> float -> Graphene_enums.eulerorder -> t = "ml_graphene_euler_init_from_radians"

  (** Initializes a #graphene_euler_t using the given normalized quaternion.

  If the #graphene_quaternion_t @q is %NULL, the #graphene_euler_t will
  be initialized with all angles set to 0. *)
  external init_from_quaternion : t -> Quaternion.t option -> Graphene_enums.eulerorder -> t = "ml_graphene_euler_init_from_quaternion"

  (** Initializes a #graphene_euler_t using the given rotation matrix.

  If the #graphene_matrix_t @m is %NULL, the #graphene_euler_t will
  be initialized with all angles set to 0. *)
  external init_from_matrix : t -> Matrix.t option -> Graphene_enums.eulerorder -> t = "ml_graphene_euler_init_from_matrix"
  ...
  external init_from_euler : t -> t option -> t = "ml_graphene_euler_init_from_euler"
  ...
  instead. *)
  external get_order : t -> Graphene_enums.eulerorder = "ml_graphene_euler_get_order"
...
and Matrix
 : sig
  ...
  external untransform_point : t -> Point.t -> Rect.t -> bool * Point.t = "ml_graphene_matrix_untransform_point"

  (** Undoes the transformation on the corners of a #graphene_rect_t using the
  given matrix, within the given axis aligned rectangular @bounds. *)
  external untransform_bounds : t -> Rect.t -> Rect.t -> Rect.t = "ml_graphene_matrix_untransform_bounds"

  (** Unprojects the given @point using the @projection matrix and
  a @modelview matrix. *)
  external unproject_point3d : t -> t -> Point3_d.t -> Point3_d.t = "ml_graphene_matrix_unproject_point3d"
  ...
  external transform_vec4 : t -> Vec3_and__vec4.Vec4.t -> Vec3_and__vec4.Vec4.t = "ml_graphene_matrix_transform_vec4"
  ...
  external transform_vec3 : t -> Vec3_and__vec4.Vec3.t -> Vec3_and__vec4.Vec3.t = "ml_graphene_matrix_transform_vec3"

  (** Transforms a #graphene_sphere_t using the given matrix @m. The
  result is the bounding sphere containing the transformed sphere. *)
  external transform_sphere : t -> Box_and__sphere.Sphere.t -> Box_and__sphere.Sphere.t = "ml_graphene_matrix_transform_sphere"
  ...
  external transform_rect : t -> Rect.t -> Quad.t = "ml_graphene_matrix_transform_rect"

  (** Transform a #graphene_ray_t using the given matrix @m. *)
  external transform_ray : t -> Ray.t -> Ray.t = "ml_graphene_matrix_transform_ray"
  ...
  external transform_point3d : t -> Point3_d.t -> Point3_d.t = "ml_graphene_matrix_transform_point3d"
  ...
  See also: graphene_simd4x4f_point3_mul() *)
  external transform_point : t -> Point.t -> Point.t = "ml_graphene_matrix_transform_point"

  (** Transforms the vertices of a #graphene_box_t using the given matrix @m.

  The result is the axis aligned bounding box containing the transformed
  vertices. *)
  external transform_box : t -> Box_and__sphere.Box.t -> Box_and__sphere.Box.t = "ml_graphene_matrix_transform_box"
  ...
  See also: graphene_matrix_transform_point() *)
  external transform_bounds : t -> Rect.t -> Rect.t = "ml_graphene_matrix_transform_bounds"
  ...
  external to_2d : t -> bool * float * float * float * float * float * float = "ml_graphene_matrix_to_2d"
  ...
  external scale : t -> float -> float -> float -> unit = "ml_graphene_matrix_scale"
  ...
  external rotate_quaternion : t -> Quaternion.t -> unit = "ml_graphene_matrix_rotate_quaternion"

  (** Adds a rotation transformation to @m, using the given
  #graphene_euler_t. *)
  external rotate_euler : t -> Euler.t -> unit = "ml_graphene_matrix_rotate_euler"
  ...
  external rotate : t -> float -> Vec3_and__vec4.Vec3.t -> unit = "ml_graphene_matrix_rotate"

  (** Projects a #graphene_rect_t using the given matrix.

  The resulting rectangle is the axis aligned bounding rectangle capable
  of fully containing the projected rectangle. *)
  external project_rect_bounds : t -> Rect.t -> Rect.t = "ml_graphene_matrix_project_rect_bounds"

  (** Projects all corners of a #graphene_rect_t using the given matrix.

  See also: graphene_matrix_project_point() *)
  external project_rect : t -> Rect.t -> Quad.t = "ml_graphene_matrix_project_rect"

  (** Projects a #graphene_point_t using the matrix @m. *)
  external project_point : t -> Point.t -> Point.t = "ml_graphene_matrix_project_point"
  ...
  external is_backface_visible : t -> bool = "ml_graphene_matrix_is_backface_visible"
  ...
  given coordinates. *)
  external init_translate : t -> Point3_d.t -> t = "ml_graphene_matrix_init_translate"
  ...
  external init_scale : t -> float -> float -> float -> t = "ml_graphene_matrix_init_scale"

  (** Initializes @m to represent a rotation of @angle degrees on
  the axis represented by the @axis vector. *)
  external init_rotate : t -> float -> Vec3_and__vec4.Vec3.t -> t = "ml_graphene_matrix_init_rotate"

  (** Initializes a #graphene_matrix_t with a perspective projection. *)
  external init_perspective : t -> float -> float -> float -> float -> t = "ml_graphene_matrix_init_perspective"

  (** Initializes a #graphene_matrix_t with an orthographic projection. *)
  external init_ortho : t -> float -> float -> float -> float -> float -> float -> t = "ml_graphene_matrix_init_ortho_bytecode" "ml_graphene_matrix_init_ortho_native"
  ...
  coordinates. *)
  external init_look_at : t -> Vec3_and__vec4.Vec3.t -> Vec3_and__vec4.Vec3.t -> Vec3_and__vec4.Vec3.t -> t = "ml_graphene_matrix_init_look_at"
  ...
  external init_frustum : t -> float -> float -> float -> float -> float -> float -> t = "ml_graphene_matrix_init_frustum_bytecode" "ml_graphene_matrix_init_frustum_native"

  (** Initializes a #graphene_matrix_t with the given four row
  vectors. *)
  external init_from_vec4 : t -> Vec3_and__vec4.Vec4.t -> Vec3_and__vec4.Vec4.t -> Vec3_and__vec4.Vec4.t -> Vec3_and__vec4.Vec4.t -> t = "ml_graphene_matrix_init_from_vec4"

  (** Initializes a #graphene_matrix_t using the values of the
  given matrix. *)
  external init_from_matrix : t -> t -> t = "ml_graphene_matrix_init_from_matrix"

  (** Initializes a #graphene_matrix_t with the given array of floating
  point values. *)
  external init_from_float : t -> float array -> t = "ml_graphene_matrix_init_from_float"
  ...
  external init_from_2d : t -> float -> float -> float -> float -> float -> float -> t = "ml_graphene_matrix_init_from_2d_bytecode" "ml_graphene_matrix_init_from_2d_native"

  (** Retrieves the translation component on the Z axis from @m. *)
  external get_z_translation : t -> float = "ml_graphene_matrix_get_z_translation"

  (** Retrieves the scaling factor on the Z axis in @m. *)
  external get_z_scale : t -> float = "ml_graphene_matrix_get_z_scale"

  (** Retrieves the translation component on the Y axis from @m. *)
  external get_y_translation : t -> float = "ml_graphene_matrix_get_y_translation"

  (** Retrieves the scaling factor on the Y axis in @m. *)
  external get_y_scale : t -> float = "ml_graphene_matrix_get_y_scale"

  (** Retrieves the translation component on the X axis from @m. *)
  external get_x_translation : t -> float = "ml_graphene_matrix_get_x_translation"
  ...
  external get_row : t -> int -> Vec3_and__vec4.Vec4.t = "ml_graphene_matrix_get_row"
  ...
  external decompose : t -> bool * Vec3_and__vec4.Vec3.t * Vec3_and__vec4.Vec3.t * Quaternion.t * Vec3_and__vec4.Vec3.t * Vec3_and__vec4.Vec4.t = "ml_graphene_matrix_decompose"
...
and Plane
 : sig
  ...
  external transform : t -> Matrix.t -> Matrix.t option -> t = "ml_graphene_plane_transform"
  ...
  external init_from_vec4 : t -> Vec3_and__vec4.Vec4.t -> t = "ml_graphene_plane_init_from_vec4"
  ...
  external init_from_points : t -> Point3_d.t -> Point3_d.t -> Point3_d.t -> t = "ml_graphene_plane_init_from_points"

  (** Initializes the given #graphene_plane_t using the given normal vector
  and an arbitrary co-planar point. *)
  external init_from_point : t -> Vec3_and__vec4.Vec3.t -> Point3_d.t -> t = "ml_graphene_plane_init_from_point"
  ...
  (** Initializes the given #graphene_plane_t using the given @normal vector
  and @constant values. *)
  external init : t -> Vec3_and__vec4.Vec3.t option -> float -> t = "ml_graphene_plane_init"

  (** Retrieves the normal vector pointing towards the origin of the
  given #graphene_plane_t. *)
  external get_normal : t -> Vec3_and__vec4.Vec3.t = "ml_graphene_plane_get_normal"
...
and Quaternion
 : sig
  ...
  #graphene_vec4_t. *)
  external to_vec4 : t -> Vec3_and__vec4.Vec4.t = "ml_graphene_quaternion_to_vec4"
  ...
  on each axis. *)
  external to_radians : t -> float * float * float = "ml_graphene_quaternion_to_radians"
  ...
  on the [Euler angles](http://en.wikipedia.org/wiki/Euler_angles)
  on each axis. *)
  external to_angles : t -> float * float * float = "ml_graphene_quaternion_to_angles"

  (** Converts a quaternion into an @angle, @axis pair. *)
  external to_angle_vec3 : t -> float * Vec3_and__vec4.Vec3.t = "ml_graphene_quaternion_to_angle_vec3"
  ...
  external init_from_vec4 : t -> Vec3_and__vec4.Vec4.t -> t = "ml_graphene_quaternion_init_from_vec4"
  ...
  external init_from_radians : t -> float -> float -> float -> t = "ml_graphene_quaternion_init_from_radians"

  (** Initializes a #graphene_quaternion_t with the values from @src. *)
  external init_from_quaternion : t -> t -> t = "ml_graphene_quaternion_init_from_quaternion"

  (** Initializes a #graphene_quaternion_t using the rotation components
  of a transformation matrix. *)
  external init_from_matrix : t -> Matrix.t -> t = "ml_graphene_quaternion_init_from_matrix"

  (** Initializes a #graphene_quaternion_t using the given #graphene_euler_t. *)
  external init_from_euler : t -> Euler.t -> t = "ml_graphene_quaternion_init_from_euler"
  ...
  See also: graphene_quaternion_init_from_euler() *)
  external init_from_angles : t -> float -> float -> float -> t = "ml_graphene_quaternion_init_from_angles"

  (** Initializes a #graphene_quaternion_t using an @angle on a
  specific @axis. *)
  external init_from_angle_vec3 : t -> float -> Vec3_and__vec4.Vec3.t -> t = "ml_graphene_quaternion_init_from_angle_vec3"

  (** Initializes a #graphene_quaternion_t using the given four values. *)
  external init : t -> float -> float -> float -> float -> t = "ml_graphene_quaternion_init"
...
and Ray
 : sig
  ...
  external intersects_triangle : t -> Triangle.t -> bool = "ml_graphene_ray_intersects_triangle"

  (** Checks if the given #graphene_ray_t @r intersects the
  given #graphene_sphere_t @s.

  See also: graphene_ray_intersect_sphere() *)
  external intersects_sphere : t -> Box_and__sphere.Sphere.t -> bool = "ml_graphene_ray_intersects_sphere"

  (** Checks whether the given #graphene_ray_t @r intersects the
  given #graphene_box_t @b.

  See also: graphene_ray_intersect_box() *)
  external intersects_box : t -> Box_and__sphere.Box.t -> bool = "ml_graphene_ray_intersects_box"

  (** Intersects the given #graphene_ray_t @r with the given
  #graphene_triangle_t @t. *)
  external intersect_triangle : t -> Triangle.t -> Graphene_enums.rayintersectionkind * float = "ml_graphene_ray_intersect_triangle"

  (** Intersects the given #graphene_ray_t @r with the given
  #graphene_sphere_t @s. *)
  external intersect_sphere : t -> Box_and__sphere.Sphere.t -> Graphene_enums.rayintersectionkind * float = "ml_graphene_ray_intersect_sphere"

  (** Intersects the given #graphene_ray_t @r with the given
  #graphene_box_t @b. *)
  external intersect_box : t -> Box_and__sphere.Box.t -> Graphene_enums.rayintersectionkind * float = "ml_graphene_ray_intersect_box"

  (** Initializes the given #graphene_ray_t using the given vectors. *)
  external init_from_vec3 : t -> Vec3_and__vec4.Vec3.t option -> Vec3_and__vec4.Vec3.t option -> t = "ml_graphene_ray_init_from_vec3"
  ...
  external init : t -> Point3_d.t option -> Vec3_and__vec4.Vec3.t option -> t = "ml_graphene_ray_init"

  (** Retrieves the coordinates of a point at the distance @t along the
  given #graphene_ray_t. *)
  external get_position_at : t -> float -> Point3_d.t = "ml_graphene_ray_get_position_at"
  ...
  ray itself. *)
  external get_distance_to_point : t -> Point3_d.t -> float = "ml_graphene_ray_get_distance_to_point"

  (** Computes the distance of the origin of the given #graphene_ray_t from the
  given plane.

  If the ray does not intersect the plane, this function returns `INFINITY`. *)
  external get_distance_to_plane : t -> Plane.t -> float = "ml_graphene_ray_get_distance_to_plane"

  (** Retrieves the direction of the given #graphene_ray_t. *)
  external get_direction : t -> Vec3_and__vec4.Vec3.t = "ml_graphene_ray_get_direction"

  (** Computes the point on the given #graphene_ray_t that is closest to the
  given point @p. *)
  external get_closest_point_to_point : t -> Point3_d.t -> Point3_d.t = "ml_graphene_ray_get_closest_point_to_point"
...
and Triangle
 : sig
  ...
  external init_from_vec3 : t -> Vec3_and__vec4.Vec3.t option -> Vec3_and__vec4.Vec3.t option -> Vec3_and__vec4.Vec3.t option -> t = "ml_graphene_triangle_init_from_vec3"

  (** Initializes a #graphene_triangle_t using the three given 3D points. *)
  external init_from_point3d : t -> Point3_d.t option -> Point3_d.t option -> Point3_d.t option -> t = "ml_graphene_triangle_init_from_point3d"
  ...
  a point in 3D space. *)
  external init_from_float : t -> float array -> float array -> float array -> t = "ml_graphene_triangle_init_from_float"

  (** Retrieves the three vertices of the given #graphene_triangle_t. *)
  external get_vertices : t -> Vec3_and__vec4.Vec3.t * Vec3_and__vec4.Vec3.t * Vec3_and__vec4.Vec3.t = "ml_graphene_triangle_get_vertices"
  ...
  external get_uv : t -> Point3_d.t option -> Vec2.t -> Vec2.t -> Vec2.t -> bool * Vec2.t = "ml_graphene_triangle_get_uv"

  (** Retrieves the three vertices of the given #graphene_triangle_t and returns
  their coordinates as #graphene_point3d_t. *)
  external get_points : t -> Point3_d.t * Point3_d.t * Point3_d.t = "ml_graphene_triangle_get_points"
  ...
  external get_normal : t -> Vec3_and__vec4.Vec3.t = "ml_graphene_triangle_get_normal"
  ...
  external get_bounding_box : t -> Box_and__sphere.Box.t = "ml_graphene_triangle_get_bounding_box"
  ...
  The returned #graphene_vec2_t contains the following values, in order:
   ...
   - `res.x = u`
   - `res.y = v` *)
  external get_barycoords : t -> Point3_d.t option -> bool * Vec2.t = "ml_graphene_triangle_get_barycoords"
  ...
  external contains_point : t -> Point3_d.t -> bool = "ml_graphene_triangle_contains_point"
