...
class type matrix_t =
  GEuler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.matrix_t

class matrix =
  GEuler_and__matrix_and__plane_and__quaternion_and__ray_and__triangle.matrix
