...
GskRepeatingLinearGradientNode *obj = gsk_repeating_linear_gradient_node_new(graphene_rect_t_val(arg1), graphene_point_t_val(arg2), graphene_point_t_val(arg3), c_arg4, Gsize_val(arg5));
