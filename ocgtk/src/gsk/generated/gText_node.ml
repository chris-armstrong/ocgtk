...
class text_node (obj : Text_node.t) : text_node_t =
  object (self)
    inherit GRender_node.render_node (obj :> Render_node.t)

    method get_color : unit -> Ocgtk_gdk.Gdk.Rgb_a.rgb_a_t =
      fun () -> new Ocgtk_gdk.Gdk.Rgb_a.rgb_a (Text_node.get_color obj)

    method get_font : unit -> Ocgtk_pango.Pango.Font.font_t =
      fun () -> new Ocgtk_pango.Pango.Font.font (Text_node.get_font obj)

    method get_num_glyphs : unit -> int = fun () -> Text_node.get_num_glyphs obj
    ...
    method has_color_glyphs : unit -> bool =
      fun () -> Text_node.has_color_glyphs obj

    method as_text_node = obj
  end

let new_ (font : Ocgtk_pango.Pango.Font.font_t)
    (glyphs : Ocgtk_pango.Pango.Glyph_string.glyph_string_t)
    (color : Ocgtk_gdk.Gdk.Rgb_a.rgb_a_t)
    (offset : Ocgtk_graphene.Graphene.Point.point_t) : text_node_t =
