...
class container_node (obj : Container_node.t) : container_node_t =
  object (self)
    inherit GRender_node.render_node (obj :> Render_node.t)

    method get_child : int -> GRender_node.render_node_t =
      fun idx -> new GRender_node.render_node (Container_node.get_child obj idx)

    method get_n_children : unit -> int =
      fun () -> Container_node.get_n_children obj
