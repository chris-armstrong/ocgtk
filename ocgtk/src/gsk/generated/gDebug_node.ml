...
class debug_node (obj : Debug_node.t) : debug_node_t =
  object (self)
    inherit GRender_node.render_node (obj :> Render_node.t)

    method get_child : unit -> GRender_node.render_node_t =
      fun () -> new GRender_node.render_node (Debug_node.get_child obj)

    method get_message : unit -> string = fun () -> Debug_node.get_message obj
