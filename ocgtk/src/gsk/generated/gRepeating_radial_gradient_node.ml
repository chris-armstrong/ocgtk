...
class repeating_radial_gradient_node (obj : Repeating_radial_gradient_node.t) :
  repeating_radial_gradient_node_t =
  object (self)
...
let new_ (bounds : Ocgtk_graphene.Graphene.Rect.rect_t)
  ...
  let obj_ =
    Repeating_radial_gradient_node.new_ bounds center hradius vradius start end_
