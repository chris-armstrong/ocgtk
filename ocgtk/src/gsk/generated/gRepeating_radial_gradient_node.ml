...
let new_ (bounds : Ocgtk_graphene.Graphene.Rect.rect_t) (center : Ocgtk_graphene.Graphene.Point.point_t) (hradius : float) (vradius : float) (start : float) (end_ : float) (color_stops : Color_stop.t array) (n_color_stops : int) : repeating_radial_gradient_node_t =
