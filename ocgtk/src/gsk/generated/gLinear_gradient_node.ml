...
class linear_gradient_node (obj : Linear_gradient_node.t) :
  linear_gradient_node_t =
  object (self)
    ...
    method get_end : unit -> Ocgtk_graphene.Graphene.Point.point_t =
      fun () ->
        new Ocgtk_graphene.Graphene.Point.point
          (Linear_gradient_node.get_end obj)

    method get_n_color_stops : unit -> Gsize.t =
      fun () -> Linear_gradient_node.get_n_color_stops obj

    method get_start : unit -> Ocgtk_graphene.Graphene.Point.point_t =
      fun () ->
        new Ocgtk_graphene.Graphene.Point.point
          (Linear_gradient_node.get_start obj)
...
let new_ (bounds : Ocgtk_graphene.Graphene.Rect.rect_t)
  ...
  let obj_ =
    Linear_gradient_node.new_ bounds start end_ color_stops n_color_stops
  in
