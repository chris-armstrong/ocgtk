...
val new_ : Ocgtk_graphene.Graphene.Rect.rect_t -> Ocgtk_graphene.Graphene.Point.point_t -> float -> float -> float -> float -> Color_stop.t array -> Gsize.t -> repeating_radial_gradient_node_t
