...
class fontset_simple (obj : Fontset_simple.t) : fontset_simple_t =
  object (self)
    inherit
      GContext_and__font_and__font_map_and__fontset.fontset
        (obj :> Context_and__font_and__font_map_and__fontset.Fontset.t)
    ...
    method size : unit -> int = fun () -> Fontset_simple.size obj
