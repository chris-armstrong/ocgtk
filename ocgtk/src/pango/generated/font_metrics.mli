...
external get_underline_thickness : t -> int = "ml_pango_font_metrics_get_underline_thickness"
...
external get_underline_position : t -> int = "ml_pango_font_metrics_get_underline_position"

(** Gets the suggested thickness to draw for the strikethrough. *)
external get_strikethrough_thickness : t -> int = "ml_pango_font_metrics_get_strikethrough_thickness"

(** Gets the suggested position to draw the strikethrough.

The value returned is the distance *above* the
baseline of the top of the strikethrough. *)
external get_strikethrough_position : t -> int = "ml_pango_font_metrics_get_strikethrough_position"
...
external get_approximate_digit_width : t -> int = "ml_pango_font_metrics_get_approximate_digit_width"
...
external get_approximate_char_width : t -> int = "ml_pango_font_metrics_get_approximate_char_width"
