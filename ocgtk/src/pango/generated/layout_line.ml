...
external x_to_index : t -> int -> bool * int * int = "ml_pango_layout_line_x_to_index"
...
external is_paragraph_start : t -> bool = "ml_pango_layout_line_is_paragraph_start"

(** Converts an index within a line to a X position. *)
external index_to_x : t -> int -> bool -> int = "ml_pango_layout_line_index_to_x"
...
external get_x_ranges : t -> int -> int -> int array * int = "ml_pango_layout_line_get_x_ranges"
...
external get_resolved_direction : t -> Pango_enums.direction = "ml_pango_layout_line_get_resolved_direction"
...
external get_pixel_extents : t -> Rectangle.t * Rectangle.t = "ml_pango_layout_line_get_pixel_extents"
...
external get_extents : t -> Rectangle.t * Rectangle.t = "ml_pango_layout_line_get_extents"
