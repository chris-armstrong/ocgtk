...
class context (obj : Context_and__font_and__font_map_and__fontset.Context.t) :
  context_t =
  object (self)
    method changed : unit -> unit =
      fun () -> Context_and__font_and__font_map_and__fontset.Context.changed obj
    ...
    method get_base_gravity : unit -> Pango_enums.gravity =
      fun () ->
        Context_and__font_and__font_map_and__fontset.Context.get_base_gravity
          obj

    method get_font_description : unit -> Font_description.t option =
      fun () ->
        Context_and__font_and__font_map_and__fontset.Context
        .get_font_description obj

    method get_font_map : unit -> font_map_t option =
      fun () ->
        Option.map
          (fun ret -> new font_map ret)
          (Context_and__font_and__font_map_and__fontset.Context.get_font_map obj)
    ...
    method get_gravity_hint : unit -> Pango_enums.gravityhint =
      fun () ->
        Context_and__font_and__font_map_and__fontset.Context.get_gravity_hint
          obj
    ...
    method get_metrics :
        Font_description.t option -> Language.t option -> Font_metrics.t =
      fun desc language ->
        Context_and__font_and__font_map_and__fontset.Context.get_metrics obj
          desc language

    method get_round_glyph_positions : unit -> bool =
      fun () ->
        Context_and__font_and__font_map_and__fontset.Context
        .get_round_glyph_positions obj
    ...
    method load_font : Font_description.t -> font_t option =
      fun desc ->
        Option.map
          (fun ret -> new font ret)
          (Context_and__font_and__font_map_and__fontset.Context.load_font obj
             desc)

    method load_fontset : Font_description.t -> Language.t -> fontset_t option =
      fun desc language ->
        Option.map
          (fun ret -> new fontset ret)
          (Context_and__font_and__font_map_and__fontset.Context.load_fontset obj
             desc language)

    method set_base_dir : Pango_enums.direction -> unit =
      fun direction ->
        Context_and__font_and__font_map_and__fontset.Context.set_base_dir obj
          direction
    ...
    method set_font_map : font_map_t option -> unit =
      fun font_map ->
        ...
        Context_and__font_and__font_map_and__fontset.Context.set_font_map obj
          font_map

    method set_gravity_hint : Pango_enums.gravityhint -> unit =
      fun hint ->
        Context_and__font_and__font_map_and__fontset.Context.set_gravity_hint
          obj hint

    method set_language : Language.t option -> unit =
      fun language ->
        Context_and__font_and__font_map_and__fontset.Context.set_language obj
          language

    method set_matrix : Matrix.t option -> unit =
      fun matrix ->
        Context_and__font_and__font_map_and__fontset.Context.set_matrix obj
          matrix

    method set_round_glyph_positions : bool -> unit =
      fun round_positions ->
        Context_and__font_and__font_map_and__fontset.Context
        .set_round_glyph_positions obj round_positions

    method as_context = obj
  end

and font (obj : Context_and__font_and__font_map_and__fontset.Font.t) : font_t =
  object (self)
    method describe : unit -> Font_description.t =
      fun () -> Context_and__font_and__font_map_and__fontset.Font.describe obj

    method describe_with_absolute_size : unit -> Font_description.t =
      fun () ->
        Context_and__font_and__font_map_and__fontset.Font
        .describe_with_absolute_size obj

    method get_coverage : Language.t -> GCoverage.coverage_t =
      fun language ->
        new GCoverage.coverage
    ...
    method get_font_map : unit -> font_map_t option =
      fun () ->
        Option.map
          (fun ret -> new font_map ret)
          (Context_and__font_and__font_map_and__fontset.Font.get_font_map obj)

    method get_metrics : Language.t option -> Font_metrics.t =
      fun language ->
        Context_and__font_and__font_map_and__fontset.Font.get_metrics obj
          language
    ...
    method serialize : unit -> Glib_bytes.t =
      fun () -> Context_and__font_and__font_map_and__fontset.Font.serialize obj

    method as_font = obj
  end

and font_map (obj : Context_and__font_and__font_map_and__fontset.Font_map.t) :
  font_map_t =
  object (self)
    inherit
    ...
    method load_font : context_t -> Font_description.t -> font_t option =
      fun context desc ->
        ...
        Option.map
          (fun ret -> new font ret)
          (Context_and__font_and__font_map_and__fontset.Font_map.load_font obj
             context desc)
    ...
    method load_fontset :
      ...
      fun context desc language ->
        ...
        Option.map
          (fun ret -> new fontset ret)
          (Context_and__font_and__font_map_and__fontset.Font_map.load_fontset
             obj context desc language)
    ...
    method reload_font :
      ...
      fun font scale context variations ->
        ...
        new font
          (Context_and__font_and__font_map_and__fontset.Font_map.reload_font obj
             font scale context variations)

    method item_type =
      Context_and__font_and__font_map_and__fontset.Font_map.get_item_type obj

    method n_items =
      Context_and__font_and__font_map_and__fontset.Font_map.get_n_items obj

    method as_font_map = obj
  end

and fontset (obj : Context_and__font_and__font_map_and__fontset.Fontset.t) :
  fontset_t =
  object (self)
    method get_font : int -> font_t =
      fun wc ->
        new font
          (Context_and__font_and__font_map_and__fontset.Fontset.get_font obj wc)
