...
external get_attrs : t -> Attr_color_cycle_ed189c09.Attribute.t list
  = "ml_pango_attr_iterator_get_attrs"
(** Gets a list of all attributes at the current position of the iterator. *)

external get :
  t -> Pango_enums.attrtype -> Attr_color_cycle_ed189c09.Attribute.t option
