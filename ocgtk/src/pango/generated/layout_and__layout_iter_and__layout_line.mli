...
and Layout_line : sig
  ...
  (* Getters *)
  external get_layout : t -> Layout.t = "ml_pango_layout_line_get_layout"
  external get_start_index : t -> int = "ml_pango_layout_line_get_start_index"
  external get_length : t -> int = "ml_pango_layout_line_get_length"
  ...
  (* Setters *)
  external set_layout : t -> Layout.t -> unit
    = "ml_pango_layout_line_set_layout"
  ...
  external make : Layout.t -> int -> int -> unit -> int -> int -> t
    = "ml_pango_layout_line_make_bytecode" "ml_pango_layout_line_make_native"
end
