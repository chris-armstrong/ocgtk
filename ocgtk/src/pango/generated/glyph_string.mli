...
external x_to_index : t -> string -> int -> Analysis.t -> int -> int * int = "ml_pango_glyph_string_x_to_index"
...
clusters. *)
external index_to_x_full : t -> string -> int -> Analysis.t -> Log_attr.t option -> int -> bool -> int = "ml_pango_glyph_string_index_to_x_full_bytecode" "ml_pango_glyph_string_index_to_x_full_native"
...
external index_to_x : t -> string -> int -> Analysis.t -> int -> bool -> int = "ml_pango_glyph_string_index_to_x_bytecode" "ml_pango_glyph_string_index_to_x_native"
...
external extents_range : t -> int -> int -> Context_and__font_and__font_map_and__fontset.Font.t -> Rectangle.t * Rectangle.t = "ml_pango_glyph_string_extents_range"
...
external extents : t -> Context_and__font_and__font_map_and__fontset.Font.t -> Rectangle.t * Rectangle.t = "ml_pango_glyph_string_extents"
