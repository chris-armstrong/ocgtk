...
and Font_family : sig
  ...
  external list_faces : t -> Font_face.t array * int
    = "ml_pango_font_family_list_faces"
  ...
  external get_face : t -> string option -> Font_face.t option
    = "ml_pango_font_family_get_face"
