...
let () =
  ...
  let buffer =
    Text_buffer_and__text_iter_and__text_mark.Text_buffer.new_ None
  in
  ...
  Text_buffer_and__text_iter_and__text_mark.Text_buffer.insert_at_cursor buffer
  ...
  ignore
    (clear_btn#on_clicked ~callback:(fun () ->
         Text_buffer_and__text_iter_and__text_mark.Text_buffer.set_text buffer
           "" (-1)));
  ...
  let update_status () =
    let char_count =
      Text_buffer_and__text_iter_and__text_mark.Text_buffer.get_char_count
        buffer
    in
