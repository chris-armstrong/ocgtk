...
class color_chooser (obj : Color_chooser.t) = object (self)
  ...
  method get_use_alpha : unit -> bool = fun () -> (Color_chooser.get_use_alpha obj )

  method set_use_alpha : bool -> unit = fun use_alpha -> (Color_chooser.set_use_alpha obj use_alpha)
