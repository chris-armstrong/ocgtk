...
class string_sorter (obj : String_sorter.t) = object (self)
  ...
  method get_ignore_case : unit -> bool = fun () -> (String_sorter.get_ignore_case obj )
  ...
  method set_ignore_case : bool -> unit = fun ignore_case -> (String_sorter.set_ignore_case obj ignore_case)
