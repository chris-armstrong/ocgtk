...
class center_box (obj : Center_box.t) = object (self)
  ...
  method get_shrink_center_last : unit -> bool = fun () -> (Center_box.get_shrink_center_last obj )
  ...
  method set_shrink_center_last : bool -> unit = fun shrink_center_last -> (Center_box.set_shrink_center_last obj shrink_center_last)
