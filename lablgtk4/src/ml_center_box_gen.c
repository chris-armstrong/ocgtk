...
{
CAMLparam1(unit);
GtkWidget *widget = gtk_center_box_new();
...
CAMLparam2(self, arg1);
    ...
    gtk_center_box_set_start_widget(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_center_box_set_end_widget(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_center_box_set_center_widget(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_center_box_set_baseline_position(GtkWidget_val(self), GtkBaselinePosition_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkWidget* result = gtk_center_box_get_start_widget(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkWidget* result = gtk_center_box_get_end_widget(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
...
CAMLparam1(self);
    ...
    GtkWidget* result = gtk_center_box_get_center_widget(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
...
CAMLparam1(self);
    ...
    GtkBaselinePosition result = gtk_center_box_get_baseline_position(GtkWidget_val(self));
