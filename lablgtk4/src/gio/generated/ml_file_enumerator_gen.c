...
/* Type-specific conversion macros for GFileEnumerator */
#ifndef Val_GFileEnumerator
#define GFileEnumerator_val(val) ((GFileEnumerator*)ext_of_val(val))
#define Val_GFileEnumerator(obj) ((value)(val_of_ext(obj)))
