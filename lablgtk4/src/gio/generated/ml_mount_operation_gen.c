...
/* Type-specific conversion macros for GMountOperation */
#ifndef Val_GMountOperation
#define GMountOperation_val(val) ((GMountOperation*)ext_of_val(val))
#define Val_GMountOperation(obj) ((value)(val_of_ext(obj)))
