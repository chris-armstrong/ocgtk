...
/* Type-specific conversion macros for GSocketService */
#ifndef Val_GSocketService
#define GSocketService_val(val) ((GSocketService*)ext_of_val(val))
#define Val_GSocketService(obj) ((value)(val_of_ext(obj)))
