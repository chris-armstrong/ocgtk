...
/* Type-specific conversion macros for GSimpleIOStream */
#ifndef Val_GSimpleIOStream
#define GSimpleIOStream_val(val) ((GSimpleIOStream*)ext_of_val(val))
#define Val_GSimpleIOStream(obj) ((value)(val_of_ext(obj)))
