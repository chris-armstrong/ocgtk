...
/* Type-specific conversion macros for GCancellable */
#ifndef Val_GCancellable
#define GCancellable_val(val) ((GCancellable*)ext_of_val(val))
#define Val_GCancellable(obj) ((value)(val_of_ext(obj)))
