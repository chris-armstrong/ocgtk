...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_numeric_sorter_new((Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
...
CAMLparam2(self, arg1);
    ...
    gtk_numeric_sorter_set_sort_order(GtkWidget_val(self), GtkSortType_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_numeric_sorter_set_expression(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkSortType result = gtk_numeric_sorter_get_sort_order(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkExpression* result = gtk_numeric_sorter_get_expression(GtkWidget_val(self));
