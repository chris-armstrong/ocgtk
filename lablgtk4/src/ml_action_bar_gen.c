...
CAMLparam2(self, arg1);
    ...
    gtk_action_bar_set_center_widget(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_action_bar_remove(GtkWidget_val(self), GtkWidget_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_action_bar_pack_start(GtkWidget_val(self), GtkWidget_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_action_bar_pack_end(GtkWidget_val(self), GtkWidget_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkWidget* result = gtk_action_bar_get_center_widget(GtkWidget_val(self));
