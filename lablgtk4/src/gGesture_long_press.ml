...
class gesture_long_press (obj : Gesture_long_press.t) = object (self)
  ...
  method get_delay_factor : unit -> float = fun () -> (Gesture_long_press.get_delay_factor obj )

  method set_delay_factor : float -> unit = fun delay_factor -> (Gesture_long_press.set_delay_factor obj delay_factor)
