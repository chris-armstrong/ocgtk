...
class grid_view (obj : Grid_view.t) = object (self)
  ...
  method get_enable_rubberband : unit -> bool = fun () -> (Grid_view.get_enable_rubberband obj )
  ...
  method get_max_columns : unit -> int = fun () -> (Grid_view.get_max_columns obj )

  method get_min_columns : unit -> int = fun () -> (Grid_view.get_min_columns obj )
  ...
  method get_single_click_activate : unit -> bool = fun () -> (Grid_view.get_single_click_activate obj )
  ...
  method set_enable_rubberband : bool -> unit = fun enable_rubberband -> (Grid_view.set_enable_rubberband obj enable_rubberband)
  ...
  method set_max_columns : int -> unit = fun max_columns -> (Grid_view.set_max_columns obj max_columns)

  method set_min_columns : int -> unit = fun min_columns -> (Grid_view.set_min_columns obj min_columns)
  ...
  method set_single_click_activate : bool -> unit = fun single_click_activate -> (Grid_view.set_single_click_activate obj single_click_activate)
