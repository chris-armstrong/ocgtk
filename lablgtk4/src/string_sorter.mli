...
external new_ : Gtk.Widget.t option -> t = "ml_gtk_string_sorter_new"
...
external set_expression : t -> Gtk.Widget.t option -> unit = "ml_gtk_string_sorter_set_expression"

external set_collation : t -> Gtk_enums.collation -> unit = "ml_gtk_string_sorter_set_collation"

external get_expression : t -> Gtk.Widget.t = "ml_gtk_string_sorter_get_expression"
