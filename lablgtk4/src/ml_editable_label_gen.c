...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_editable_label_new(String_val(arg1));
...
CAMLparam2(self, arg1);
    ...
    gtk_editable_label_stop_editing(GtkWidget_val(self), Bool_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    gtk_editable_label_start_editing(GtkWidget_val(self));
CAMLreturn(Val_unit);
}
