...
GtkWidget *widget = gtk_text_mark_new((Is_some(arg1) ? String_val(Some_val(arg1)) : NULL), Bool_val(arg2));
...
CAMLparam2(self, arg1);
    ...
    gtk_text_mark_set_visible(GtkWidget_val(self), Bool_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    gboolean result = gtk_text_mark_get_visible(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    gboolean result = gtk_text_mark_get_deleted(GtkWidget_val(self));
CAMLreturn(Val_bool(result));
}
...
CAMLparam1(self);
    ...
    GtkTextBuffer* result = gtk_text_mark_get_buffer(GtkWidget_val(self));
