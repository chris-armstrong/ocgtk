...
(* SKIPPED: unmapped parameter type - external window_to_buffer_coords : t -> Gtk_enums.textwindowtype -> int -> int -> int -> int -> unit = "ml_gtk_text_view_window_to_buffer_coords_bytecode" "ml_gtk_text_view_window_to_buffer_coords_native" *)
(* SKIPPED: unmapped parameter type - external starts_display_line : t -> unit -> bool = "ml_gtk_text_view_starts_display_line" *)
external set_wrap_mode : t -> Gtk_enums.wrapmode -> unit = "ml_gtk_text_view_set_wrap_mode"
(* SKIPPED: unmapped parameter type - external set_tabs : t -> unit -> unit = "ml_gtk_text_view_set_tabs" *)
...
(* SKIPPED: unmapped parameter type - external set_extra_menu : t -> unit -> unit = "ml_gtk_text_view_set_extra_menu" *)
...
(* SKIPPED: unmapped parameter type - external get_visible_rect : t -> unit -> unit = "ml_gtk_text_view_get_visible_rect" *)
(* SKIPPED: unmapped return type - external get_tabs : t -> unit = "ml_gtk_text_view_get_tabs" *)
(* SKIPPED: unmapped return type - external get_rtl_context : t -> unit = "ml_gtk_text_view_get_rtl_context" *)
(* SKIPPED: unmapped return type - external get_ltr_context : t -> unit = "ml_gtk_text_view_get_ltr_context" *)
(* SKIPPED: unmapped parameter type - external get_line_yrange : t -> unit -> int -> int -> unit = "ml_gtk_text_view_get_line_yrange" *)
(* SKIPPED: unmapped parameter type - external get_line_at_y : t -> Gtk.Widget.t -> int -> int -> unit = "ml_gtk_text_view_get_line_at_y" *)
external get_justification : t -> Gtk_enums.justification = "ml_gtk_text_view_get_justification"
(* SKIPPED: unmapped parameter type - external get_iter_location : t -> unit -> unit -> unit = "ml_gtk_text_view_get_iter_location" *)
(* SKIPPED: unmapped parameter type - external get_iter_at_position : t -> Gtk.Widget.t -> int -> int -> int -> bool = "ml_gtk_text_view_get_iter_at_position" *)
...
(* SKIPPED: unmapped return type - external get_extra_menu : t -> unit = "ml_gtk_text_view_get_extra_menu" *)
(* SKIPPED: unmapped parameter type - external get_cursor_locations : t -> unit -> unit -> unit -> unit = "ml_gtk_text_view_get_cursor_locations" *)
...
(* SKIPPED: unmapped parameter type - external buffer_to_window_coords : t -> Gtk_enums.textwindowtype -> int -> int -> int -> int -> unit = "ml_gtk_text_view_buffer_to_window_coords_bytecode" "ml_gtk_text_view_buffer_to_window_coords_native" *)
