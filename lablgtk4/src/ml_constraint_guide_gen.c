...
{
CAMLparam1(unit);
GtkWidget *widget = gtk_constraint_guide_new();
...
CAMLparam2(self, arg1);
    ...
    gtk_constraint_guide_set_strength(GtkWidget_val(self), GtkConstraintStrength_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam3(self, arg1, arg2);
    ...
    gtk_constraint_guide_set_nat_size(GtkWidget_val(self), Int_val(arg1), Int_val(arg2));
CAMLreturn(Val_unit);
}
...
CAMLparam3(self, arg1, arg2);
    ...
    gtk_constraint_guide_set_min_size(GtkWidget_val(self), Int_val(arg1), Int_val(arg2));
CAMLreturn(Val_unit);
}
...
CAMLparam3(self, arg1, arg2);
    ...
    gtk_constraint_guide_set_max_size(GtkWidget_val(self), Int_val(arg1), Int_val(arg2));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkConstraintStrength result = gtk_constraint_guide_get_strength(GtkWidget_val(self));
CAMLreturn(Val_GtkConstraintStrength(result));
}

CAMLexport CAMLprim value ml_gtk_constraint_guide_get_nat_size(value self, value arg1, value arg2)
{
CAMLparam3(self, arg1, arg2);


    gtk_constraint_guide_get_nat_size(GtkWidget_val(self), arg1, arg2);
CAMLreturn(Val_unit);
}

CAMLexport CAMLprim value ml_gtk_constraint_guide_get_min_size(value self, value arg1, value arg2)
{
CAMLparam3(self, arg1, arg2);


    gtk_constraint_guide_get_min_size(GtkWidget_val(self), arg1, arg2);
CAMLreturn(Val_unit);
}

CAMLexport CAMLprim value ml_gtk_constraint_guide_get_max_size(value self, value arg1, value arg2)
{
CAMLparam3(self, arg1, arg2);


    gtk_constraint_guide_get_max_size(GtkWidget_val(self), arg1, arg2);
CAMLreturn(Val_unit);
}
