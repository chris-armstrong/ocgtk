...
GtkWidget *widget = gtk_column_view_column_new((Is_some(arg1) ? String_val(Some_val(arg1)) : NULL), (Is_some(arg2) ? GtkWidget_val(Some_val(arg2)) : NULL));
...
CAMLparam2(self, arg1);
    ...
    gtk_column_view_column_set_sorter(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_column_view_column_set_header_menu(GtkWidget_val(self), arg1);
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_column_view_column_set_factory(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkSorter* result = gtk_column_view_column_get_sorter(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkListItemFactory* result = gtk_column_view_column_get_factory(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
...
CAMLparam1(self);
    ...
    GtkColumnView* result = gtk_column_view_column_get_column_view(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
