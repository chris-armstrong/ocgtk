...
external set_start_widget : t -> Gtk.Widget.t option -> unit = "ml_gtk_center_layout_set_start_widget"

external set_orientation : t -> Gtk_enums.orientation -> unit = "ml_gtk_center_layout_set_orientation"

external set_end_widget : t -> Gtk.Widget.t option -> unit = "ml_gtk_center_layout_set_end_widget"

external set_center_widget : t -> Gtk.Widget.t option -> unit = "ml_gtk_center_layout_set_center_widget"

external set_baseline_position : t -> Gtk_enums.baselineposition -> unit = "ml_gtk_center_layout_set_baseline_position"

external get_start_widget : t -> Gtk.Widget.t = "ml_gtk_center_layout_get_start_widget"

external get_orientation : t -> Gtk_enums.orientation = "ml_gtk_center_layout_get_orientation"

external get_end_widget : t -> Gtk.Widget.t = "ml_gtk_center_layout_get_end_widget"

external get_center_widget : t -> Gtk.Widget.t = "ml_gtk_center_layout_get_center_widget"
