...
(* SKIPPED: unmapped parameter type - external set_tabs : t -> unit -> unit = "ml_gtk_entry_set_tabs" *)
...
(* SKIPPED: unmapped parameter type - external set_icon_from_paintable : t -> Gtk_enums.entryiconposition -> unit -> unit = "ml_gtk_entry_set_icon_from_paintable" *)
external set_icon_from_icon_name : t -> Gtk_enums.entryiconposition -> string option -> unit = "ml_gtk_entry_set_icon_from_icon_name"
(* SKIPPED: unmapped parameter type - external set_icon_from_gicon : t -> Gtk_enums.entryiconposition -> unit -> unit = "ml_gtk_entry_set_icon_from_gicon" *)
(* SKIPPED: unmapped parameter type - external set_icon_drag_source : t -> Gtk_enums.entryiconposition -> unit -> Gdk_enums.dragaction -> unit = "ml_gtk_entry_set_icon_drag_source" *)
external set_icon_activatable : t -> Gtk_enums.entryiconposition -> bool -> unit = "ml_gtk_entry_set_icon_activatable"
(* SKIPPED: unmapped parameter type - external set_extra_menu : t -> unit -> unit = "ml_gtk_entry_set_extra_menu" *)
...
(* SKIPPED: unmapped parameter type - external set_attributes : t -> unit -> unit = "ml_gtk_entry_set_attributes" *)
...
(* SKIPPED: unmapped return type - external get_tabs : t -> unit = "ml_gtk_entry_get_tabs" *)
...
(* SKIPPED: unmapped return type - external get_icon_tooltip_text : t -> Gtk_enums.entryiconposition -> string = "ml_gtk_entry_get_icon_tooltip_text" *)
(* SKIPPED: unmapped return type - external get_icon_tooltip_markup : t -> Gtk_enums.entryiconposition -> string = "ml_gtk_entry_get_icon_tooltip_markup" *)
...
(* SKIPPED: unmapped return type - external get_icon_paintable : t -> Gtk_enums.entryiconposition -> unit = "ml_gtk_entry_get_icon_paintable" *)
external get_icon_name : t -> Gtk_enums.entryiconposition -> string = "ml_gtk_entry_get_icon_name"
(* SKIPPED: unmapped return type - external get_icon_gicon : t -> Gtk_enums.entryiconposition -> unit = "ml_gtk_entry_get_icon_gicon" *)
external get_icon_at_pos : t -> int -> int -> int = "ml_gtk_entry_get_icon_at_pos"
(* SKIPPED: unmapped parameter type - external get_icon_area : t -> Gtk_enums.entryiconposition -> unit -> unit = "ml_gtk_entry_get_icon_area" *)
external get_icon_activatable : t -> Gtk_enums.entryiconposition -> bool = "ml_gtk_entry_get_icon_activatable"
(* SKIPPED: unmapped return type - external get_extra_menu : t -> unit = "ml_gtk_entry_get_extra_menu" *)
...
(* SKIPPED: unmapped return type - external get_attributes : t -> unit = "ml_gtk_entry_get_attributes" *)
external get_alignment : t -> float = "ml_gtk_entry_get_alignment"

(* Summary:
 * - 1 type declarations
 * - 91 external bindings
 *)
