...
external connect_enter :
  ...
  Gobject.signal_id = "ml_gtk_event_controller_motion_connect_enter"

external connect_leave :
  t ->
  callback:(unit -> unit) ->
  Gobject.signal_id = "ml_gtk_event_controller_motion_connect_leave"

external connect_motion :
  t ->
  callback:(x:float -> y:float -> unit) ->
  Gobject.signal_id = "ml_gtk_event_controller_motion_connect_motion"
