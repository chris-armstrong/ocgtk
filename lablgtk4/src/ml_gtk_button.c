...
CAMLprim value ml_gtk_button_new_with_label(value label)
{
    ...
    CAMLreturn(val_of_GtkWidget(button));
}
...
{
    CAMLparam1(button);
    const char *label = gtk_button_get_label(GTK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_button_set_label(value button, value label)
{
    ...
    gtk_button_set_label(GTK_BUTTON(GtkWidget_of_val(button)), String_val(label));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gboolean has_frame = gtk_button_get_has_frame(GTK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_button_set_has_frame(value button, value has_frame)
{
    ...
    gtk_button_set_has_frame(GTK_BUTTON(GtkWidget_of_val(button)), Bool_val(has_frame));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gboolean use_underline = gtk_button_get_use_underline(GTK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_button_set_use_underline(value button, value use_underline)
{
    ...
    gtk_button_set_use_underline(GTK_BUTTON(GtkWidget_of_val(button)), Bool_val(use_underline));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    const char *icon_name = gtk_button_get_icon_name(GTK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_button_set_icon_name(value button, value icon_name)
{
    ...
    gtk_button_set_icon_name(GTK_BUTTON(GtkWidget_of_val(button)), String_val(icon_name));
    CAMLreturn(Val_unit);
}
...
CAMLprim value ml_gtk_button_get_can_shrink(value button)
{
    CAMLparam1(button);
    gboolean can_shrink;
    g_object_get(G_OBJECT(GtkWidget_of_val(button)), "can-shrink", &can_shrink, NULL);
...
CAMLprim value ml_gtk_button_set_can_shrink(value button, value can_shrink)
{
    ...
    g_object_set(G_OBJECT(GtkWidget_of_val(button)), "can-shrink", Bool_val(can_shrink), NULL);
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    GtkWidget *child = gtk_button_get_child(GTK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_button_set_child(value button, value child)
{
    ...
    GtkWidget *child_widget = Is_some(child) ? GtkWidget_of_val(Some_val(child)) : NULL;
    gtk_button_set_child(GTK_BUTTON(GtkWidget_of_val(button)), child_widget);
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gboolean active = gtk_check_button_get_active(GTK_CHECK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_check_button_set_active(value button, value active)
{
    ...
    gtk_check_button_set_active(GTK_CHECK_BUTTON(GtkWidget_of_val(button)), Bool_val(active));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    const char *label = gtk_check_button_get_label(GTK_CHECK_BUTTON(GtkWidget_of_val(button)));
    CAMLreturn(caml_copy_string(label ? label : ""));
}
...
{
    CAMLparam2(button, label);
    gtk_check_button_set_label(GTK_CHECK_BUTTON(GtkWidget_of_val(button)), String_val(label));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gboolean use_underline = gtk_check_button_get_use_underline(GTK_CHECK_BUTTON(GtkWidget_of_val(button)));
    CAMLreturn(Val_bool(use_underline));
}
...
{
    CAMLparam2(button, use_underline);
    gtk_check_button_set_use_underline(GTK_CHECK_BUTTON(GtkWidget_of_val(button)), Bool_val(use_underline));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gboolean inconsistent = gtk_check_button_get_inconsistent(GTK_CHECK_BUTTON(GtkWidget_of_val(button)));
...
CAMLprim value ml_gtk_check_button_set_inconsistent(value button, value inconsistent)
{
    ...
    gtk_check_button_set_inconsistent(GTK_CHECK_BUTTON(GtkWidget_of_val(button)), Bool_val(inconsistent));
    CAMLreturn(Val_unit);
}
...
CAMLprim value ml_gtk_check_button_set_group(value button, value group)
{
    ...
    GtkCheckButton *group_button = Is_some(group) ?
        GTK_CHECK_BUTTON(GtkWidget_of_val(Some_val(group))) : NULL;
    gtk_check_button_set_group(GTK_CHECK_BUTTON(GtkWidget_of_val(button)), group_button);
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gboolean active = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(GtkWidget_of_val(button)));
    CAMLreturn(Val_bool(active));
}
...
{
    CAMLparam2(button, active);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(GtkWidget_of_val(button)), Bool_val(active));
    CAMLreturn(Val_unit);
}
...
{
    CAMLparam1(button);
    gtk_toggle_button_toggled(GTK_TOGGLE_BUTTON(GtkWidget_of_val(button)));
    CAMLreturn(Val_unit);
}
