        ...
        [
          {
            param_name = "title";
            param_type =
              { name = "utf8"; c_type = Some "const gchar*"; nullable = false; transfer_ownership = TransferNone };
            direction = In;
            nullable = true;
        ...
        [
          {
            param_name = "parent";
            param_type =
              { name = "Widget"; c_type = Some "GtkWidget*"; nullable = false; transfer_ownership = TransferNone };
            direction = In;
            nullable = true;
  ...
  let meth =
    {
      ...
      return_type =
        { name = "Widget"; c_type = Some "GtkWidget*"; nullable = true; transfer_ownership = TransferNone };
      parameters = [];
      doc = None;
      throws = false;
      get_property = None;
