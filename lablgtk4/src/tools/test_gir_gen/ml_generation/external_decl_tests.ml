...
let test_method_multiple_params () =
  ...
  let meth = {
    ...
    parameters = [
      {
        param_name = "lower";
        param_type = { name = "gdouble"; c_type = Some "gdouble"; nullable = false };
        direction = In;
        nullable = false;
        varargs = false;
      };
...
let test_method_with_object_param () =
  ...
  let meth = {
    ...
    parameters = [
      {
        param_name = "child";
        param_type = { name = "Widget"; c_type = Some "GtkWidget*"; nullable = false };
        direction = In;
        nullable = false;
        varargs = false;
      }
...
let test_method_with_nullable_object () =
  ...
  let meth = {
    ...
    parameters = [
      {
        param_name = "parent";
        param_type = { name = "Widget"; c_type = Some "GtkWidget*"; nullable = true };
        direction = In;
        nullable = true;
        varargs = false;
      }
...
let test_property_getter_nullable () =
  ...
  let meth = {
    ...
    return_type = { name = "utf8"; c_type = Some "gchar*"; nullable = true };
    parameters = [];
    doc = None;
    throws = false;
