...
let enums = [
  ...
  "Gtk", "Gtk4Enums",
  [ "Justification"; "Align"; "ShadowType";
    "ImageType"; "WindowType";
    "ButtonsType"; "MessageType"; "PositionType";
    "Orientation"; "IconSize"; "PolicyType"; "CornerType";
    "SelectionMode"; "SortType"; "WrapMode";
    "CellRendererMode"; "TreeViewColumnSizing";
    "SortType"; "TextDirection"; "SizeGroupMode"; "StackTransitionType";
    "MovementStep"; "ScrollStep"; "ScrollType"; "MenuDirectionType";
    "DeleteType"; (* for canvas *) "AnchorType";
    "DirectionType"; "SensitivityType"; "InputHints"; "InputPurpose";
    "EntryIconPosition"; "PackDirection"; "TreeViewGridLines";
    "FileChooserAction"; "Response"
  ];
...
let boxeds = [
  "Gdk", ["RGBA"; "Cairo"];  (* Color and Font removed in GTK4 *)
  "Pango", ["FontDescription";];
  "Gtk", ["SelectionData";"TextIter";"TreePath"; "TreeIter";];  (* IconSet removed in GTK4 *)
]

let classes = [
  "Gdk", [ "Screen"; "DragContext";];  (* Image, Pixmap, Bitmap removed in GTK4 *)
  "Gtk", [ "TreeStore"; "TreeModel"; "TreeModelFilter"; "Tooltip" ]  (* Style removed in GTK4 *)
]
