...
let enums =
  [(* GTK4 enums - updated for GTK4 API *)
   "Gtk",
   "Gtk4Enums",
   ["Justification"; "Align"; "ShadowType"; "ImageType"; "WindowType";
    "ButtonsType"; "MessageType"; "PositionType"; "Orientation"; "IconSize";
    "PolicyType"; "CornerType"; "SelectionMode"; "SortType"; "WrapMode";
    "CellRendererMode"; "TreeViewColumnSizing"; "SortType"; "TextDirection";
    "SizeGroupMode"; "StackTransitionType"; "MovementStep"; "ScrollStep";
    "ScrollType"; "MenuDirectionType"; "DeleteType";
    (* for canvas *)    "AnchorType"; "DirectionType"; "SensitivityType";
    "InputHints"; "InputPurpose"; "EntryIconPosition"; "PackDirection";
    "TreeViewGridLines"; "FileChooserAction"; "Response"];
   (* GDK4 enums - updated for GDK4 API *)
   "Gdk", "Gdk4Enums", ["EventMask"; "Gravity"];
   (* Pango enums - unchanged from GTK3 *)
   "Pango", "PangoEnums",
   ["Stretch"; "Style"; "Underline"; "Variant"; "EllipsizeMode"; "WrapMode"]]

(* These types must be registered with g_boxed_register! *)
(* Updated for GTK4 - removed deprecated types *)
let boxeds =
  ["Gdk", ["RGBA"; "Cairo"];
   (* Color and Font removed in GTK4 *)
   "Pango", ["FontDescription"];
   "Gtk", ["SelectionData"; "TextIter"; "TreePath"; "TreeIter"]]

let classes =
  ["Gdk", ["Screen"; "DragContext"];
   (* Image, Pixmap, Bitmap removed in GTK4 *)
   "Gtk", ["TreeStore"; "TreeModel"; "TreeModelFilter"; "Tooltip"]]
