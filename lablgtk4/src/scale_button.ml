...
external get_plus_button : t -> Gtk.Widget.t = "ml_gtk_scale_button_get_plus_button"

external get_minus_button : t -> Gtk.Widget.t = "ml_gtk_scale_button_get_minus_button"

external get_adjustment : t -> Gtk.Widget.t = "ml_gtk_scale_button_get_adjustment"
