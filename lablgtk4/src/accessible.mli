...
external update_state : t -> Gtk_enums.accessiblestate -> unit -> unit = "ml_gtk_accessible_update_state"

external update_relation_value : t -> int -> unit -> unit -> unit = "ml_gtk_accessible_update_relation_value"

external update_relation : t -> Gtk_enums.accessiblerelation -> unit -> unit = "ml_gtk_accessible_update_relation"

external update_property_value : t -> int -> unit -> unit -> unit = "ml_gtk_accessible_update_property_value"

external update_property : t -> Gtk_enums.accessibleproperty -> unit -> unit = "ml_gtk_accessible_update_property"
