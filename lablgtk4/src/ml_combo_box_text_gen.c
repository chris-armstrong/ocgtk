...
CAMLparam1(self);
    ...
    gtk_combo_box_text_remove_all(GtkWidget_val(self));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_combo_box_text_remove(GtkWidget_val(self), Int_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_combo_box_text_prepend_text(GtkWidget_val(self), String_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam3(self, arg1, arg2);
    ...
    gtk_combo_box_text_prepend(GtkWidget_val(self), (Is_some(arg1) ? String_val(Some_val(arg1)) : NULL), String_val(arg2));
CAMLreturn(Val_unit);
}
...
CAMLparam3(self, arg1, arg2);
    ...
    gtk_combo_box_text_insert_text(GtkWidget_val(self), Int_val(arg1), String_val(arg2));
CAMLreturn(Val_unit);
}
...
CAMLparam4(self, arg1, arg2, arg3);
    ...
    gtk_combo_box_text_insert(GtkWidget_val(self), Int_val(arg1), (Is_some(arg2) ? String_val(Some_val(arg2)) : NULL), String_val(arg3));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_combo_box_text_append_text(GtkWidget_val(self), String_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam3(self, arg1, arg2);
    ...
    gtk_combo_box_text_append(GtkWidget_val(self), (Is_some(arg1) ? String_val(Some_val(arg1)) : NULL), String_val(arg2));
CAMLreturn(Val_unit);
}
