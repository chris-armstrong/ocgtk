...
external set_wrap_mode : t -> Pango.wrap_mode -> unit = "ml_gtk_label_set_wrap_mode"
...
external set_justify : t -> Gtk.justification -> unit = "ml_gtk_label_set_justify"
...
external get_wrap_mode : t -> Pango.wrap_mode = "ml_gtk_label_get_wrap_mode"
...
external get_justify : t -> Gtk.justification = "ml_gtk_label_get_justify"
