...
{
CAMLparam1(unit);
GtkWidget *widget = gtk_cell_view_new();
...
GtkWidget *widget = gtk_cell_view_new_with_context(GtkWidget_val(arg1), GtkWidget_val(arg2));
CAMLreturn(Val_GtkWidget(widget));
}
...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_cell_view_new_with_markup(String_val(arg1));
CAMLreturn(Val_GtkWidget(widget));
}
...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_cell_view_new_with_text(String_val(arg1));
CAMLreturn(Val_GtkWidget(widget));
}
...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_cell_view_new_with_texture(arg1);
CAMLreturn(Val_GtkWidget(widget));
}
...
CAMLparam2(self, arg1);
    ...
    gtk_cell_view_set_model(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_cell_view_set_displayed_row(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkTreeModel* result = gtk_cell_view_get_model(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkTreePath* result = gtk_cell_view_get_displayed_row(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
