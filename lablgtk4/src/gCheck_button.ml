...
class check_button (obj : Check_button.t) = object (self)
  ...
  method get_inconsistent : unit -> bool = fun () -> (Check_button.get_inconsistent obj )

  method get_label : unit -> string option = fun () -> (Check_button.get_label obj )

  method get_use_underline : unit -> bool = fun () -> (Check_button.get_use_underline obj )

  method set_active : bool -> unit = fun setting -> (Check_button.set_active obj setting)
  ...
  method set_inconsistent : bool -> unit = fun inconsistent -> (Check_button.set_inconsistent obj inconsistent)

  method set_label : string option -> unit = fun label -> (Check_button.set_label obj label)

  method set_use_underline : bool -> unit = fun setting -> (Check_button.set_use_underline obj setting)
