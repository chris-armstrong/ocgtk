...
class application_window (obj : Application_window.t) = object (self)
  ...
  method get_show_menubar : unit -> bool = fun () -> (Application_window.get_show_menubar obj )
  ...
  method set_show_menubar : bool -> unit = fun show_menubar -> (Application_window.set_show_menubar obj show_menubar)
