...
GtkWidget *widget = gtk_directory_list_new((Is_some(arg1) ? String_val(Some_val(arg1)) : NULL), arg2);
...
CAMLparam2(self, arg1);
    ...
    gtk_directory_list_set_file(GtkWidget_val(self), arg1);
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    gboolean result = gtk_directory_list_is_loading(GtkWidget_val(self));
