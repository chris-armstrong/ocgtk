...
{
CAMLparam1(unit);
GtkWidget *widget = gtk_revealer_new();
...
CAMLparam2(self, arg1);
    ...
    gtk_revealer_set_transition_type(GtkWidget_val(self), GtkRevealerTransitionType_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_revealer_set_child(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkRevealerTransitionType result = gtk_revealer_get_transition_type(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkWidget* result = gtk_revealer_get_child(GtkWidget_val(self));
