...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_bool_filter_new((Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
...
CAMLparam2(self, arg1);
    ...
    gtk_bool_filter_set_expression(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkExpression* result = gtk_bool_filter_get_expression(GtkWidget_val(self));
