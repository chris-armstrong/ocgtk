...
CAMLxparam1(arg6);
GtkWidget *widget = gtk_tree_list_model_new(arg1, Bool_val(arg2), Bool_val(arg3), arg4, arg5, arg6);
...
CAMLparam2(self, arg1);
    ...
    GtkTreeListRow* result = gtk_tree_list_model_get_row(GtkWidget_val(self), Int_val(arg1));
...
CAMLparam2(self, arg1);
    ...
    GtkTreeListRow* result = gtk_tree_list_model_get_child_row(GtkWidget_val(self), Int_val(arg1));
CAMLreturn(Val_GtkWidget(result));
}
