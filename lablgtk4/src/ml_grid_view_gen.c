...
GtkWidget *widget = gtk_grid_view_new((Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL), (Is_some(arg2) ? GtkWidget_val(Some_val(arg2)) : NULL));
...
CAMLparam2(self, arg1);
    ...
    gtk_grid_view_set_tab_behavior(GtkWidget_val(self), GtkListTabBehavior_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_grid_view_set_model(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_grid_view_set_factory(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam4(self, arg1, arg2, arg3);
    ...
    gtk_grid_view_scroll_to(GtkWidget_val(self), Int_val(arg1), GtkListScrollFlags_val(arg2), (Is_some(arg3) ? GtkWidget_val(Some_val(arg3)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkListTabBehavior result = gtk_grid_view_get_tab_behavior(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkSelectionModel* result = gtk_grid_view_get_model(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkListItemFactory* result = gtk_grid_view_get_factory(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
