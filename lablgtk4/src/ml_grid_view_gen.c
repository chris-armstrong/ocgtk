...
GtkGridView *obj = gtk_grid_view_new((Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL), (Is_some(arg2) ? GtkListItemFactory_val(Some_val(arg2)) : NULL));
...
gtk_grid_view_set_factory(GtkGridView_val(self), (Is_some(arg1) ? GtkListItemFactory_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
