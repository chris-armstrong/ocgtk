...
(* SKIPPED: unmapped parameter type - external insert_text : t -> string -> int -> int -> unit = "ml_gtk_editable_insert_text" *)
external init_delegate : t -> unit = "ml_gtk_editable_init_delegate"
(* SKIPPED: unmapped parameter type - external get_selection_bounds : t -> int -> int -> bool = "ml_gtk_editable_get_selection_bounds" *)
...
(* SKIPPED: unmapped return type - external get_chars : t -> int -> int -> string = "ml_gtk_editable_get_chars" *)
