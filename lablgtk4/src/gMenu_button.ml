...
class menu_button (obj : Menu_button.t) = object (self)
  ...
  method get_always_show_arrow : unit -> bool = fun () -> (Menu_button.get_always_show_arrow obj )

  method get_can_shrink : unit -> bool = fun () -> (Menu_button.get_can_shrink obj )
  ...
  method get_has_frame : unit -> bool = fun () -> (Menu_button.get_has_frame obj )

  method get_icon_name : unit -> string option = fun () -> (Menu_button.get_icon_name obj )

  method get_label : unit -> string option = fun () -> (Menu_button.get_label obj )
  ...
  method get_use_underline : unit -> bool = fun () -> (Menu_button.get_use_underline obj )

  method popdown : unit -> unit = fun () -> (Menu_button.popdown obj )

  method popup : unit -> unit = fun () -> (Menu_button.popup obj )

  method set_active : bool -> unit = fun active -> (Menu_button.set_active obj active)

  method set_always_show_arrow : bool -> unit = fun always_show_arrow -> (Menu_button.set_always_show_arrow obj always_show_arrow)

  method set_can_shrink : bool -> unit = fun can_shrink -> (Menu_button.set_can_shrink obj can_shrink)
  ...
  method set_has_frame : bool -> unit = fun has_frame -> (Menu_button.set_has_frame obj has_frame)

  method set_icon_name : string -> unit = fun icon_name -> (Menu_button.set_icon_name obj icon_name)

  method set_label : string -> unit = fun label -> (Menu_button.set_label obj label)
  ...
  method set_primary : bool -> unit = fun primary -> (Menu_button.set_primary obj primary)

  method set_use_underline : bool -> unit = fun use_underline -> (Menu_button.set_use_underline obj use_underline)
