...
class popover (obj : Popover.t) = object (self)
  ...
  method get_cascade_popdown : unit -> bool = fun () -> (Popover.get_cascade_popdown obj )
  ...
  method get_has_arrow : unit -> bool = fun () -> (Popover.get_has_arrow obj )

  method get_mnemonics_visible : unit -> bool = fun () -> (Popover.get_mnemonics_visible obj )
  ...
  method set_autohide : bool -> unit = fun autohide -> (Popover.set_autohide obj autohide)

  method set_cascade_popdown : bool -> unit = fun cascade_popdown -> (Popover.set_cascade_popdown obj cascade_popdown)
  ...
  method set_has_arrow : bool -> unit = fun has_arrow -> (Popover.set_has_arrow obj has_arrow)

  method set_mnemonics_visible : bool -> unit = fun mnemonics_visible -> (Popover.set_mnemonics_visible obj mnemonics_visible)
