...
class column_view (obj : Column_view_and__column_view_column.Column_view.t) = object (self)
  ...
  method get_enable_rubberband : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view.get_enable_rubberband obj )
  ...
  method get_reorderable : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view.get_reorderable obj )
  ...
  method get_show_column_separators : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view.get_show_column_separators obj )

  method get_show_row_separators : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view.get_show_row_separators obj )

  method get_single_click_activate : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view.get_single_click_activate obj )
  ...
  method set_enable_rubberband : bool -> unit = fun enable_rubberband -> (Column_view_and__column_view_column.Column_view.set_enable_rubberband obj enable_rubberband)
  ...
  method set_reorderable : bool -> unit = fun reorderable -> (Column_view_and__column_view_column.Column_view.set_reorderable obj reorderable)
  ...
  method set_show_column_separators : bool -> unit = fun show_column_separators -> (Column_view_and__column_view_column.Column_view.set_show_column_separators obj show_column_separators)

  method set_show_row_separators : bool -> unit = fun show_row_separators -> (Column_view_and__column_view_column.Column_view.set_show_row_separators obj show_row_separators)

  method set_single_click_activate : bool -> unit = fun single_click_activate -> (Column_view_and__column_view_column.Column_view.set_single_click_activate obj single_click_activate)
...
and column_view_column (obj : Column_view_and__column_view_column.Column_view_column.t) = object (self)
  ...
  method get_expand : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view_column.get_expand obj )
  ...
  method get_fixed_width : unit -> int = fun () -> (Column_view_and__column_view_column.Column_view_column.get_fixed_width obj )

  method get_id : unit -> string option = fun () -> (Column_view_and__column_view_column.Column_view_column.get_id obj )

  method get_resizable : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view_column.get_resizable obj )
  ...
  method get_title : unit -> string option = fun () -> (Column_view_and__column_view_column.Column_view_column.get_title obj )

  method get_visible : unit -> bool = fun () -> (Column_view_and__column_view_column.Column_view_column.get_visible obj )

  method set_expand : bool -> unit = fun expand -> (Column_view_and__column_view_column.Column_view_column.set_expand obj expand)
  ...
  method set_fixed_width : int -> unit = fun fixed_width -> (Column_view_and__column_view_column.Column_view_column.set_fixed_width obj fixed_width)

  method set_id : string option -> unit = fun id -> (Column_view_and__column_view_column.Column_view_column.set_id obj id)

  method set_resizable : bool -> unit = fun resizable -> (Column_view_and__column_view_column.Column_view_column.set_resizable obj resizable)
  ...
  method set_title : string option -> unit = fun title -> (Column_view_and__column_view_column.Column_view_column.set_title obj title)

  method set_visible : bool -> unit = fun visible -> (Column_view_and__column_view_column.Column_view_column.set_visible obj visible)
