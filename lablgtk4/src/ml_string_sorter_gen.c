...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_string_sorter_new((Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
...
CAMLparam2(self, arg1);
    ...
    gtk_string_sorter_set_expression(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_string_sorter_set_collation(GtkWidget_val(self), GtkCollation_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkExpression* result = gtk_string_sorter_get_expression(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkCollation result = gtk_string_sorter_get_collation(GtkWidget_val(self));
