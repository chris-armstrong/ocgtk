...
(* SKIPPED: unmapped parameter type - external select_range : t -> unit -> unit -> unit = "ml_gtk_text_buffer_select_range" *)
(* SKIPPED: unmapped parameter type - external remove_tag_by_name : t -> string -> unit -> unit -> unit = "ml_gtk_text_buffer_remove_tag_by_name" *)
(* SKIPPED: unmapped parameter type - external remove_tag : t -> Gtk.Widget.t -> unit -> unit -> unit = "ml_gtk_text_buffer_remove_tag" *)
(* SKIPPED: unmapped parameter type - external remove_selection_clipboard : t -> unit -> unit = "ml_gtk_text_buffer_remove_selection_clipboard" *)
(* SKIPPED: unmapped parameter type - external remove_all_tags : t -> unit -> unit -> unit = "ml_gtk_text_buffer_remove_all_tags" *)
external redo : t -> unit = "ml_gtk_text_buffer_redo"
(* SKIPPED: unmapped parameter type - external place_cursor : t -> unit -> unit = "ml_gtk_text_buffer_place_cursor" *)
(* SKIPPED: unmapped parameter type - external paste_clipboard : t -> unit -> Gtk.Widget.t option -> bool -> unit = "ml_gtk_text_buffer_paste_clipboard" *)
(* SKIPPED: unmapped parameter type - external move_mark_by_name : t -> string -> unit -> unit = "ml_gtk_text_buffer_move_mark_by_name" *)
(* SKIPPED: unmapped parameter type - external move_mark : t -> Gtk.Widget.t -> unit -> unit = "ml_gtk_text_buffer_move_mark" *)
(* SKIPPED: unmapped parameter type - external insert_range_interactive : t -> Gtk.Widget.t -> unit -> unit -> bool -> bool = "ml_gtk_text_buffer_insert_range_interactive" *)
(* SKIPPED: unmapped parameter type - external insert_range : t -> Gtk.Widget.t -> unit -> unit -> unit = "ml_gtk_text_buffer_insert_range" *)
(* SKIPPED: unmapped parameter type - external insert_paintable : t -> Gtk.Widget.t -> unit -> unit = "ml_gtk_text_buffer_insert_paintable" *)
...
(* SKIPPED: unmapped return type - external get_slice : t -> unit -> unit -> bool -> string = "ml_gtk_text_buffer_get_slice" *)
(* SKIPPED: unmapped return type - external get_selection_content : t -> unit = "ml_gtk_text_buffer_get_selection_content" *)
...
(* SKIPPED: unmapped parameter type - external cut_clipboard : t -> unit -> bool -> unit = "ml_gtk_text_buffer_cut_clipboard" *)
(* SKIPPED: unmapped parameter type - external create_mark : t -> string option -> unit -> bool -> Gtk.Widget.t = "ml_gtk_text_buffer_create_mark" *)
external create_child_anchor : t -> Gtk.Widget.t -> Gtk.Widget.t = "ml_gtk_text_buffer_create_child_anchor"
(* SKIPPED: unmapped parameter type - external copy_clipboard : t -> unit -> unit = "ml_gtk_text_buffer_copy_clipboard" *)
...
(* SKIPPED: unmapped parameter type - external apply_tag_by_name : t -> string -> unit -> unit -> unit = "ml_gtk_text_buffer_apply_tag_by_name" *)
(* SKIPPED: unmapped parameter type - external apply_tag : t -> Gtk.Widget.t -> unit -> unit -> unit = "ml_gtk_text_buffer_apply_tag" *)
(* SKIPPED: unmapped parameter type - external add_selection_clipboard : t -> unit -> unit = "ml_gtk_text_buffer_add_selection_clipboard" *)
(* SKIPPED: unmapped parameter type - external add_mark : t -> Gtk.Widget.t -> unit -> unit = "ml_gtk_text_buffer_add_mark" *)
