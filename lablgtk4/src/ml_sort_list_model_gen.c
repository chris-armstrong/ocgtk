...
GtkWidget *widget = gtk_sort_list_model_new(arg1, (Is_some(arg2) ? GtkWidget_val(Some_val(arg2)) : NULL));
...
CAMLparam2(self, arg1);
    ...
    gtk_sort_list_model_set_sorter(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_sort_list_model_set_section_sorter(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_sort_list_model_set_model(GtkWidget_val(self), arg1);
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkSorter* result = gtk_sort_list_model_get_sorter(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkSorter* result = gtk_sort_list_model_get_section_sorter(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
