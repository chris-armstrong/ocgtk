...
(* SKIPPED: unmapped parameter type - external get_range : t -> float -> float -> unit = "ml_gtk_spin_button_get_range" *)
(* SKIPPED: unmapped parameter type - external get_increments : t -> float -> float -> unit = "ml_gtk_spin_button_get_increments" *)
