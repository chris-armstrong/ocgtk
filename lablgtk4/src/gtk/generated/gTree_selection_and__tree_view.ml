...
and tree_view (obj : Tree_selection_and__tree_view.Tree_view.t) = object (self)
  ...
  method get_activate_on_single_click : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_activate_on_single_click obj )
  ...
  method get_enable_search : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_enable_search obj )

  method get_enable_tree_lines : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_enable_tree_lines obj )
  ...
  method get_fixed_height_mode : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_fixed_height_mode obj )

  method get_grid_lines : unit -> Gtk_enums.treeviewgridlines = fun () -> (Tree_selection_and__tree_view.Tree_view.get_grid_lines obj )

  method get_headers_clickable : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_headers_clickable obj )

  method get_headers_visible : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_headers_visible obj )

  method get_hover_expand : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_hover_expand obj )

  method get_hover_selection : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_hover_selection obj )

  method get_level_indentation : unit -> int = fun () -> (Tree_selection_and__tree_view.Tree_view.get_level_indentation obj )
  ...
  method get_reorderable : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_reorderable obj )

  method get_rubber_banding : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_rubber_banding obj )

  method get_search_column : unit -> int = fun () -> (Tree_selection_and__tree_view.Tree_view.get_search_column obj )
  ...
  method get_show_expanders : unit -> bool = fun () -> (Tree_selection_and__tree_view.Tree_view.get_show_expanders obj )

  method get_tooltip_column : unit -> int = fun () -> (Tree_selection_and__tree_view.Tree_view.get_tooltip_column obj )
  ...
  method set_activate_on_single_click : bool -> unit = fun single -> (Tree_selection_and__tree_view.Tree_view.set_activate_on_single_click obj single)
  ...
  method set_enable_search : bool -> unit = fun enable_search -> (Tree_selection_and__tree_view.Tree_view.set_enable_search obj enable_search)

  method set_enable_tree_lines : bool -> unit = fun enabled -> (Tree_selection_and__tree_view.Tree_view.set_enable_tree_lines obj enabled)
  ...
  method set_fixed_height_mode : bool -> unit = fun enable -> (Tree_selection_and__tree_view.Tree_view.set_fixed_height_mode obj enable)
  ...
  method set_headers_clickable : bool -> unit = fun setting -> (Tree_selection_and__tree_view.Tree_view.set_headers_clickable obj setting)

  method set_headers_visible : bool -> unit = fun headers_visible -> (Tree_selection_and__tree_view.Tree_view.set_headers_visible obj headers_visible)

  method set_hover_expand : bool -> unit = fun expand -> (Tree_selection_and__tree_view.Tree_view.set_hover_expand obj expand)

  method set_hover_selection : bool -> unit = fun hover -> (Tree_selection_and__tree_view.Tree_view.set_hover_selection obj hover)

  method set_level_indentation : int -> unit = fun indentation -> (Tree_selection_and__tree_view.Tree_view.set_level_indentation obj indentation)
  ...
  method set_reorderable : bool -> unit = fun reorderable -> (Tree_selection_and__tree_view.Tree_view.set_reorderable obj reorderable)

  method set_rubber_banding : bool -> unit = fun enable -> (Tree_selection_and__tree_view.Tree_view.set_rubber_banding obj enable)

  method set_search_column : int -> unit = fun column -> (Tree_selection_and__tree_view.Tree_view.set_search_column obj column)
  ...
  method set_show_expanders : bool -> unit = fun enabled -> (Tree_selection_and__tree_view.Tree_view.set_show_expanders obj enabled)
  ...
  method set_tooltip_column : int -> unit = fun column -> (Tree_selection_and__tree_view.Tree_view.set_tooltip_column obj column)
