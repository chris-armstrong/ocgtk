...
class scale (obj : Scale.t) = object (self)
  ...
  method set_draw_value : bool -> unit = fun draw_value -> (Scale.set_draw_value obj draw_value)

  method set_has_origin : bool -> unit = fun has_origin -> (Scale.set_has_origin obj has_origin)
