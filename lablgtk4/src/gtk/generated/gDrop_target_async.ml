...
class drop_target_async (obj : Drop_target_async.t) = object (self)
  ...
  method get_actions : unit -> Gdk.dragaction = fun () -> (Drop_target_async.get_actions obj )

  method set_actions : Gdk.dragaction -> unit = fun actions -> (Drop_target_async.set_actions obj actions)
