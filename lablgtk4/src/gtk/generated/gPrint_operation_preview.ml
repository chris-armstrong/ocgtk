...
class print_operation_preview (obj : Print_operation_preview.t) = object (self)
  ...
  method end_preview : unit -> unit = fun () -> (Print_operation_preview.end_preview obj )

  method is_selected : int -> bool = fun page_nr -> (Print_operation_preview.is_selected obj page_nr)

  method render_page : int -> unit = fun page_nr -> (Print_operation_preview.render_page obj page_nr)
