...
class column_view_cell (obj : Column_view_cell.t) = object (self)
  ...
  method get_focusable : unit -> bool = fun () -> (Column_view_cell.get_focusable obj )

  method get_position : unit -> int = fun () -> (Column_view_cell.get_position obj )

  method get_selected : unit -> bool = fun () -> (Column_view_cell.get_selected obj )
  ...
  method set_focusable : bool -> unit = fun focusable -> (Column_view_cell.set_focusable obj focusable)
