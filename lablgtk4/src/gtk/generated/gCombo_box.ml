...
class combo_box (obj : Combo_box.t) = object (self)
  ...
  method get_active_id : unit -> string option = fun () -> (Combo_box.get_active_id obj )
  ...
  method get_entry_text_column : unit -> int = fun () -> (Combo_box.get_entry_text_column obj )

  method get_has_entry : unit -> bool = fun () -> (Combo_box.get_has_entry obj )

  method get_id_column : unit -> int = fun () -> (Combo_box.get_id_column obj )
  ...
  method get_popup_fixed_width : unit -> bool = fun () -> (Combo_box.get_popup_fixed_width obj )

  method popdown : unit -> unit = fun () -> (Combo_box.popdown obj )

  method popup : unit -> unit = fun () -> (Combo_box.popup obj )

  method set_active : int -> unit = fun index_ -> (Combo_box.set_active obj index_)

  method set_active_id : string option -> bool = fun active_id -> (Combo_box.set_active_id obj active_id)
  ...
  method set_entry_text_column : int -> unit = fun text_column -> (Combo_box.set_entry_text_column obj text_column)

  method set_id_column : int -> unit = fun id_column -> (Combo_box.set_id_column obj id_column)
  ...
  method set_popup_fixed_width : bool -> unit = fun fixed -> (Combo_box.set_popup_fixed_width obj fixed)
