...
class search_entry (obj : Search_entry.t) = object (self)
  ...
  method get_placeholder_text : unit -> string option = fun () -> (Search_entry.get_placeholder_text obj )

  method get_search_delay : unit -> int = fun () -> (Search_entry.get_search_delay obj )
  ...
  method set_placeholder_text : string option -> unit = fun text -> (Search_entry.set_placeholder_text obj text)

  method set_search_delay : int -> unit = fun delay -> (Search_entry.set_search_delay obj delay)
