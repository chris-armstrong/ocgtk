...
class color_dialog_button (obj : Color_dialog_button.t) = object (self)
  ...
  method get_dialog : unit -> GColor_dialog.color_dialog option = fun () -> Option.map (fun ret -> new GColor_dialog.color_dialog ret) (Color_dialog_button.get_dialog obj )

  method set_dialog : 'p1. (#GColor_dialog.color_dialog as 'p1) -> unit = fun dialog -> (Color_dialog_button.set_dialog obj ( dialog#as_color_dialog ))
