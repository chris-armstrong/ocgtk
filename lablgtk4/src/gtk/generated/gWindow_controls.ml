...
class window_controls (obj : Window_controls.t) = object (self)
  ...
  method get_decoration_layout : unit -> string option = fun () -> (Window_controls.get_decoration_layout obj )
  ...
  method set_decoration_layout : string option -> unit = fun layout -> (Window_controls.set_decoration_layout obj layout)
