...
gtk_expander_set_label_widget(GtkExpander_val(self), Option_val(arg1, GtkWidget_val, NULL));
CAMLreturn(Val_unit);
}
...
gtk_expander_set_child(GtkExpander_val(self), Option_val(arg1, GtkWidget_val, NULL));
CAMLreturn(Val_unit);
}
