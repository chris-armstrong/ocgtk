...
class aspect_frame (obj : Aspect_frame.t) = object (self)
  ...
  method get_obey_child : unit -> bool = fun () -> (Aspect_frame.get_obey_child obj )

  method get_ratio : unit -> float = fun () -> (Aspect_frame.get_ratio obj )

  method get_xalign : unit -> float = fun () -> (Aspect_frame.get_xalign obj )
  ...
  method set_obey_child : bool -> unit = fun obey_child -> (Aspect_frame.set_obey_child obj obey_child)

  method set_ratio : float -> unit = fun ratio -> (Aspect_frame.set_ratio obj ratio)

  method set_xalign : float -> unit = fun xalign -> (Aspect_frame.set_xalign obj xalign)

  method set_yalign : float -> unit = fun yalign -> (Aspect_frame.set_yalign obj yalign)
