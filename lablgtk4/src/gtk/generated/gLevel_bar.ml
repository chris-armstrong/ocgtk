...
class level_bar (obj : Level_bar.t) = object (self)
  ...
  method set_inverted v = Level_bar.set_inverted obj v

  method max_value = Level_bar.get_max_value obj
  method set_max_value v = Level_bar.set_max_value obj v

  method min_value = Level_bar.get_min_value obj
  method set_min_value v = Level_bar.set_min_value obj v
