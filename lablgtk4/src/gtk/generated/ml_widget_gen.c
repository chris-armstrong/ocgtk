...
gtk_widget_set_focus_child(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
gtk_widget_insert_before(GtkWidget_val(self), GtkWidget_val(arg1), GtkWidget_option_val(arg2));
CAMLreturn(Val_unit);
}
...
gtk_widget_insert_after(GtkWidget_val(self), GtkWidget_val(arg1), GtkWidget_option_val(arg2));
CAMLreturn(Val_unit);
}
...
gtk_widget_get_css_classes(GtkWidget_val(self));
CAMLreturn(Val_unit);
}
...
CAMLexport CAMLprim value ml_gtk_widget_get_allocation(value self)
{
CAMLparam1(self);
GtkAllocation out1;

gtk_widget_get_allocation(GtkWidget_val(self), &out1);
CAMLreturn(Val_unit);
}
