...
class expander (obj : Expander.t) = object (self)
  ...
  method expanded = Expander.get_expanded obj
  method set_expanded v = Expander.set_expanded obj v

  method label = Expander.get_label obj
  method set_label v = Expander.set_label obj v

  method resize_toplevel = Expander.get_resize_toplevel obj
  method set_resize_toplevel v = Expander.set_resize_toplevel obj v

  method use_markup = Expander.get_use_markup obj
  method set_use_markup v = Expander.set_use_markup obj v

  method use_underline = Expander.get_use_underline obj
  method set_use_underline v = Expander.set_use_underline obj v
