...
class icon_view (obj : Icon_view.t) = object (self)
  ...
  method get_activate_on_single_click : unit -> bool = fun () -> (Icon_view.get_activate_on_single_click obj )

  method get_column_spacing : unit -> int = fun () -> (Icon_view.get_column_spacing obj )
  ...
  method get_item_padding : unit -> int = fun () -> (Icon_view.get_item_padding obj )
  ...
  method get_markup_column : unit -> int = fun () -> (Icon_view.get_markup_column obj )
  ...
  method get_pixbuf_column : unit -> int = fun () -> (Icon_view.get_pixbuf_column obj )

  method get_reorderable : unit -> bool = fun () -> (Icon_view.get_reorderable obj )

  method get_row_spacing : unit -> int = fun () -> (Icon_view.get_row_spacing obj )
  ...
  method get_text_column : unit -> int = fun () -> (Icon_view.get_text_column obj )

  method get_tooltip_column : unit -> int = fun () -> (Icon_view.get_tooltip_column obj )
  ...
  method set_activate_on_single_click : bool -> unit = fun single -> (Icon_view.set_activate_on_single_click obj single)

  method set_column_spacing : int -> unit = fun column_spacing -> (Icon_view.set_column_spacing obj column_spacing)

  method set_columns : int -> unit = fun columns -> (Icon_view.set_columns obj columns)
  ...
  method set_item_padding : int -> unit = fun item_padding -> (Icon_view.set_item_padding obj item_padding)

  method set_item_width : int -> unit = fun item_width -> (Icon_view.set_item_width obj item_width)

  method set_margin : int -> unit = fun margin -> (Icon_view.set_margin obj margin)

  method set_markup_column : int -> unit = fun column -> (Icon_view.set_markup_column obj column)
  ...
  method set_pixbuf_column : int -> unit = fun column -> (Icon_view.set_pixbuf_column obj column)

  method set_reorderable : bool -> unit = fun reorderable -> (Icon_view.set_reorderable obj reorderable)

  method set_row_spacing : int -> unit = fun row_spacing -> (Icon_view.set_row_spacing obj row_spacing)

  method set_selection_mode : Gtk_enums.selectionmode -> unit = fun mode -> (Icon_view.set_selection_mode obj mode)

  method set_spacing : int -> unit = fun spacing -> (Icon_view.set_spacing obj spacing)

  method set_text_column : int -> unit = fun column -> (Icon_view.set_text_column obj column)
  ...
  method set_tooltip_column : int -> unit = fun column -> (Icon_view.set_tooltip_column obj column)
