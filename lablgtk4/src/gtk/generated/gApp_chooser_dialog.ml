...
class app_chooser_dialog (obj : App_chooser_dialog.t) = object (self)
  ...
  method get_heading : unit -> string option = fun () -> (App_chooser_dialog.get_heading obj )
  ...
  method set_heading : string -> unit = fun heading -> (App_chooser_dialog.set_heading obj heading)
