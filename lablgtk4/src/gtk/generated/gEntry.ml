...
class entry (obj : Entry.t) = object (self)
  ...
  method get_activates_default : unit -> bool = fun () -> (Entry.get_activates_default obj )
  ...
  method get_overwrite_mode : unit -> bool = fun () -> (Entry.get_overwrite_mode obj )

  method get_placeholder_text : unit -> string option = fun () -> (Entry.get_placeholder_text obj )

  method get_progress_fraction : unit -> float = fun () -> (Entry.get_progress_fraction obj )

  method get_progress_pulse_step : unit -> float = fun () -> (Entry.get_progress_pulse_step obj )
  ...
  method set_activates_default : bool -> unit = fun setting -> (Entry.set_activates_default obj setting)
  ...
  method set_has_frame : bool -> unit = fun setting -> (Entry.set_has_frame obj setting)
  ...
  method set_max_length : int -> unit = fun max -> (Entry.set_max_length obj max)

  method set_overwrite_mode : bool -> unit = fun overwrite -> (Entry.set_overwrite_mode obj overwrite)

  method set_placeholder_text : string option -> unit = fun text -> (Entry.set_placeholder_text obj text)

  method set_progress_fraction : float -> unit = fun fraction -> (Entry.set_progress_fraction obj fraction)

  method set_progress_pulse_step : float -> unit = fun fraction -> (Entry.set_progress_pulse_step obj fraction)

  method set_visibility : bool -> unit = fun visible -> (Entry.set_visibility obj visible)
