...
class info_bar (obj : Info_bar.t) = object (self)
  ...
  method revealed = Info_bar.get_revealed obj
  method set_revealed v = Info_bar.set_revealed obj v

  method show_close_button = Info_bar.get_show_close_button obj
  method set_show_close_button v = Info_bar.set_show_close_button obj v
