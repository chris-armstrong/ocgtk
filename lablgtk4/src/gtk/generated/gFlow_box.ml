...
class flow_box (obj : Flow_box.t) = object (self)
  ...
  method activate_on_single_click = Flow_box.get_activate_on_single_click obj
  method set_activate_on_single_click v = Flow_box.set_activate_on_single_click obj v

  method column_spacing = Flow_box.get_column_spacing obj
  method set_column_spacing v = Flow_box.set_column_spacing obj v

  method homogeneous = Flow_box.get_homogeneous obj
  method set_homogeneous v = Flow_box.set_homogeneous obj v

  method max_children_per_line = Flow_box.get_max_children_per_line obj
  method set_max_children_per_line v = Flow_box.set_max_children_per_line obj v

  method min_children_per_line = Flow_box.get_min_children_per_line obj
  method set_min_children_per_line v = Flow_box.set_min_children_per_line obj v

  method row_spacing = Flow_box.get_row_spacing obj
  method set_row_spacing v = Flow_box.set_row_spacing obj v
