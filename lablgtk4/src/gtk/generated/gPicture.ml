...
class picture (obj : Picture.t) = object (self)
  ...
  method get_alternative_text : unit -> string option = fun () -> (Picture.get_alternative_text obj )
  ...
  method get_keep_aspect_ratio : unit -> bool = fun () -> (Picture.get_keep_aspect_ratio obj )

  method set_alternative_text : string option -> unit = fun alternative_text -> (Picture.set_alternative_text obj alternative_text)

  method set_can_shrink : bool -> unit = fun can_shrink -> (Picture.set_can_shrink obj can_shrink)
  ...
  method set_keep_aspect_ratio : bool -> unit = fun keep_aspect_ratio -> (Picture.set_keep_aspect_ratio obj keep_aspect_ratio)
