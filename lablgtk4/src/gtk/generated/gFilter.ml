...
class filter (obj : Filter.t) = object (self)
  ...
  method changed : Gtk_enums.filterchange -> unit = fun change -> (Filter.changed obj change)

  method get_strictness : unit -> Gtk_enums.filtermatch = fun () -> (Filter.get_strictness obj )
