...
class scale_button (obj : Scale_button.t) = object (self)
  ...
  method get_has_frame : unit -> bool = fun () -> (Scale_button.get_has_frame obj )
  ...
  method set_has_frame : bool -> unit = fun has_frame -> (Scale_button.set_has_frame obj has_frame)

  method set_value : float -> unit = fun value -> (Scale_button.set_value obj value)
