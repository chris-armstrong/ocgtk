...
class file_chooser (obj : File_chooser.t) = object (self)
  ...
  method get_create_folders : unit -> bool = fun () -> (File_chooser.get_create_folders obj )
  ...
  method get_select_multiple : unit -> bool = fun () -> (File_chooser.get_select_multiple obj )
  ...
  method set_create_folders : bool -> unit = fun create_folders -> (File_chooser.set_create_folders obj create_folders)
  ...
  method set_select_multiple : bool -> unit = fun select_multiple -> (File_chooser.set_select_multiple obj select_multiple)
