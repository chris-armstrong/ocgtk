...
class header_bar (obj : Header_bar.t) = object (self)
  ...
  method decoration_layout = Header_bar.get_decoration_layout obj
  method set_decoration_layout v = Header_bar.set_decoration_layout obj v

  method show_title_buttons = Header_bar.get_show_title_buttons obj
  method set_show_title_buttons v = Header_bar.set_show_title_buttons obj v
