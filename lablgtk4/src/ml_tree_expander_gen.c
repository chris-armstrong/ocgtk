...
{
CAMLparam1(unit);
GtkWidget *widget = gtk_tree_expander_new();
...
CAMLparam2(self, arg1);
    ...
    gtk_tree_expander_set_list_row(GtkWidget_val(self), (Is_some(arg1) ? GtkWidget_val(Some_val(arg1)) : NULL));
CAMLreturn(Val_unit);
}
...
CAMLparam2(self, arg1);
    ...
    gtk_tree_expander_set_child(GtkWidget_val(self), GtkWidget_option_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkTreeListRow* result = gtk_tree_expander_get_list_row(GtkWidget_val(self));
...
CAMLparam1(self);
    ...
    GtkWidget* result = gtk_tree_expander_get_child(GtkWidget_val(self));
CAMLreturn(Val_GtkWidget(result));
}
