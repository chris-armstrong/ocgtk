...
class drop_down (obj : Drop_down.t) = object (self)
  ...
  method get_factory : unit -> GList_item_factory.list_item_factory option = fun () -> Option.map (fun ret -> new GList_item_factory.list_item_factory ret) (Drop_down.get_factory obj )

  method get_header_factory : unit -> GList_item_factory.list_item_factory option = fun () -> Option.map (fun ret -> new GList_item_factory.list_item_factory ret) (Drop_down.get_header_factory obj )
  ...
  method set_factory : 'p1. (#GList_item_factory.list_item_factory as 'p1) option -> unit = fun factory -> (Drop_down.set_factory obj ( factory |> Option.map (fun x -> x#as_list_item_factory) ))

  method set_header_factory : 'p1. (#GList_item_factory.list_item_factory as 'p1) option -> unit = fun factory -> (Drop_down.set_header_factory obj ( factory |> Option.map (fun x -> x#as_list_item_factory) ))
