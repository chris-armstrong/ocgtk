...
{
CAMLparam1(arg1);
GtkWidget *widget = gtk_window_controls_new(GtkPackType_val(arg1));
...
CAMLparam2(self, arg1);
    ...
    gtk_window_controls_set_side(GtkWidget_val(self), GtkPackType_val(arg1));
CAMLreturn(Val_unit);
}
...
CAMLparam1(self);
    ...
    GtkPackType result = gtk_window_controls_get_side(GtkWidget_val(self));
